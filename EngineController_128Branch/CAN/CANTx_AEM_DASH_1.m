...
%%
  ...
  msg.description             = 'Message 1';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A000');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{4}.name          = 'CoolantTemp';
  msg.fields{4}.units         = 'degC';
