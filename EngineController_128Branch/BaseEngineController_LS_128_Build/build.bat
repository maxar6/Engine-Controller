				...
				@if exist "%MOTOCODER_DIR%\bin\ESTconvert.exe" "%MOTOCODER_DIR%\bin\ESTconvert.exe" .\Target\BaseEngineController_LS_128.elf -b -c > NUL 2>&1
					...
					@"C:\PROGRA~2\Woodward\MCS\MotoHawk\2011A_~1.184\Bin\motohawk_dumpdll.exe" -xml "C:\Users\maxar\Documents\GitHub\Engine-Controller\EngineController_128Branch\BaseEngineController_LS_128_Build\TDB\BaseEngin_034.dll" > "C:\Users\maxar\Documents\GitHub\Engine-Controller\EngineController_128Branch\BaseEngineController_LS_128_Build\TDB\BaseEngin_034.xml"
							@if ERRORLEVEL 1 exit junk
					
				
					@echo ### Generating ASAP2 file
					@"C:\PROGRA~2\Woodward\MCS\MotoHawk\2011A_~1.184\Bin\ASAP2.exe" -m "C:\Users\maxar\Documents\GitHub\Engine-Controller\EngineController_128Branch\BaseEngineController_LS_128_Build\TDB\BaseEngin_034.xml" -o "C:\Users\maxar\Documents\GitHub\Engine-Controller\EngineController_128Branch\BaseEngineController_LS_128_Build\TDB\BaseEngin_034.a2l" -u VirtualCalSpace -asap1b "C:\Users\maxar\Documents\GitHub\Engine-Controller\EngineController_128Branch\BaseEngineController_LS_128_Build\mh_asap1b_ccp_CCP1.xml"
							@if ERRORLEVEL 1 exit junk
					
				
					@echo ### Installing ASAP2 file in c:\ecufiles\tdbdll
					@copy "C:\Users\maxar\Documents\GitHub\Engine-Controller\EngineController_128Branch\BaseEngineController_LS_128_Build\TDB\BaseEngin_034.a2l" "c:\ecufiles\tdbdll" > NUL
							@if ERRORLEVEL 1 exit junk
