...
/* Serial is supported so map the alias to the real methods */
#define KeySuite_Manager_ChangeBaud KeySuiteSupport_Serial_ChangeBaud
#define KeySuite_Manager_IsBaudSupported KeySuiteSupport_Serial_IsBaudSupported
...
void KeySuite_Manager_TransmitReplyOnSerial(S_KeySuiteCityState* const pConnection);

void KeySuiteSupport_Serial_Transmit(S_KeySuiteSerialData const* const pTXData,
                                     void (*pfnSCITXCompleteNotify)(NativePtrSizedInt_U uAppData),
                                     NativePtrSizedInt_U uAppData);

void KeySuiteSupport_Serial_ChangeBaud(S_KeySuiteCityState const* const pConnection, uint32_T uBaud_bps);
NativeBool KeySuiteSupport_Serial_IsBaudSupported(S_KeySuiteCityState const* const pConnection, uint32_T uBaud_bps);
void KeySuiteSupport_Serial_FillMotoTronBootObj(S_MotoTronBootObj_V4* const, S_KeySuiteCityState const* const);

InstantiateMethod_PROTOCOL_KEY_OnSerial(g_KeyProtocolOnSerial, &g_u32KeyProtocolPacketTimeout_ms);
InstantiateMethod_PROTOCOL_ERI_OnSerial(g_ERIProtocolOnSerial, &g_u32ERIProtocolPacketTimeout_ms, CRC_ENTIRE_MAP);
...
S_KeySuiteProtocolInstanceInfo const g_KeySuiteProtocolInstanceInfo[] = 
{
    ...
    {&g_KeyProtocolOnSerial,  KeySuite_Manager_TransmitReplyOnSerial,    EriRequestTableList,     SCI_TRANSPORT_LAYER, PROTOCOL_KEY},
    {&g_ERIProtocolOnSerial,  KeySuite_Manager_TransmitReplyOnSerial,    EriRequestTableList,     SCI_TRANSPORT_LAYER, PROTOCOL_ERI},
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuite_Manager_Connection_GetFromSerial
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
/*! \internal
    \brief Returns the connection information for a Serial transport.

    \return pointer to S_KeySuiteCityState is memory allocation was successful, NULL otherwise.
    \param pCANDataObj Pointer to a KeySuite CAN object
*/
S_KeySuiteCityState* KeySuite_Manager_Connection_GetFromSerial(S_KeySuiteSerialData const* const pReceiptObj) 
{
    /* Always SERIAL_CITY_ID on serial connections, and use uModuleId as the only attribute to distinguish connections */
    return(KeySuite_Manager_Connection_Get(SERIAL_CITY_ID, SCI_TRANSPORT_LAYER, pReceiptObj->TransportInfo.u8ModuleId));
}
...
void KeySuite_Manager_OnModuleSupportClose(uint32_T in_u32UserData)
{
    ...
    if (s_u8MotoTronBootObjVersion == PV0)
    {
	    ...
	    if (RS485_SerialLink_ModuleId_Get() == pConnection->u8AppSpecific)
	    {
	        pMotoTronBootObjV0->u32BootCurrentSerialBaudRate = RS485_SerialLink_BaudRate_Get();
	    }
	...
	else
	{
	    ...
	    {   /* A version 4 object implies a serial connection */
	        ...
	        KeySuiteSupport_Serial_FillMotoTronBootObj(pMotoTronBootObjV4,
	                                                   pConnection);
	        /* KeySuite manager knows how to recover the default baud */
	        pMotoTronBootObjV4->u32BootDefaultKeySerialBaudRate = KeySuite_DefaultBaud_Get();
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuite_Manager_OnSerialReceipt
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
/*! \internal
    \brief Handles a incoming data from a serial link

        Dispatches the serial data to the protocol method the client is connected to. If the message is
        properly handled, a reply is sent to the client. Otherwise, no reply is sent.

    \retval SUCCESS_OK The frame was handled
    \retval ERROR_FAIL The frame was not handled
    \param pReceiptObj Pointer to a serial data object.
*/
NativeError_S KeySuite_Manager_OnSerialReceipt(S_KeySuiteSerialData const* const pReceiptObj)
{
    S_KeySuiteCityState* pConnection;

    pConnection = KeySuite_Manager_Connection_GetFromSerial(pReceiptObj);
    if (pConnection != NULL)
    {   /* We have a connection for this data stream */
        ...
        /* We have a connection and some data */
        {
            ...
            ProtocolIncomingData.pDataPayload = pReceiptObj->pDataStream;
            ProtocolIncomingData.pTransportLayerSpecific = &pReceiptObj->TransportInfo;
            pConnection->u8TransportInUse = pReceiptObj->TransportInfo.u8ModuleId;

            KeySuite_Manager_MessageHandler_Execute(pConnection, &ProtocolIncomingData);
            return (SUCCESS_OK);
        }
    }
    /* Serial data stream was not handled */
    return(ERROR_FAIL);
}
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuiteSupport_ReceiptEvent_Set
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
void KeySuiteSupport_ReceiptEvent_Set(void)
{
    /* We don't do anything currently to the set the receipt event. Suspect that the serial driver
       will just be polled continuously. If this is not the case then here is where the event should
       set */
}

/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuite_Manager_TransmitReplyOnSerial
::
:: Transmits a Reply on Serial.
::
:: Parameters
:: (1) The connection making the transmit request
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
void KeySuite_Manager_TransmitReplyOnSerial(S_KeySuiteCityState* const pConnection)
{
    S_KeySuiteSerialData SerialInfo;
    S_KeySuiteReply* pReply = pConnection->pReplyObj;
    NativeVar_U uNumBytes;
    ...
    {
        /* We can Send the reply */
        SerialInfo.TransportInfo.u8ModuleId = (uint8_T)pConnection->u8AppSpecific;
        SerialInfo.TransportInfo.u8BytesInBuffer = (uint8_T)uNumBytes;
        SerialInfo.pDataStream = pReply->u8pReplyArr;

        /* Execute the transmission. The method will call us back as required */
        KeySuiteSupport_Serial_Transmit(&SerialInfo,
                                        (SCITxCompleteNotifyFuncPtr)pReply->pfnPostReplyCallBack,
                                        (NativePtrSizedInt_U)pConnection);
    }
    else
    {   /* No transmission, but the callback may still be applicable */
...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
void KeySuiteSupport_RS485_OnErrorNotify(void)
{
    NativeVar_U uModuleID;

    uModuleID = RS485_SerialLink_ModuleId_Get();
    RS485_SerialLink_RxQueue_Purge();

    /* Call the manager to reset the Transport. */
    KeySuite_Manager_ResetTransport(SCI_TRANSPORT_LAYER, uModuleID);
}

/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuiteSupport_RS485_OnIdleNotify
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
void KeySuiteSupport_RS485_OnIdleNotify(void)
{
    /* Idle implies that there is likely to be data available */
    KeySuiteSupport_ReceiptEvent_Set();
}


/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuiteSupport_Serial_Transmit
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
void KeySuiteSupport_Serial_Transmit(S_KeySuiteSerialData const* const pTXData,
                                     void (*pfnSCITXCompleteNotify)(NativePtrSizedInt_U uAppData),
                                     NativePtrSizedInt_U uAppData)
{
    ...
    if (pTXData->TransportInfo.u8ModuleId == RS485_SerialLink_ModuleId_Get())
    {   /* This is the driver */ 
        RS485_SerialLink_Transmit_WithCallbackOnComplete(pTXData->pDataStream, pTXData->TransportInfo.u8BytesInBuffer, pfnSCITXCompleteNotify, uAppData);
        return;
    }
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuiteSupport_Serial_FillMotoTronBootObj
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
void KeySuiteSupport_Serial_FillMotoTronBootObj(S_MotoTronBootObj_V4* const out_pBootObj,
                                                S_KeySuiteCityState const* const pConnection)
{
    memset(out_pBootObj, 0, sizeof(*out_pBootObj));

    /* The module is described by the ModuleId that is kept in the u8AppSpecific member */
    out_pBootObj->uAllowConnectOnSerialMask = 1 << pConnection->u8AppSpecific;

    /* Explicitly set this to zero as this boot object does not know how to fill the CAN info */
    out_pBootObj->V3.uAllowConnectOnCANMask = 0;


    if (RS485_SerialLink_ModuleId_Get() == pConnection->u8AppSpecific)
    {
        out_pBootObj->u32BootCurrentSerialBaudRate = RS485_SerialLink_BaudRate_Get();
        return;
    }
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuiteSupport_Serial_IsBaudSupported
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
/*! \brief This function executes when KeySuite wants to query whether it should allow the connection to
           change the baud rate
    \param pConnection The connection that is making the request
    \param uBaud_bps The baud rate that we shall change to
*/
NativeBool KeySuiteSupport_Serial_IsBaudSupported(S_KeySuiteCityState const* const pConnection, uint32_T uBaud_bps)
{
    if (pConnection->pMethod->u8TransportLayerID == SCI_TRANSPORT_LAYER)
    {   /* Serial transport, so baud rate applies */

        if (RS485_SerialLink_ModuleId_Get() == pConnection->u8AppSpecific)
        {
            if (RS485_SerialLink_MaxAllowedBaud_Get() >= uBaud_bps)
            {   /* The device handles the supported baud rate */
                return(TRUE);
            }
        }
    ...
    /* Baud rate changes is either not supported on this Transport, or is too high for this transport
       to reliably handle */
    return(FALSE);
}

/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: KeySuiteSupport_Serial_ChangeBaud
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
/*! \brief This function executes when KeySuite wants to change the baud rate
    \param pConnection The connection that is making the request
    \param uBaud_bps The baud rate that we shall change to
*/
void KeySuiteSupport_Serial_ChangeBaud(S_KeySuiteCityState const* const pConnection, uint32_T uBaud_bps)
{
    if (pConnection->pMethod->u8TransportLayerID == SCI_TRANSPORT_LAYER)
    {   /* This connection supports baud rate */

        if (RS485_SerialLink_ModuleId_Get() == pConnection->u8AppSpecific)
        {   /* The module Identifier matches RS485 */
            RS485_SerialLink_BaudRate_Change(uBaud_bps);
        }
...
void KeySuite_MessageHandler(void)
{
    ...
    {   /*==== Serial Data Receipt from RS485 =========================================================*/
        NativeError_S sSerialReceiptError;
        NativeVar_U uReceiptDepth;
        S_KeySuiteSerialData SerialDataObj;
        uint8_T uDataStreamArr[8];

        SerialDataObj.pDataStream = uDataStreamArr;
        SerialDataObj.TransportInfo.u8ModuleId = (uint8_T)RS485_SerialLink_ModuleId_Get();
        SerialDataObj.TransportInfo.u8BytesInBuffer = 0;

        /* Keep processing until the queue data has been emptied */
        while(TRUE)
        {   
            uReceiptDepth = RS485_SerialLink_RxQueueDepth_Get();
            
            if(uReceiptDepth == 0)
            {
                /* There is no more data left in the queue. Exit the processing loop. */
                break;
            }          
            else if (uReceiptDepth >= _countof(uDataStreamArr))
            {   /* Recover as many bytes as we can handle */
                SerialDataObj.TransportInfo.u8BytesInBuffer = _countof(uDataStreamArr);
            }
            else
            {
                SerialDataObj.TransportInfo.u8BytesInBuffer = (uint8_T)uReceiptDepth;
            }

            /* Note that the next while will refresh uReceiptDepth so we don't need to do it here */

            /* Fill the buffer */
            sSerialReceiptError = RS485_SerialLink_ReadSync(uDataStreamArr,
                                                                  /* Characters to read */
                                                                  SerialDataObj.TransportInfo.u8BytesInBuffer,
                                                                  /* Don't wait for the characters */
                                                                  0);
            if (SUCCESS(sSerialReceiptError))
            {   /* We read the data */
                KeySuite_Manager_OnSerialReceipt(&SerialDataObj);
            }
            else
            {   /* Didn't read the data that was supposed to be there */

                /* Most likely the queue was purged between getting the depth and pulling from the queue.
                   We shall just try again */
                uReceiptDepth = 0;
            }
        }
    }
