...
static void initialize_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void initialize_params_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void enable_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void disable_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void set_sim_state_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance, const mxArray *
   c7_st);
static void finalize_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void sf_c7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void initSimStructsc7_BaseEngineController_LS_128
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_BaseEngineController_LS_128InstanceStruct
...
static uint8_T c7_d_emlrt_marshallIn
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance, const mxArray *
   c7_b_is_active_c7_BaseEngineController_LS_128, const char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance, const mxArray *
   c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_BaseEngineController_LS_128InstanceStruct
  *chartInstance);
  ...
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_BaseEngineController_LS_128 = 0U;
}
  ...
  (SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance)
{
  ...
  c7_e_hoistedGlobal =
    chartInstance->c7_is_active_c7_BaseEngineController_LS_128;
   ...
   c7_st)
{
  ...
  *c7_StateO = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u,
  ...
  chartInstance->c7_is_active_c7_BaseEngineController_LS_128 =
    ...
    "is_active_c7_BaseEngineController_LS_128");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_BaseEngineController_LS_128(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance;
  chartInstance = (SFc7_BaseEngineController_LS_128InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c7_BaseEngineController_LS_128_get_eml_resolved_functions_info
  (void)
{
   ...
   c7_b_is_active_c7_BaseEngineController_LS_128, const char_T *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_BaseEngineController_LS_128), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_BaseEngineController_LS_128);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_BaseEngineController_LS_128_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_BaseEngineController_LS_128_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_BaseEngineController_LS_128(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"ETCMode\",},{M[1],M[10],T\"Hold\",},{M[1],M[9],T\"Reset\",},{M[1],M[11],T\"StateO\",},{M[8],M[0],T\"is_active_c7_BaseEngineController_LS_128\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_BaseEngineController_LS_128_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_BaseEngineController_LS_128InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
  initialize_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  enable_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  disable_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  sf_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_BaseEngineController_LS_128
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_BaseEngineController_LS_128();/* state var info */
...
extern void sf_internal_set_sim_state_c7_BaseEngineController_LS_128(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_BaseEngineController_LS_128
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_BaseEngineController_LS_128(S);
}

static void sf_opaque_set_sim_state_c7_BaseEngineController_LS_128(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_BaseEngineController_LS_128(S, st);
}

static void sf_opaque_terminate_c7_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_BaseEngineController_LS_128InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_BaseEngineController_LS_128
      ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_BaseEngineController_LS_128
    ((SFc7_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_BaseEngineController_LS_128(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_BaseEngineController_LS_128
      ((SFc7_BaseEngineController_LS_128InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_BaseEngineController_LS_128(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS_128",
      "BaseEngineController_LS_128",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS_128",
                "BaseEngineController_LS_128",7,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS_128","BaseEngineController_LS_128",7,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"BaseEngineController_LS_128",
        "BaseEngineController_LS_128",7,5);
      sf_mark_chart_reusable_outputs(S,"BaseEngineController_LS_128",
        "BaseEngineController_LS_128",7,4);
    }
...
static void mdlRTW_c7_BaseEngineController_LS_128(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_BaseEngineController_LS_128(SimStruct *S)
{
  SFc7_BaseEngineController_LS_128InstanceStruct *chartInstance;
  chartInstance = (SFc7_BaseEngineController_LS_128InstanceStruct *)malloc
    (sizeof(SFc7_BaseEngineController_LS_128InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_BaseEngineController_LS_128InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_BaseEngineController_LS_128;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_BaseEngineController_LS_128;
...
void c7_BaseEngineController_LS_128_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_BaseEngineController_LS_128(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_BaseEngineController_LS_128(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_BaseEngineController_LS_128(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_BaseEngineController_LS_128_method_dispatcher.\n"
