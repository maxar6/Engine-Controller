...
#define BaseEngineController_LS_128_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_128_DWork.s324_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S324>/MisfireDiagFunc' */
    {
      ...
      boolean_T rtb_Logic_c[2];
      boolean_T rtb_Memory_n;
      boolean_T rtb_LogicalOperator3_j;
      boolean_T rtb_LogicalOperator_b[8];
      real_T rtb_Product_e[8];
      uint16_T rtb_Sum_g1;
      real_T rtb_Product_a;
      real_T rtb_UnitDelay2_i;
      int8_T rtPrevAction;
      int8_T rtAction;
      boolean_T rtb_LogicalOperator1_am[8];
      real_T rtb_UnitDelay2_h;
      uint32_T rtb_DataTypeConversion1_f;
      uint32_T rtb_Sum3_a[8];
      uint32_T rtb_Gain1[8];
      int32_T i;
      boolean_T rtb_LogicalOperator1_am_0;
      uint32_T rtb_Gain_0;
      int16_T tmp;
      uint32_T tmp_0;
      ...
      {
        int_T i1;
        boolean_T *y0 = rtb_motohawk_data_read2_h;
        for (i1=0; i1 < 8; i1++) {
       ...
       */
      for (i = 0; i < 8; i++) {
        rtb_Product_e[i] = (real_T)(rtb_motohawk_data_read2_h[i] &&
          (!BaseEngineController_LS_128_DWork.s331_UnitDelay_DSTATE[i])) *
          BaseEngineController_LS_128_ConstP.pooled85[i];
      }
       ...
       *  MinMax: '<S342>/MinMax'
       */
      rtb_Product_a = rtb_Product_e[0];
      for (i = 0; i < 7; i++) {
        rtb_Product_a = (rtb_Product_a >= rtb_Product_e[i + 1]) || rtIsNaN
          (rtb_Product_e[i + 1]) ? rtb_Product_a : rtb_Product_e[i + 1];
      }

      rtb_MinMax_m = rtb_Product_a;
       ...
       */
      rtb_Sum_g1 = (uint16_T)(((uint16_T)MisfireDiag_StopRPM_DataStore()
        [(uint32_T)rtb_MinMax_m]) - ((uint16_T)MisfireDiag_StartRPM_DataStore()
                               [(uint32_T)rtb_MinMax_m]));

      /* RelationalOperator: '<S327>/Relational Operator1' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S327>/motohawk_calibration1'
       */
      rtb_Memory_n = ((real_T)rtb_Sum_g1 <=
       ...
       */
      rtb_LogicalOperator3_j = (rtb_Memory_n && (rtb_MinMax_m > 0.0));

      /* Product: '<S327>/Product' */
      rtb_Product_a = rtb_MinMax_m * (real_T)rtb_LogicalOperator3_j;

      /* RelationalOperator: '<S333>/Compare' incorporates:
       *  Constant: '<S333>/Constant'
       */
      rtb_Compare_f = ((rtb_Product_a == 1.0));
      ...
      /* Set Fault Suspected Status: Cylinder1_HardMisfire */
      {
        ...
        SetFaultSuspected(34, rtb_Compare_f);
        UpdateFault(34);
      }
       ...
       */
      rtb_Compare_b = ((rtb_Product_a == 2.0));
       ...
       */
      rtb_Compare_k = ((rtb_Product_a == 3.0));
      ...
      /* Set Fault Suspected Status: Cylinder3_HardMisfire */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(36, rtb_Compare_k);
        UpdateFault(36);
      }
       ...
       */
      rtb_Compare_n = ((rtb_Product_a == 4.0));
      ...
      /* Set Fault Suspected Status: Cylinder4_HardMisfire */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(37, rtb_Compare_n);
        UpdateFault(37);
      }
       ...
       */
      rtb_Compare_m = ((rtb_Product_a == 5.0));
       ...
       */
      rtb_Compare_kn = ((rtb_Product_a == 6.0));
      ...
      /* Set Fault Suspected Status: Cylinder6_HardMisfire */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(39, rtb_Compare_kn);
        UpdateFault(39);
      }
       ...
       */
      rtb_Compare_e = ((rtb_Product_a == 7.0));
      ...
      /* Set Fault Suspected Status: Cylinder7_HardMisfire */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(40, rtb_Compare_e);
        UpdateFault(40);
      }
       ...
       */
      rtb_Compare_j = ((rtb_Product_a == 8.0));
      ...
      /* Set Fault Suspected Status: Cylinder8_HardMisfire */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(41, rtb_Compare_j);
        UpdateFault(41);
      }

      /* UnitDelay: '<S344>/Unit Delay1' */
      rtb_UnitDelay1_h =
        BaseEngineController_LS_128_DWork.s344_UnitDelay1_DSTATE;

      /* UnitDelay: '<S344>/Unit Delay2' */
      rtb_UnitDelay2_i =
        BaseEngineController_LS_128_DWork.s344_UnitDelay2_DSTATE;

      /* RelationalOperator: '<S344>/Relational Operator' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S344>/motohawk_calibration'
       *  UnitDelay: '<S344>/Unit Delay2'
       */
      BaseEngineController_LS_128_B.s344_RelationalOperator =
        ((BaseEngineController_LS_128_DWork.s344_UnitDelay2_DSTATE >= (real_T)
          ((uint8_T)(MisfireDiag_StartRPMAvgCnt_DataStore()))));

      /* Outputs for Enabled SubSystem: '<S344>/SafeDivide' */
      BaseEngineController_LS_128_SafeDivide
        (BaseEngineController_LS_128_B.s344_RelationalOperator,
         (MisfireDiag_StartRPMAvgCnt_DataStore()), rtb_UnitDelay1_h,
         &BaseEngineController_LS_128_B.s344_SafeDivide);
      ...
      for (i = 0; i < 8; i++) {
        ...
        /* Gain: '<S328>/Gain' */
        rtb_Sum3_a[i] = rtb_DataTypeConversion1_f;
      }

      /* If: '<S343>/If' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S343>/motohawk_calibration3'
       */
      rtPrevAction = BaseEngineController_LS_128_DWork.s343_If_ActiveSubsystem;
      ...
      BaseEngineController_LS_128_DWork.s343_If_ActiveSubsystem = rtAction;
      ...
      switch (rtAction) {
       case 0:
        ...
        rtb_DataTypeConversion1_f = (rtb_motohawk_abs_time -
          BaseEngineController_LS_128_B.s351_motohawk_abs_time) *
         ...
         *  DataTypeConversion: '<S350>/Data Type Conversion'
         */
        BaseEngineController_LS_128_B.s350_Sum1 = (uint32_T)tmp -
       ...
       case 1:
        ...
        {
          extern int16_T GetEncoderEngAngle(void);
          BaseEngineController_LS_128_B.s343_Merge = GetEncoderEngAngle();
        }
      ...
      BaseEngineController_LS_128_B.s343_Merge = (int16_T)
        BaseEngineController_LS_128_B.s350_Sum1;
      for (i = 0; i < 8; i++) {
        /* RelationalOperator: '<S328>/Relational Operator' */
        if (BaseEngineController_LS_128_B.s343_Merge <= 0) {
          rtb_DataTypeConversion1_f = 0U;
        } else {
          rtb_DataTypeConversion1_f = (uint32_T)
            BaseEngineController_LS_128_B.s343_Merge << 11;
        }
        ...
        if (BaseEngineController_LS_128_B.s343_Merge <= 0) {
          ...
          tmp_0 = (uint32_T)BaseEngineController_LS_128_B.s343_Merge << 11;
        }
         ...
         *  Sum: '<S328>/Sum1'
         */
        rtb_LogicalOperator1_am_0 = ((rtb_Gain1[i] <= rtb_DataTypeConversion1_f)
          && (rtb_Sum3_a[i] - ((uint32_T)((uint16_T)
          (MisfireDiag_AngleHyst_DataStore())) << 11) >= tmp_0));

        /* Product: '<S341>/Product' incorporates:
         *  Constant: '<S341>/Constant'
         */
        rtb_Product_e[i] = (real_T)rtb_LogicalOperator1_am_0 *
          BaseEngineController_LS_128_ConstP.pooled85[i];

        /* Logic: '<S328>/Logical Operator' */
        rtb_LogicalOperator_b[i] = rtb_LogicalOperator1_am_0;
      }
       ...
       */
      if (BaseEngineController_LS_128_B.s344_RelationalOperator) {
        /* S-Function (motohawk_sfun_data_write): '<S346>/motohawk_data_write' */
        /* Write to Data Storage as vector: MisfireDiag_StartRPM */
        {
          MisfireDiag_StartRPM_DataStore()[(uint32_T)(rtb_MinMax_h4)] =
            BaseEngineController_LS_128_B.s344_SafeDivide.s354_Product;
        }
        ...
        {
          MisfireDiag_RPMDR_DataStore()[(uint32_T)(rtb_MinMax_h4)] = FALSE;
        }
      }
      ...
      rtb_UnitDelay1_e =
        BaseEngineController_LS_128_DWork.s345_UnitDelay1_DSTATE;

      /* UnitDelay: '<S345>/Unit Delay2' */
      rtb_UnitDelay2_h =
        BaseEngineController_LS_128_DWork.s345_UnitDelay2_DSTATE;

      /* RelationalOperator: '<S345>/Relational Operator' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S345>/motohawk_calibration'
       *  UnitDelay: '<S345>/Unit Delay2'
       */
      BaseEngineController_LS_128_B.s345_RelationalOperator =
        ((BaseEngineController_LS_128_DWork.s345_UnitDelay2_DSTATE >= (real_T)
          ((uint8_T)(MisfireDiag_StopRPMAvgCnt_DataStore()))));

      /* Outputs for Enabled SubSystem: '<S345>/SafeDivide' */
      BaseEngineController_LS_128_SafeDivide
        (BaseEngineController_LS_128_B.s345_RelationalOperator,
         (MisfireDiag_StopRPMAvgCnt_DataStore()), rtb_UnitDelay1_e,
         &BaseEngineController_LS_128_B.s345_SafeDivide);
      ...
      for (i = 0; i < 8; i++) {
         ...
         *  Sum: '<S328>/Sum3'
         */
        rtb_LogicalOperator1_am_0 = ((((uint32_T)((uint16_T)
        ...
        rtb_LogicalOperator1_am[i] = rtb_LogicalOperator1_am_0;
      }
       ...
       */
      if (BaseEngineController_LS_128_B.s345_RelationalOperator) {
        /* S-Function (motohawk_sfun_data_write): '<S347>/motohawk_data_write' */
        /* Write to Data Storage as vector: MisfireDiag_StopRPM */
        {
          MisfireDiag_StopRPM_DataStore()[(uint32_T)(rtb_MinMax_c)] =
            BaseEngineController_LS_128_B.s345_SafeDivide.s354_Product;
        }
        ...
        /* Write to Data Storage as vector: MisfireDiag_RPMDR */
        {
          MisfireDiag_RPMDR_DataStore()[(uint32_T)(rtb_MinMax_c)] = TRUE;
        }
      }
      ...
      rtb_LogicalOperator3_j = (rtb_LogicalOperator_b[0] ||
        rtb_LogicalOperator_b[1] || rtb_LogicalOperator_b[2] ||
        rtb_LogicalOperator_b[3] || rtb_LogicalOperator_b[4] ||
        rtb_LogicalOperator_b[5] || rtb_LogicalOperator_b[6] ||
        rtb_LogicalOperator_b[7]);

      /* Memory: '<S353>/Memory' */
      rtb_Memory_n = BaseEngineController_LS_128_DWork.s353_Memory_PreviousInput;
      ...
      /* CombinatorialLogic: '<S353>/Logic' */
      {
        ...
        rowidx = (rowidx << 1) + (uint_T)(rtb_LogicalOperator3_j != 0);
        rowidx = (rowidx << 1) + (uint_T)
          (BaseEngineController_LS_128_B.s344_RelationalOperator != 0);
        rowidx = (rowidx << 1) + (uint_T)(rtb_Memory_n != 0);

        /* Copy the appropriate row of the table into the block output vector */
        rtb_Logic_d[0] = BaseEngineController_LS_128_ConstP.pooled889[rowidx];
        rtb_Logic_d[1] = BaseEngineController_LS_128_ConstP.pooled889[rowidx + 8];
      }

      /* Outputs for Enabled SubSystem: '<S344>/GetInstRPM' */
      BaseEngineController_LS_128_GetInstRPM(rtb_Logic_d[1],
        &BaseEngineController_LS_128_B.s344_GetInstRPM);
      ...
      if (rtb_Logic_d[1]) {
        ...
        rtb_Product_a = 1.0 + rtb_UnitDelay2_i;
      }
      ...
      if (rtb_Logic_d[1]) {
        ...
        /* Sum: '<S344>/Sum1' */
        rtb_DataTypeConversion1_f = (uint32_T)
          BaseEngineController_LS_128_B.s344_GetInstRPM.s352_motohawk_encoder_instant_rpm
          + (uint32_T)rtb_UnitDelay1_h;
        if (rtb_DataTypeConversion1_f > 65535U) {
          rtb_DataTypeConversion1_f = 65535U;
        }

        /* End of Sum: '<S344>/Sum1' */
        rtb_Sum_g1 = (uint16_T)rtb_DataTypeConversion1_f;
      }

      /* End of Switch: '<S344>/Switch1' */

      /* Logic: '<S328>/Logical Operator3' */
      rtb_LogicalOperator3_j = (rtb_LogicalOperator1_am[0] ||
        rtb_LogicalOperator1_am[1] || rtb_LogicalOperator1_am[2] ||
        rtb_LogicalOperator1_am[3] || rtb_LogicalOperator1_am[4] ||
        rtb_LogicalOperator1_am[5] || rtb_LogicalOperator1_am[6] ||
        rtb_LogicalOperator1_am[7]);

      /* Memory: '<S356>/Memory' */
      rtb_Memory_n = BaseEngineController_LS_128_DWork.s356_Memory_PreviousInput;
      ...
      /* CombinatorialLogic: '<S356>/Logic' */
      {
        ...
        rowidx = (rowidx << 1) + (uint_T)(rtb_LogicalOperator3_j != 0);
        rowidx = (rowidx << 1) + (uint_T)
          (BaseEngineController_LS_128_B.s345_RelationalOperator != 0);
        rowidx = (rowidx << 1) + (uint_T)(rtb_Memory_n != 0);

        /* Copy the appropriate row of the table into the block output vector */
        rtb_Logic_c[0] = BaseEngineController_LS_128_ConstP.pooled889[rowidx];
        rtb_Logic_c[1] = BaseEngineController_LS_128_ConstP.pooled889[rowidx + 8];
      }

      /* Outputs for Enabled SubSystem: '<S345>/GetInstRPM' */
      BaseEngineController_LS_128_GetInstRPM(rtb_Logic_c[1],
        &BaseEngineController_LS_128_B.s345_GetInstRPM);
      ...
      if (rtb_Logic_c[1]) {
         ...
         *  Sum: '<S345>/Sum'
         */
        BaseEngineController_LS_128_DWork.s345_UnitDelay2_DSTATE = 1.0 +
          rtb_UnitDelay2_h;
      }
      ...
      if (rtb_Logic_c[1]) {
         ...
         */
        BaseEngineController_LS_128_DWork.s345_UnitDelay1_DSTATE = 0U;
      } else {
        /* Sum: '<S345>/Sum1' */
        rtb_DataTypeConversion1_f = (uint32_T)
          BaseEngineController_LS_128_B.s345_GetInstRPM.s352_motohawk_encoder_instant_rpm
          + (uint32_T)rtb_UnitDelay1_e;
        if (rtb_DataTypeConversion1_f > 65535U) {
          rtb_DataTypeConversion1_f = 65535U;
        }
         ...
         *  Sum: '<S345>/Sum1'
         */
        BaseEngineController_LS_128_DWork.s345_UnitDelay1_DSTATE = (uint16_T)
          rtb_DataTypeConversion1_f;
      }
      ...
      for (i = 0; i < 8; i++) {
        BaseEngineController_LS_128_DWork.s331_UnitDelay_DSTATE[i] =
          rtb_motohawk_data_read2_h[i];
      }

      /* End of UnitDelay: '<S331>/Unit Delay' */

      /* Update for UnitDelay: '<S344>/Unit Delay1' */
      BaseEngineController_LS_128_DWork.s344_UnitDelay1_DSTATE = rtb_Sum_g1;

      /* Update for UnitDelay: '<S344>/Unit Delay2' */
      BaseEngineController_LS_128_DWork.s344_UnitDelay2_DSTATE = rtb_Product_a;

      /* Update for Memory: '<S353>/Memory' */
      BaseEngineController_LS_128_DWork.s353_Memory_PreviousInput = rtb_Logic_d
        [0];

      /* Update for Memory: '<S356>/Memory' */
      BaseEngineController_LS_128_DWork.s356_Memory_PreviousInput = rtb_Logic_c
        [0];
    }
  }
}
