...
#define BaseEngineController_LS_112_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_112_DWork.s93_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S93>/DFCO' */
    {
       ...
       */
      rtb_RelationalOperator_b = (BaseEngineController_LS_112_B.s555_Sum1 >=
       ...
       */
      rtb_RelationalOperator1_g = (BaseEngineController_LS_112_B.s443_Switch1 <=
       ...
       */
      rtb_LogicalOperator2_n = (BaseEngineController_LS_112_B.s606_Merge <=
      ...
      rtb_LogicalOperator1_a = !rtb_LogicalOperator4;
       ...
       *  Sum: '<S147>/Sum1'
       */
      BaseEngineController_LS_112_B.s147_LogicalOperator =
        ((rtb_RelationalOperator_b && rtb_RelationalOperator1_g &&
          rtb_LogicalOperator2_n && rtb_LogicalOperator1_a &&
          (DFCOEnable_DataStore()) && (BaseEngineController_LS_112_B.s555_Sum1 >=
       ...
       *  Sum: '<S150>/Sum'
       */
      if (BaseEngineController_LS_112_B.s147_LogicalOperator) {
        rtb_Switch_i = rtb_motohawk_delta_time_k + DFCOEnterTimer_DataStore();
      } else {
        rtb_Switch_i = 0.0;
      }
       ...
       */
      rtb_LogicalOperator2_n =
        (BaseEngineController_LS_112_B.s147_LogicalOperator && (rtb_Switch_i >=
       ...
       */
      rtb_RelationalOperator1_g = (BaseEngineController_LS_112_B.s555_Sum1 <=
       ...
       */
      rtb_LogicalOperator1_a = (BaseEngineController_LS_112_B.s443_Switch1 >=
       ...
       */
      rtb_LogicalOperator4 = ((rtb_RelationalOperator_b &&
        rtb_RelationalOperator1_g && rtb_LogicalOperator1_a &&
        (BaseEngineController_LS_112_B.s606_Merge >= (real_T)((uint8_T)
      ...
      /* CombinatorialLogic: '<S149>/Combinatorial  Logic' */
      {
        ...
        rowidx = (rowidx << 1) + (uint_T)(rtb_LogicalOperator2_n != 0);
      ...
      if (rtb_CombinatorialLogic[1]) {
        BaseEngineController_LS_112_B.s149_Switch1 = rtb_CombinatorialLogic[0];
      } else {
        BaseEngineController_LS_112_B.s149_Switch1 =
          BaseEngineController_LS_112_DWork.s149_UnitDelay_DSTATE;
      }
       ...
       */
      if (BaseEngineController_LS_112_B.s149_Switch1 == FALSE) {
        ...
        if ((DFCOExitRampTime_DataStore()) > 0.0) {
          rtb_Switch1_a = (DFCOExitRampTime_DataStore());
        } else {
          rtb_Switch1_a = rtb_motohawk_delta_time_j;
        }

        /* End of Switch: '<S148>/Switch' */
        rtb_Switch1_a = rtb_motohawk_delta_time_j / rtb_Switch1_a * -1.0;
      } else {
        ...
        if ((DFCOEnterRampTime_DataStore()) > 0.0) {
          rtb_Switch1_a = (DFCOEnterRampTime_DataStore());
        } else {
          rtb_Switch1_a = rtb_motohawk_delta_time_j;
        }

        /* End of Switch: '<S148>/Switch1' */
        rtb_Switch1_a = rtb_motohawk_delta_time_j / rtb_Switch1_a;
      }
       ...
       */
      rtb_Switch1_a += BaseEngineController_LS_112_DWork.s148_state_DSTATE;
       ...
       *  MinMax: '<S151>/MinMax'
       */
      rtb_Switch1_a = rtb_Switch1_a >= 0.0 ? rtb_Switch1_a : 0.0;
      rtb_Switch1_a = rtb_Switch1_a <= 1.0 ? rtb_Switch1_a : 1.0;

      /* Inport: '<S105>/EquivRatioInfo' */
      BaseEngineController_LS_112_B.s105_EquivRatioInfo[0] =
        BaseEngineController_LS_112_B.s103_DesEquivRatio;
      BaseEngineController_LS_112_B.s105_EquivRatioInfo[1] =
        BaseEngineController_LS_112_B.s103_WarmUpRatio;
      BaseEngineController_LS_112_B.s105_EquivRatioInfo[2] =
        BaseEngineController_LS_112_B.s127_Switch;
      BaseEngineController_LS_112_B.s105_EquivRatioInfo[3] =
        BaseEngineController_LS_112_B.s103_IATEnrichment;
      BaseEngineController_LS_112_B.s105_EquivRatioInfo[4] =
       ...
       *  Sum: '<S147>/Sum2'
       */
      BaseEngineController_LS_112_B.s147_Product1 = (1.0 - rtb_Switch1_a) *
        BaseEngineController_LS_112_B.s105_EquivRatioInfo[0];
       ...
       */
      BaseEngineController_LS_112_B.s147_SpkOut = rtb_Switch1_a * (real_T)
        ((int16_T)(DFCOExitSparkRet_DataStore()));

      /* Saturate: '<S150>/Saturation' */
      rtb_Saturation_b = rtb_Switch_i >= 16000.0 ? 16000.0 : rtb_Switch_i <= 0.0
        ? 0.0 : rtb_Switch_i;

      /* S-Function (motohawk_sfun_data_write): '<S150>/motohawk_data_write' */
      /* Write to Data Storage as scalar: DFCOEnterTimer */
      {
        DFCOEnterTimer_DataStore() = rtb_Saturation_b;
      }
       ...
       *  MinMax: '<S151>/MinMax1'
       */
      BaseEngineController_LS_112_DWork.s148_state_DSTATE = rtb_Switch1_a;
    }
    ...
    /* Output and update for function-call system: '<S93>/MinGovernor' */
    {
      ...
      real_T rtb_motohawk_delta_time_li;
      real_T rtb_motohawk_delta_time_km;
      ...
      real_T rtb_Switch_f;
      int16_T rtb_motohawk_interpolation_1d2_nn;
       ...
       */
      rtb_Sum2_b = BaseEngineController_LS_112_B.s481_RPMInst -
        BaseEngineController_LS_112_DWork.s224_UnitDelay_DSTATE;

      /* S-Function Block: <S224>/motohawk_delta_time */
      rtb_motohawk_delta_time_l = 0.005;

      /* Product: '<S224>/Product' incorporates:
       *  S-Function (motohawk_sfun_delta_time): '<S224>/motohawk_delta_time'
       */
      rtb_Sum2_b /= rtb_motohawk_delta_time_l;
       ...
       */
      rtb_Switch_f /= (rtb_Switch_f >= (RPMFallingFiltConst_DataStore())) ||
        rtIsNaN((RPMFallingFiltConst_DataStore())) ? rtb_Switch_f :
       ...
       */
      rtb_Sum1_i = (1.0 - rtb_Switch_f) *
        BaseEngineController_LS_112_DWork.s226_UnitDelay_DSTATE + rtb_Sum2_b *
        rtb_Switch_f;
       ...
       */
      BaseEngineController_LS_112_B.s220_RelationalOperator = ((rtb_Sum1_i <
      ...
      if (rtIsNaN(BaseEngineController_LS_112_B.s481_RPMInst) || rtIsInf
        ...
        rtb_Sum2_b = fmod(floor(BaseEngineController_LS_112_B.s481_RPMInst),
                          65536.0);
      }

      rtb_DataTypeConversion_g = (int16_T)(rtb_Sum2_b < 0.0 ? (int16_T)-(int16_T)
        (uint16_T)-rtb_Sum2_b : (int16_T)(uint16_T)rtb_Sum2_b);
      ...
      /* S-Function Block: <S204>/motohawk_interpolation_1d2 */
      {
        ...
        rtb_motohawk_interpolation_1d2_nn = TableInterpolation1D_int16_T
          (BaseEngineController_LS_112_B.s431_motohawk_prelookup, (int16_T *)
           ((MinGovClntRPMSetPtTbl_DataStore())), 5);
        (MinGovClntRPMSetPt_DataStore()) = rtb_motohawk_interpolation_1d2_nn;
      }
      ...
      tmp = ((int16_T)(InGearMinGovEntryRPMDelta_DataStore())) +
        rtb_motohawk_interpolation_1d2_nn;
      if (tmp > 32767) {
        tmp = 32767;
      } else {
        if (tmp <= -32768) {
      ...
      if (AirControlSource_DataStore() == FALSE) {
        rtb_Switch_f = BaseEngineController_LS_112_B.s443_Switch1;
      } else {
        rtb_Switch_f = BaseEngineController_LS_112_B.s450_Switch2;
      }
       ...
       */
      BaseEngineController_LS_112_B.s206_RelationalOperator1 = ((rtb_Switch_f <
       ...
       */
      if (AirControlSource_DataStore() == FALSE) {
        rtb_RelationalOperator2_b = (BaseEngineController_LS_112_B.s458_Sum2 >
          BaseEngineController_LS_112_DWork.s110_UnitDelay3_DSTATE);
      } else {
        rtb_RelationalOperator2_b = TRUE;
      }
       ...
       *  Sum: '<S206>/Sum1'
       */
      BaseEngineController_LS_112_B.s206_LogicalOperator = (((rtb_Switch_f >=
       ...
       *  Sum: '<S223>/Sum'
       */
      if (BaseEngineController_LS_112_B.s206_RelationalOperator1) {
        rtb_Switch_f = rtb_motohawk_delta_time_g + IdleEnterTimer_DataStore();
      } else {
        rtb_Switch_f = 0.0;
      }
       ...
       */
      BaseEngineController_LS_112_B.s206_RelationalOperator5 = ((rtb_Switch_f >
        (MinGovEntryAirTimeThresh_DataStore())));

      /* Stateflow: '<S206>/IdleStateMachine' */
      BaseEngineController_LS_112_IdleStateMachine();

      /* RelationalOperator: '<S222>/RelOp' incorporates:
       *  Constant: '<S222>/Constant'
       */
      BaseEngineController_LS_112_B.s222_RelOp =
        ((BaseEngineController_LS_112_B.s221_IdleState == 2));

      /* UnitDelay: '<S110>/Unit Delay1' */
      rtb_UnitDelay1_f =
        BaseEngineController_LS_112_DWork.s110_UnitDelay1_DSTATE;
      ...
      if (BaseEngineController_LS_112_B.s222_RelOp) {
         ...
         */
        rtb_Sum2_b = rtb_UnitDelay1_f * (BaseAirflowAdaptGain_DataStore());

        /* MinMax: '<S218>/MinMax' incorporates:
         *  S-Function (motohawk_sfun_calibration): '<S216>/motohawk_calibration'
         */
        rtb_Sum2_b = (rtb_Sum2_b >= (BaseAirflowAdaptErrorLwrLim_DataStore())) ||
          rtIsNaN((BaseAirflowAdaptErrorLwrLim_DataStore())) ? rtb_Sum2_b :
         ...
         */
        rtb_MinMax1_as = (rtb_Sum2_b <= (BaseAirflowAdaptErrorUprLim_DataStore()))
          || rtIsNaN((BaseAirflowAdaptErrorUprLim_DataStore())) ? rtb_Sum2_b :
         ...
         */
        if (BaseEngineController_LS_112_B.s222_RelOp) {
          rtb_Sum2_b = rtb_motohawk_delta_time_o + BaseAirflowTimer_DataStore();
        } else {
          rtb_Sum2_b = 0.0;
        }
         ...
         */
        BaseEngineController_LS_112_B.s203_LogicalOperator1 =
          (((BaseAirflowAdaptEnable_DataStore()) && rtb_RelationalOperator2_b &&
            (fabs(rtb_UnitDelay1_f) <= (BaseAirflowAdaptDelta_DataStore()))));

        /* Outputs for Enabled SubSystem: '<S203>/Adapt Base Airflow Table' incorporates:
         *  EnablePort: '<S214>/Enable'
         */
        if (BaseEngineController_LS_112_B.s203_LogicalOperator1) {
          ...
          /* Adapt 1-D Table */
          {
            ...
            if (_frac == 0) {
              _new = (BaseAirflowOfstTbl_DataStore())[_i] + rtb_MinMax1_as;
              ...
              _new = (BaseAirflowOfstTbl_DataStore())[_i+1] + rtb_MinMax1_as;
              if (_new > (BaseAirflowOfstMaxValue_DataStore()))
                _new = (BaseAirflowOfstMaxValue_DataStore());
              if (_new < (BaseAirflowOfstMinValue_DataStore()))
                _new = (BaseAirflowOfstMinValue_DataStore());
      ...
      /* S-Function Block: <S205>/motohawk_delta_time */
      {
        ...
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_112_DWork.s205_motohawk_delta_time_DWORK1,
           NULL);
        rtb_motohawk_delta_time_li = ((real_T) delta) * 0.000001;
      }
       ...
       */
      if (BaseEngineController_LS_112_B.s222_RelOp == FALSE) {
        ...
        if ((IdleExitTimeConst_DataStore()) > 0.0) {
          rtb_Sum2_b = (IdleExitTimeConst_DataStore());
        } else {
          rtb_Sum2_b = rtb_motohawk_delta_time_li;
        }

        /* End of Switch: '<S205>/Switch' */
        rtb_Product5 = rtb_motohawk_delta_time_li / rtb_Sum2_b * -1.0;
      } else {
        rtb_Product5 = rtb_motohawk_delta_time_li / rtb_motohawk_delta_time_li;
      }
       ...
       */
      rtb_Product5 += BaseEngineController_LS_112_DWork.s205_state_DSTATE;
       ...
       *  MinMax: '<S219>/MinMax'
       */
      rtb_Sum2_b = rtb_Product5 >= 0.0 ? rtb_Product5 : 0.0;
      BaseEngineController_LS_112_B.s219_MinMax1 = rtb_Sum2_b <= 1.0 ?
        rtb_Sum2_b : 1.0;

      /* RelationalOperator: '<S208>/RelOp' incorporates:
       *  Constant: '<S208>/Constant'
       */
      rtb_RelationalOperator2_b = (BaseEngineController_LS_112_B.s219_MinMax1 ==
        0.0);

      /* UnitDelay: '<S110>/Unit Delay2' */
      rtb_Sum2_b = BaseEngineController_LS_112_DWork.s110_UnitDelay2_DSTATE;
      ...
      zcEvent = rt_ZCFcn(FALLING_ZERO_CROSSING,
                         ...
                         (BaseEngineController_LS_112_DWork.s110_UnitDelay2_DSTATE
                          - 0.5));
      if (BaseEngineController_LS_112_DWork.s110_HitCrossing1_MODE == 0) {
        if (zcEvent != NO_ZCEVENT) {
          BaseEngineController_LS_112_B.s110_HitCrossing1 =
            !BaseEngineController_LS_112_B.s110_HitCrossing1;
          BaseEngineController_LS_112_DWork.s110_HitCrossing1_MODE = 1;
        } else {
          if (BaseEngineController_LS_112_B.s110_HitCrossing1 && (rtb_Sum2_b !=
               0.5)) {
            BaseEngineController_LS_112_B.s110_HitCrossing1 = FALSE;
          }
        }
      } else {
        if (rtb_Sum2_b != 0.5) {
        ...
        BaseEngineController_LS_112_DWork.s110_HitCrossing1_MODE = 0;
      }

      /* End of HitCross: '<S110>/Hit  Crossing1' */

      /* Logic: '<S110>/Logical Operator' */
      BaseEngineController_LS_112_B.s110_LogicalOperator =
        ((rtb_RelationalOperator2_b ||
          BaseEngineController_LS_112_B.s110_HitCrossing1));

      /* DataTypeConversion: '<S110>/Data Type Conversion' */
      rtb_DataTypeConversion_j = (real_T)rtb_motohawk_interpolation_1d2_nn;

      /* Logic: '<S209>/Logical Operator' */
      rtb_LogicalOperator_c = !BaseEngineController_LS_112_B.s222_RelOp;
      ...
      /* S-Function Block: <S209>/motohawk_delta_time */
      {
        ...
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_112_DWork.s209_motohawk_delta_time_DWORK1,
           NULL);
        rtb_motohawk_delta_time_km = ((real_T) delta) * 0.000001;
      }

      /* UnitDelay: '<S209>/Unit Delay' */
      rtb_Sum2_b = BaseEngineController_LS_112_DWork.s209_UnitDelay_DSTATE;
      ...
      if (rtb_LogicalOperator_c) {
        rtb_Product5 = BaseEngineController_LS_112_B.s481_RPMInst;
      } else {
         ...
         */
        rtb_UnitDelay1_f = rtb_motohawk_delta_time_km /
          (InGearRPMCtrlEntryFiltC_DataStore());
        rtb_Product5 = (1.0 - rtb_UnitDelay1_f) * rtb_Sum2_b +
          rtb_DataTypeConversion_j * rtb_UnitDelay1_f;
      }
      ...
      BaseEngineController_LS_112_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM
        = (rtb_DataTypeConversion_j >= rtb_Product5) || rtIsNaN(rtb_Product5) ?
        rtb_DataTypeConversion_j : rtb_Product5;

      /* Sum: '<S235>/Sum2' */
      BaseEngineController_LS_112_B.s235_Sum2 =
        BaseEngineController_LS_112_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM
       ...
       */
      rtb_Product5 = BaseEngineController_LS_112_B.s235_Sum2 *
       ...
       */
      BaseEngineController_LS_112_B.s235_Product2 = (AirMinGovPGain_DataStore())
        * rtb_motohawk_interpolation_1d2 * rtb_Product5;

      /* UnitDelay: '<S236>/Unit Delay' */
      rtb_Sum2_b = BaseEngineController_LS_112_DWork.s236_UnitDelay_DSTATE;
       ...
       *  Sum: '<S236>/Sum2'
       */
      BaseEngineController_LS_112_B.s236_Product = (rtb_Product4 - rtb_Sum2_b) /
        rtb_motohawk_delta_time_j3;

      /* Switch: '<S237>/Switch1' incorporates:
       *  Constant: '<S211>/Constant'
       *  UnitDelay: '<S237>/Unit Delay'
       */
      if (BaseEngineController_LS_112_B.s110_LogicalOperator) {
        BaseEngineController_LS_112_B.s237_Switch1 = 0.0;
      } else {
        BaseEngineController_LS_112_B.s237_Switch1 =
          BaseEngineController_LS_112_DWork.s237_UnitDelay_DSTATE;
      }
       ...
       */
      if (BaseEngineController_LS_112_B.s110_LogicalOperator) {
        rtb_UnitDelay1_f = 0.0;
      } else {
        /* MinMax: '<S234>/MinMax' incorporates:
         *  Sum: '<S235>/Sum1'
         */
        rtb_Sum2_b = (BaseEngineController_LS_112_B.s235_Product2 +
                      BaseEngineController_LS_112_B.s236_Product) +
          BaseEngineController_LS_112_B.s237_Switch1;
         ...
         */
        rtb_Sum2_b = (rtb_Sum2_b >= (AirMinGovPIDOutLowerLimit_DataStore())) ||
          rtIsNaN((AirMinGovPIDOutLowerLimit_DataStore())) ? rtb_Sum2_b :
          (AirMinGovPIDOutLowerLimit_DataStore());
        rtb_UnitDelay1_f = (rtb_Sum2_b <= (AirMinGovPIDOutUpperLimit_DataStore()))
          || rtIsNaN((AirMinGovPIDOutUpperLimit_DataStore())) ? rtb_Sum2_b :
      ...
      BaseEngineController_LS_112_B.s110_MinGovAirPID =
        BaseEngineController_LS_112_B.s219_MinMax1 * rtb_UnitDelay1_f;

      /* Sum: '<S230>/Sum1' */
      BaseEngineController_LS_112_B.s230_Sum1 =
        BaseEngineController_LS_112_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM
        - BaseEngineController_LS_112_B.s555_Sum1;
       ...
       */
      rtb_UnitDelay1_f = BaseEngineController_LS_112_B.s230_Sum1 *
      ...
      /* S-Function Block: <S228>/motohawk_interpolation_1d2 */
      {
        ...
        (SpkMinGovPGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d2_c;
      }
       ...
       */
      BaseEngineController_LS_112_B.s230_Product = (SpkMinGovPGain_DataStore()) *
        rtb_motohawk_interpolation_1d2_c * rtb_UnitDelay1_f;

      /* UnitDelay: '<S231>/Unit Delay' */
      rtb_Sum2_b = BaseEngineController_LS_112_DWork.s231_UnitDelay_DSTATE;
      ...
      /* S-Function Block: <S228>/motohawk_interpolation_1d1 */
      {
        ...
        (SpkMinGovDGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d1_e;
      }
       ...
       *  S-Function (motohawk_sfun_prelookup): '<S210>/motohawk_prelookup1'
       */
      rtb_Product2_o = (SpkMinGovDGain_DataStore()) *
        rtb_motohawk_interpolation_1d1_e * rtb_UnitDelay1_f;
       ...
       *  Sum: '<S231>/Sum2'
       */
      BaseEngineController_LS_112_B.s231_Product = (rtb_Product2_o - rtb_Sum2_b)
      ...
      if (rtb_RelationalOperator2_b) {
         ...
         *  Sum: '<S230>/Sum'
         */
        rtb_Sum2_b = BaseEngineController_LS_112_B.s230_Product +
          BaseEngineController_LS_112_B.s231_Product;
         ...
         */
        rtb_Sum2_b = (rtb_Sum2_b >= (SpkMinGovPIDOutLowerLimit_DataStore())) ||
          rtIsNaN((SpkMinGovPIDOutLowerLimit_DataStore())) ? rtb_Sum2_b :
          (SpkMinGovPIDOutLowerLimit_DataStore());
        rtb_UnitDelay1_f = (rtb_Sum2_b <= (SpkMinGovPIDOutUpperLimit_DataStore()))
          || rtIsNaN((SpkMinGovPIDOutUpperLimit_DataStore())) ? rtb_Sum2_b :
      ...
      BaseEngineController_LS_112_B.s110_IdleSpk =
        BaseEngineController_LS_112_B.s219_MinMax1 * rtb_UnitDelay1_f;
      ...
      /* S-Function Block: <S202>/motohawk_interpolation_1d1 */
      {
        ...
        (ACAirFlowOfst_DataStore()) = rtb_motohawk_interpolation_1d1_m;
      }

      /* Product: '<S202>/Product' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S202>/motohawk_calibration'
       */
      rtb_Sum2_b = ((ACAirFlowOfst_Enab_DataStore()) ? (real_T)
                    BaseEngineController_LS_112_B.s101_LogicalOperator : 0.0) *
      ...
      /* S-Function Block: <S202>/motohawk_interpolation_1d2 */
      {
        ...
        (BaseAirflowOfst_DataStore()) = rtb_motohawk_interpolation_1d2_n;
      }

      /* Sum: '<S202>/Sum' incorporates:
       *  S-Function (motohawk_sfun_interpolation_1d): '<S202>/motohawk_interpolation_1d2'
       */
      rtb_DataTypeConversion_j = rtb_Sum2_b + rtb_motohawk_interpolation_1d2_n;
       ...
       */
      rtb_RelationalOperator2_b = ((rtb_RelOp <
        BaseEngineController_LS_112_DWork.s202_UnitDelay_DSTATE) || (rtb_RelOp ==
        BaseEngineController_LS_112_DWork.s202_UnitDelay_DSTATE));
      ...
      rtb_Sum2_b = BaseEngineController_LS_112_DWork.s212_UnitDelay_DSTATE;
       ...
       */
      if (!rtb_RelationalOperator2_b) {
        rtb_Sum2_b = BaseEngineController_LS_112_B.s450_Switch2;
      } else {
         ...
         */
        rtb_UnitDelay1_f = rtb_motohawk_delta_time_e /
          (IdleEntryAirRampInFiltC_DataStore());
        rtb_Sum2_b = (1.0 - rtb_UnitDelay1_f) * rtb_Sum2_b +
          rtb_DataTypeConversion_j * rtb_UnitDelay1_f;
      }
      ...
      BaseEngineController_LS_112_B.s212_DontallowsetpointtoeverdropbelowtheTargetRPM
        = (rtb_DataTypeConversion_j >= rtb_Sum2_b) || rtIsNaN(rtb_Sum2_b) ?
        rtb_DataTypeConversion_j : rtb_Sum2_b;

      /* End of Outputs for SubSystem: '<S110>/AiflowOffset' */

      /* Saturate: '<S223>/Saturation' */
      rtb_Saturation_l = rtb_Switch_f >= 16000.0 ? 16000.0 : rtb_Switch_f <= 0.0
        ? 0.0 : rtb_Switch_f;

      /* S-Function (motohawk_sfun_data_write): '<S223>/motohawk_data_write' */
      /* Write to Data Storage as scalar: IdleEnterTimer */
      {
        IdleEnterTimer_DataStore() = rtb_Saturation_l;
      }
      ...
      /* Sum: '<S207>/Sum' */
      rtb_UnitDelay1_f = BaseEngineController_LS_112_B.s555_Sum1 -
        BaseEngineController_LS_112_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM;
       ...
       *  Sum: '<S227>/Sum'
       */
      if (rtb_UnitDelay1_f > (real_T)((int16_T)(MotoringDeltaRPMLimit_DataStore())))
      {
        BaseEngineController_LS_112_B.s227_Switch = rtb_motohawk_delta_time_kh +
       ...
       */
      BaseEngineController_LS_112_B.s207_RelationalOperator1 =
        ((BaseEngineController_LS_112_B.s227_Switch >
      ...
      rtb_Saturation_a = BaseEngineController_LS_112_B.s227_Switch >= 16000.0 ?
        16000.0 : BaseEngineController_LS_112_B.s227_Switch <= 0.0 ? 0.0 :
        BaseEngineController_LS_112_B.s227_Switch;
      ...
      /* S-Function Block: <S233>/motohawk_interpolation_1d1 */
      {
        ...
        (AirMinGovIGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d1_n;
      }
       ...
       *  S-Function (motohawk_sfun_prelookup): '<S211>/motohawk_prelookup1'
       */
      rtb_Sum2_b = (AirMinGovIGain_DataStore()) *
        rtb_motohawk_interpolation_1d1_n * rtb_Product5;
       ...
       */
      rtb_UnitDelay1_f = rtb_Sum2_b * rtb_motohawk_delta_time_gs +
        BaseEngineController_LS_112_B.s237_Switch1;

      /* MinMax: '<S239>/MinMax' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S211>/motohawk_calibration7'
       */
      rtb_Sum2_b = (rtb_UnitDelay1_f >= (AirMinGovITermLowerLimit_DataStore())) ||
        rtIsNaN((AirMinGovITermLowerLimit_DataStore())) ? rtb_UnitDelay1_f :
      ...
      BaseEngineController_LS_112_DWork.s226_UnitDelay_DSTATE = rtb_Sum1_i;
      ...
      BaseEngineController_LS_112_DWork.s205_state_DSTATE =
        BaseEngineController_LS_112_B.s219_MinMax1;
      ...
      BaseEngineController_LS_112_DWork.s209_UnitDelay_DSTATE =
        BaseEngineController_LS_112_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM;

      /* Update for UnitDelay: '<S236>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s236_UnitDelay_DSTATE = rtb_Product4;
       ...
       */
      BaseEngineController_LS_112_DWork.s237_UnitDelay_DSTATE = (rtb_Sum2_b <=
        (AirMinGovITermUpperLimit_DataStore())) || rtIsNaN
        ((AirMinGovITermUpperLimit_DataStore())) ? rtb_Sum2_b :
        (AirMinGovITermUpperLimit_DataStore());

      /* Update for UnitDelay: '<S231>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s231_UnitDelay_DSTATE = rtb_Product2_o;
      ...
      BaseEngineController_LS_112_DWork.s212_UnitDelay_DSTATE =
        BaseEngineController_LS_112_B.s212_DontallowsetpointtoeverdropbelowtheTargetRPM;
    ...
    /* Output and update for function-call system: '<S93>/AC Control' */
    {
      ...
      boolean_T rtb_Switch1_b;
      boolean_T rtb_Switch1_h;
      boolean_T rtb_LogicalOperator3_j;
      boolean_T rtb_Switch1_h3;
       ...
       */
      rtb_BelowLoTarget = (BaseEngineController_LS_112_B.s674_Merge >=
                           (ACTempOn_DataStore()));

      /* RelationalOperator: '<S118>/LT1' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S101>/motohawk_calibration8'
       */
      rtb_AboveHiTarget = (BaseEngineController_LS_112_B.s674_Merge <=
                           (ACTempOff_DataStore()));
      ...
      if (rtb_CombinatorialLogic_j[1]) {
        BaseEngineController_LS_112_B.s124_Switch1 = rtb_CombinatorialLogic_j[0];
      } else {
        BaseEngineController_LS_112_B.s124_Switch1 =
          BaseEngineController_LS_112_DWork.s124_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S124>/Switch1' */

      /* DataTypeConversion: '<S101>/Data Type Conversion' */
      if (rtIsNaN(BaseEngineController_LS_112_B.s555_Sum1) || rtIsInf
          (BaseEngineController_LS_112_B.s555_Sum1)) {
        tmp = 0.0;
      } else {
        tmp = fmod(floor(BaseEngineController_LS_112_B.s555_Sum1), 65536.0);
      }
       ...
       */
      if (rtb_CombinatorialLogic_j[1]) {
        BaseEngineController_LS_112_B.s123_Switch1 = rtb_CombinatorialLogic_j[0];
      } else {
        BaseEngineController_LS_112_B.s123_Switch1 =
          BaseEngineController_LS_112_DWork.s123_UnitDelay_DSTATE;
      }
       ...
       */
      if (rtb_CombinatorialLogic_j[1]) {
        rtb_Switch1_b = rtb_CombinatorialLogic_j[0];
      } else {
        rtb_Switch1_b = BaseEngineController_LS_112_DWork.s121_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S121>/Switch1' */

      /* Logic: '<S101>/Logical Operator2' */
      BaseEngineController_LS_112_B.s101_LogicalOperator2 = !rtb_Switch1_b;

      /* DataTypeConversion: '<S101>/Data Type Conversion2' */
      if (rtIsNaN(BaseEngineController_LS_112_B.s450_Switch2) || rtIsInf
          (BaseEngineController_LS_112_B.s450_Switch2)) {
        tmp = 0.0;
      } else {
        tmp = fmod(floor(BaseEngineController_LS_112_B.s450_Switch2), 65536.0);
      }
       ...
       */
      if (rtb_CombinatorialLogic_j[1]) {
        rtb_Switch1_h = rtb_CombinatorialLogic_j[0];
      } else {
        rtb_Switch1_h = BaseEngineController_LS_112_DWork.s122_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S122>/Switch1' */

      /* Logic: '<S101>/Logical Operator4' */
      BaseEngineController_LS_112_B.s101_LogicalOperator4 = !rtb_Switch1_h;

      /* Logic: '<S101>/Logical Operator3' */
      rtb_LogicalOperator3_j = (BaseEngineController_LS_112_B.s123_Switch1 &&
        BaseEngineController_LS_112_B.s101_LogicalOperator2);

      /* DataTypeConversion: '<S101>/Data Type Conversion1' */
      if (rtIsNaN(BaseEngineController_LS_112_B.s569_Merge) || rtIsInf
          (BaseEngineController_LS_112_B.s569_Merge)) {
        tmp = 0.0;
      } else {
        tmp = fmod(floor(BaseEngineController_LS_112_B.s569_Merge), 65536.0);
      }
       ...
       */
      if (rtb_CombinatorialLogic_j[1]) {
        BaseEngineController_LS_112_B.s120_Switch1 = rtb_CombinatorialLogic_j[0];
      } else {
        BaseEngineController_LS_112_B.s120_Switch1 =
          BaseEngineController_LS_112_DWork.s120_UnitDelay_DSTATE;
      }
       ...
       */
      if (rtb_CombinatorialLogic_j[1]) {
        rtb_Switch1_h3 = rtb_CombinatorialLogic_j[0];
      } else {
        rtb_Switch1_h3 = BaseEngineController_LS_112_DWork.s119_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S119>/Switch1' */

      /* Logic: '<S101>/Logical Operator1' */
      BaseEngineController_LS_112_B.s101_LogicalOperator1 = !rtb_Switch1_h3;

      /* RelationalOperator: '<S101>/Relational Operator' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S101>/motohawk_calibration7'
       */
      rtb_RelationalOperator_i = (BaseEngineController_LS_112_B.s471_Switch >=
      ...
      BaseEngineController_LS_112_B.s101_LogicalOperator =
        ((BaseEngineController_LS_112_B.s512_Merge &&
          BaseEngineController_LS_112_B.s124_Switch1 && rtb_LogicalOperator3_j &&
          BaseEngineController_LS_112_B.s101_LogicalOperator4 &&
          BaseEngineController_LS_112_B.s120_Switch1 &&
          BaseEngineController_LS_112_B.s101_LogicalOperator1 &&
          rtb_RelationalOperator_i && (!GetFaultActionStatus(3))));
      ...
      BaseEngineController_LS_112_DWork.s121_UnitDelay_DSTATE = rtb_Switch1_b;

      /* Update for UnitDelay: '<S122>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s122_UnitDelay_DSTATE = rtb_Switch1_h;
      ...
      BaseEngineController_LS_112_DWork.s119_UnitDelay_DSTATE = rtb_Switch1_h3;
    }
    ...
    /* Output and update for function-call system: '<S93>/Boost Control' */
    {
      ...
      real_T rtb_motohawk_delta_time_kn;
      ...
      real_T rtb_MinMax1_br;
      real_T rtb_motohawk_delta_time_jo;
       ...
       *  Sum: '<S104>/Sum1'
       */
      rtb_kPatoPSI = (BaseEngineController_LS_112_B.s606_Merge -
                      BaseEngineController_LS_112_B.s405_Sum) * 0.145038;

      /* RelationalOperator: '<S104>/Relational Operator' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S104>/motohawk_calibration2'
       */
      rtb_RelationalOperator_bd = (rtb_kPatoPSI <
        (BoostActivationThreshold_DataStore()));

      /* UnitDelay: '<S104>/Unit Delay' */
      rtb_UnitDelay_dj = BaseEngineController_LS_112_DWork.s104_UnitDelay_DSTATE;
      ...
      if (!rtb_RelationalOperator_bd) {
         ...
         */
        rtb_Abs_g = rtb_UnitDelay_dj * (BoostControlAdaptGain_DataStore());

        /* MinMax: '<S138>/MinMax' incorporates:
         *  S-Function (motohawk_sfun_calibration): '<S136>/motohawk_calibration'
         */
        maxV = (rtb_Abs_g >= (BoostAdaptErrorLwrLim_DataStore())) || rtIsNaN
          ((BoostAdaptErrorLwrLim_DataStore())) ? rtb_Abs_g :
         ...
         */
        rtb_MinMax1_br = (maxV <= (BoostAdaptErrorUprLim_DataStore())) ||
         ...
         */
        BaseEngineController_LS_112_B.s131_LogicalOperator1 =
          (((BoostControlAdaptEnable_DataStore()) && rtb_LogicalOperator_p &&
            (fabs(rtb_UnitDelay_dj) <= (BoostControlAdaptDelta_DataStore()))));

        /* Outputs for Enabled SubSystem: '<S131>/Adapt Boost Table' incorporates:
         *  EnablePort: '<S134>/Enable'
         */
        if (BaseEngineController_LS_112_B.s131_LogicalOperator1) {
          ...
          /* Adapt 2-D Table */
          {
            ...
            if (_row_frac == 0) {
              ...
              if (_col_frac == 0) {
                ...
                real_T _quarter = (rtb_MinMax1_br) / 4;
                _new = (BoostControlBase_AdaptMap_DataStore())[_row][_col] +
                  _quarter;
                if (_new > (BoostControlOfstMaxValue_DataStore()))
                  _new = (BoostControlOfstMaxValue_DataStore());
      ...
      if (rtb_RelationalOperator_bd) {
        ...
        BaseEngineController_LS_112_B.s143_Switch1 =
          BaseEngineController_LS_112_DWork.s143_UnitDelay_DSTATE;
      }
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_2d2 */
      {
        ...
        rtb_motohawk_interpolation_2d2 = TableInterpolation2D_int8_T
          (BaseEngineController_LS_112_B.s438_motohawk_prelookup,
           BaseEngineController_LS_112_B.s435_motohawk_prelookup1, (int8_T *)
       ...
       */
      rtb_UnitDelay_dj = (real_T)BaseEngineController_LS_112_B.s531_Merge *
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_1d */
      {
        extern int8_T TableInterpolation1D_int8_T(uint16_T idx, int8_T *tbl_data,
          uint32_T sz);
        rtb_MinMax_nj = TableInterpolation1D_int8_T
          (BaseEngineController_LS_112_B.s431_motohawk_prelookup, (int8_T *)
           ((BoostECTLimitTbl_DataStore())), 5);
        (BoostECTLimit_DataStore()) = rtb_MinMax_nj;
      }
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_1d3 */
      {
        ...
        rtb_motohawk_interpolation_1d3_m = TableInterpolation1D_int8_T
          (BaseEngineController_LS_112_B.s432_motohawk_prelookup, (int8_T *)
           ((BoostIATLimitTbl_DataStore())), 5);
        (BoostIATLimit_DataStore()) = rtb_motohawk_interpolation_1d3_m;
      }

      /* MinMax: '<S104>/MinMax' */
      rtb_MinMax_nj = (int8_T)(rtb_MinMax_nj <= rtb_motohawk_interpolation_1d3_m
        ? rtb_MinMax_nj : rtb_motohawk_interpolation_1d3_m);

      /* MinMax: '<S104>/MinMax2' */
      rtb_Abs_g = (real_T)rtb_MinMax_nj;
      BaseEngineController_LS_112_B.s104_MinMax2 = rtb_UnitDelay_dj <= rtb_Abs_g
        ? rtb_UnitDelay_dj : rtb_Abs_g;

      /* UnitDelay: '<S133>/Unit Delay' */
      rtb_Abs_g = BaseEngineController_LS_112_DWork.s133_UnitDelay_DSTATE;
       ...
       *  UnitDelay: '<S133>/Unit Delay'
       */
      rtb_UnitDelay_dj = 1.0 / rtb_motohawk_delta_time_cz *
        (BaseEngineController_LS_112_B.s104_MinMax2 -
         BaseEngineController_LS_112_DWork.s133_UnitDelay_DSTATE);

      /* MinMax: '<S146>/MinMax' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S104>/motohawk_calibration1'
       */
      maxV = (rtb_UnitDelay_dj >= (BoostFallRate_DataStore())) || rtIsNaN
        ((BoostFallRate_DataStore())) ? rtb_UnitDelay_dj :
       ...
       *  S-Function (motohawk_sfun_delta_time): '<S133>/motohawk_delta_time'
       */
      rtb_Sum2_n = ((maxV <= (BoostRiseRate_DataStore())) || rtIsNaN
                    ((BoostRiseRate_DataStore())) ? maxV :
                    (BoostRiseRate_DataStore())) * rtb_motohawk_delta_time_cz +
        rtb_Abs_g;

      /* Sum: '<S141>/Sum2' */
      BaseEngineController_LS_112_B.s141_Sum2 = rtb_Sum2_n - rtb_kPatoPSI;

      /* Product: '<S141>/Product5' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S132>/motohawk_calibration5'
       */
      rtb_UnitDelay_dj = BaseEngineController_LS_112_B.s141_Sum2 *
      ...
      /* S-Function Block: <S139>/motohawk_interpolation_1d2 */
      {
        ...
        rtb_motohawk_interpolation_1d2_o = TableInterpolation1D_real_T
          (rtb_motohawk_prelookup1_a, (real_T *)
           ((BoostCtlPGainErrorMultTbl_DataStore())), 9);
        (BoostCtlPGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d2_o;
      }
       ...
       */
      BaseEngineController_LS_112_B.s141_Product2 = (BoostCtlPGain_DataStore()) *
        rtb_motohawk_interpolation_1d2_o * rtb_UnitDelay_dj;

      /* UnitDelay: '<S142>/Unit Delay' */
      rtb_Abs_g = BaseEngineController_LS_112_DWork.s142_UnitDelay_DSTATE;
      ...
      rtb_kPatoPSI = (BoostCtlDGain_DataStore()) *
        rtb_motohawk_interpolation_1d3_i * rtb_UnitDelay_dj;

      /* S-Function Block: <S142>/motohawk_delta_time */
      rtb_motohawk_delta_time_kn = 0.005;

      /* Product: '<S142>/Product' incorporates:
       *  S-Function (motohawk_sfun_delta_time): '<S142>/motohawk_delta_time'
       *  Sum: '<S142>/Sum2'
       */
      BaseEngineController_LS_112_B.s142_Product = (rtb_kPatoPSI - rtb_Abs_g) /
        rtb_motohawk_delta_time_kn;
      ...
      if (rtb_RelationalOperator_bd) {
         ...
         *  Sum: '<S141>/Sum1'
         */
        rtb_Abs_g = (BaseEngineController_LS_112_B.s141_Product2 +
                     BaseEngineController_LS_112_B.s142_Product) +
          BaseEngineController_LS_112_B.s143_Switch1;
        rtb_Abs_g = (rtb_Abs_g >= (BoostCtlPIDOutLowerLimit_DataStore())) ||
          rtIsNaN((BoostCtlPIDOutLowerLimit_DataStore())) ? rtb_Abs_g :
         ...
         */
        BaseEngineController_LS_112_B.s132_Switch = (rtb_Abs_g <=
          (BoostCtlPIDOutUpperLimit_DataStore())) || rtIsNaN
          ((BoostCtlPIDOutUpperLimit_DataStore())) ? rtb_Abs_g :
      ...
      /* S-Function Block: <S104>/motohawk_prelookup */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (BoostTargetIn_DataStore()) = BaseEngineController_LS_112_B.s104_MinMax2;
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_2d */
      {
        ...
        BaseEngineController_LS_112_B.s104_motohawk_interpolation_2d =
          TableInterpolation2D_uint8_T(rtb_motohawk_prelookup,
          BaseEngineController_LS_112_B.s435_motohawk_prelookup1, (uint8_T *)
       ...
       */
      rtb_Abs_g = (rtb_motohawk_interpolation_2d1_d + (real_T)
                   BaseEngineController_LS_112_B.s104_motohawk_interpolation_2d)
        + BaseEngineController_LS_112_B.s132_Switch;
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_1d2 */
      {
        ...
        (WGDeadTime_DataStore()) = rtb_motohawk_interpolation_1d2_g;
      }

      /* Sum: '<S104>/Sum3' incorporates:
       *  S-Function (motohawk_sfun_interpolation_1d): '<S104>/motohawk_interpolation_1d2'
       */
      BaseEngineController_LS_112_B.s104_Sum3 = rtb_Abs_g +
      ...
      if (rtb_RelationalOperator_bd) {
        ...
        BaseEngineController_LS_112_B.s104_Switch =
          BaseEngineController_LS_112_B.s104_Sum3;
      }
      ...
      /* S-Function Block: <S139>/motohawk_interpolation_1d1 */
      {
        ...
        (BoostCtlIGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d1_a;
      }
       ...
       *  S-Function (motohawk_sfun_prelookup): '<S132>/motohawk_prelookup1'
       */
      rtb_Abs_g = (BoostCtlIGain_DataStore()) * rtb_motohawk_interpolation_1d1_a
        * rtb_UnitDelay_dj;
       ...
       */
      rtb_UnitDelay_dj = rtb_Abs_g * rtb_motohawk_delta_time_m +
        BaseEngineController_LS_112_B.s143_Switch1;

      /* MinMax: '<S145>/MinMax' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S132>/motohawk_calibration7'
       */
      maxV = (rtb_UnitDelay_dj >= (BoostCtlITermLowerLimit_DataStore())) ||
        rtIsNaN((BoostCtlITermLowerLimit_DataStore())) ? rtb_UnitDelay_dj :
        (BoostCtlITermLowerLimit_DataStore());

      /* Update for UnitDelay: '<S104>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s104_UnitDelay_DSTATE =
        BaseEngineController_LS_112_B.s143_Switch1;
       ...
       */
      BaseEngineController_LS_112_DWork.s143_UnitDelay_DSTATE = (maxV <=
      ...
      BaseEngineController_LS_112_DWork.s133_UnitDelay_DSTATE = rtb_Sum2_n;

      /* Update for UnitDelay: '<S142>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s142_UnitDelay_DSTATE = rtb_kPatoPSI;
    }
    ...
    /* Output and update for function-call system: '<S93>/FAN Control' */
    {
      ...
      /* CombinatorialLogic: '<S155>/Combinatorial  Logic' */
      {
        ...
        /* Copy the appropriate row of the table into the block output vector */
        rtb_CombinatorialLogic_k[0] =
          BaseEngineController_LS_112_ConstP.pooled896[rowidx];
        rtb_CombinatorialLogic_k[1] =
          BaseEngineController_LS_112_ConstP.pooled896[rowidx + 4];
      }
       ...
       */
      if (rtb_CombinatorialLogic_k[1]) {
        rtb_Switch1_bx = rtb_CombinatorialLogic_k[0];
      } else {
        rtb_Switch1_bx = BaseEngineController_LS_112_DWork.s155_UnitDelay_DSTATE;
      }
      ...
      if (FAN_Mode_DataStore()) {
        rtb_Switch_a3 = (real_T)rtb_Switch1_bx;
      } else {
        /* S-Function Block: <S106>/motohawk_interpolation_2d */
        {
          ...
          rtb_motohawk_interpolation_2d = TableInterpolation2D_real_T
            (BaseEngineController_LS_112_B.s431_motohawk_prelookup2,
             BaseEngineController_LS_112_B.s438_motohawk_prelookup2, (real_T *)
             ((ECTFanSpeedMap_DataStore())), 7, 7);
          (ECTFanSpeed_DataStore()) = rtb_motohawk_interpolation_2d;
        }

        rtb_Switch_a3 = rtb_motohawk_interpolation_2d;
      }
       ...
       */
      rtb_AboveHiTarget_b = (BaseEngineController_LS_112_B.s683_Merge >=
        IATFanOn_DataStore());

      /* RelationalOperator: '<S153>/LT1' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S106>/motohawk_data_read3'
       */
      rtb_BelowLoTarget_o = (BaseEngineController_LS_112_B.s683_Merge <=
        IATFanOff_DataStore());
       ...
       */
      if (rtb_CombinatorialLogic_k[1]) {
        rtb_Switch1_i = rtb_CombinatorialLogic_k[0];
      } else {
        rtb_Switch1_i = BaseEngineController_LS_112_DWork.s156_UnitDelay_DSTATE;
      }
       ...
       */
      if (FAN_Mode_DataStore()) {
        rtb_Switch1_k = (real_T)rtb_Switch1_i;
      } else {
        /* S-Function Block: <S106>/motohawk_interpolation_2d1 */
        {
          ...
          rtb_motohawk_interpolation_2d1_i = TableInterpolation2D_real_T
            (BaseEngineController_LS_112_B.s432_motohawk_prelookup1,
             BaseEngineController_LS_112_B.s438_motohawk_prelookup2, (real_T *)
             ((IATFanSpeedMap_DataStore())), 7, 7);
          (IATFanSpeed_DataStore()) = rtb_motohawk_interpolation_2d1_i;
        }

        rtb_Switch1_k = rtb_motohawk_interpolation_2d1_i;
      }
       ...
       */
      rtb_AboveHiTarget_b = (BaseEngineController_LS_112_B.s569_Merge >=
        ACPresFanOn_DataStore());

      /* RelationalOperator: '<S154>/LT1' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S106>/motohawk_data_read5'
       */
      rtb_BelowLoTarget_o = (BaseEngineController_LS_112_B.s569_Merge <=
       ...
       */
      if (rtb_CombinatorialLogic_k[1]) {
        rtb_Switch1_e = rtb_CombinatorialLogic_k[0];
      } else {
        rtb_Switch1_e = BaseEngineController_LS_112_DWork.s157_UnitDelay_DSTATE;
      }
       ...
       */
      if (FAN_Mode_DataStore()) {
        rtb_Switch2 = (real_T)rtb_Switch1_e;
      } else {
        /* S-Function Block: <S106>/motohawk_interpolation_2d2 */
        {
          ...
          (ACPresFanSpeed_DataStore()) = rtb_motohawk_interpolation_2d2_e;
        }

        rtb_Switch2 = rtb_motohawk_interpolation_2d2_e;
      }
       ...
       */
      if (rtb_motohawk_fault_action_a) {
        ...
        rtb_Product3_h = rtb_DataTypeConversion_f * (real_T)
        ...
        rtb_Product2_is = rtb_Switch2 * (real_T)rtb_motohawk_data_read6;
        ...
        rtb_Product1_c = rtb_Switch1_k * (real_T)rtb_motohawk_data_read6;
         ...
         */
        u = rtb_Switch_a3 * (real_T)rtb_motohawk_data_read6;
        u = (u >= rtb_Product1_c) || rtIsNaN(rtb_Product1_c) ? u :
          rtb_Product1_c;
        u = (u >= rtb_Product2_is) || rtIsNaN(rtb_Product2_is) ? u :
          rtb_Product2_is;
        BaseEngineController_LS_112_B.s106_Switch4 = u >= rtb_Product3_h ? u :
          rtb_Product3_h;
      }
      ...
      if (rtb_motohawk_fault_action_a) {
        ...
        rtb_Product2_is = rtb_DataTypeConversion_f * (real_T)
        ...
        rtb_Product3_h = rtb_Switch2 * (real_T)rtb_motohawk_data_read10;
        ...
        rtb_DataTypeConversion_f = rtb_Switch1_k * (real_T)
          rtb_motohawk_data_read10;
         ...
         */
        u = rtb_Switch_a3 * (real_T)rtb_motohawk_data_read10;
        u = (u >= rtb_DataTypeConversion_f) || rtIsNaN(rtb_DataTypeConversion_f)
          ? u : rtb_DataTypeConversion_f;
        u = (u >= rtb_Product3_h) || rtIsNaN(rtb_Product3_h) ? u :
          rtb_Product3_h;
        BaseEngineController_LS_112_B.s106_Switch5 = u >= rtb_Product2_is ? u :
          rtb_Product2_is;
      }
      ...
      BaseEngineController_LS_112_DWork.s155_UnitDelay_DSTATE = rtb_Switch1_bx;

      /* Update for UnitDelay: '<S156>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s156_UnitDelay_DSTATE = rtb_Switch1_i;

      /* Update for UnitDelay: '<S157>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s157_UnitDelay_DSTATE = rtb_Switch1_e;
    }

    /* Output and update for function-call system: '<S93>/MaxGovernor' */
    {
      /* local block i/o variables */
      real_T rtb_motohawk_delta_time_on;
      ...
      uint16_T rtb_Merge1;
      uint16_T rtb_MinMax_gv;
      uint16_T rtb_MinMax_mo;
      index_T rtb_motohawk_prelookup1_d;
      uint16_T rtb_Merge_cg;
      boolean_T rtb_RelationalOperator_a5;
      ...
      /* Sum: '<S109>/Sum' */
      BaseEngineController_LS_112_B.s109_Sum =
        BaseEngineController_LS_112_B.s212_DontallowsetpointtoeverdropbelowtheTargetRPM
      ...
      if (BaseEngineController_LS_112_B.s515_Merge) {
        ...
        rtb_MinMax_mo = MaxGovInGearSetPoint_DataStore();

        /* MinMax: '<S194>/MinMax' incorporates:
         *  S-Function (motohawk_sfun_calibration): '<S192>/motohawk_calibration3'
         */
        rtb_MinMax_mo = (uint16_T)(rtb_MinMax_mo >= ((uint16_T)
          (MaxGovInGearLowerLim_DataStore())) ? rtb_MinMax_mo : ((uint16_T)
         ...
         */
        rtb_Merge_cg = (uint16_T)(rtb_MinMax_mo <= ((uint16_T)
          (MaxGovInGearUpperLim_DataStore())) ? rtb_MinMax_mo : ((uint16_T)
        ...
        rtb_MinMax_gv = MaxGovNtrlSetPoint_DataStore();

        /* MinMax: '<S195>/MinMax' incorporates:
         *  S-Function (motohawk_sfun_calibration): '<S193>/motohawk_calibration2'
         */
        rtb_MinMax_gv = (uint16_T)(rtb_MinMax_gv >= ((uint16_T)
          (MaxGovNtrlLowerLim_DataStore())) ? rtb_MinMax_gv : ((uint16_T)
         ...
         */
        rtb_Merge_cg = (uint16_T)(rtb_MinMax_gv <= ((uint16_T)
          (MaxGovNtrlUpperLim_DataStore())) ? rtb_MinMax_gv : ((uint16_T)
       ...
       *  Sum: '<S189>/Sum1'
       */
      rtb_RelationalOperator_a5 = (BaseEngineController_LS_112_B.s481_RPMInst >
                                   (real_T)(uint16_T)(rtb_Merge_cg - rtb_Merge1));

      /* DataTypeConversion: '<S109>/Data Type Conversion' */
      rtb_DataTypeConversion_a = (real_T)rtb_Merge_cg;

      /* RelationalOperator: '<S187>/Relational Operator2' */
      rtb_RelationalOperator2_h = (BaseEngineController_LS_112_B.s481_RPMInst >
       ...
       *  Sum: '<S187>/Sum'
       */
      rtb_RelationalOperator_h = (BaseEngineController_LS_112_B.s109_Sum <=
        BaseEngineController_LS_112_B.s450_Switch2 - (MaxGovTPSHyst_DataStore()));
       ...
       *  Sum: '<S187>/Sum1'
       */
      rtb_LogicalOperator1_k = (rtb_RelationalOperator_a5 &&
        (BaseEngineController_LS_112_B.s109_Sum > (MaxGovTPSHyst_DataStore()) +
         BaseEngineController_LS_112_B.s450_Switch2));
      ...
      if ((MaxGov_DataStore() == 0.0) && ((rtb_RelationalOperator_a5 ||
            rtb_RelationalOperator2_h) == 1)) {
        /* '<S191>:1:3' */
        /* '<S191>:1:4' */
        rtb_StateO = 1.0;
      } else if ((MaxGov_DataStore() == 1.0) && (rtb_RelationalOperator_h ==
                  TRUE)) {
        /* '<S191>:1:5' */
        /* '<S191>:1:6' */
        rtb_StateO = 2.0;
      } else if ((MaxGov_DataStore() == 2.0) && ((rtb_LogicalOperator1_k ||
                   rtb_RelationalOperator2_h) == 1)) {
        /* '<S191>:1:7' */
        /* '<S191>:1:8' */
        rtb_StateO = 1.0;
      } else if ((MaxGov_DataStore() == 2.0) && (!rtb_RelationalOperator_a5 ==
                  TRUE)) {
        /* '<S191>:1:9' */
        /* '<S191>:1:10' */
        rtb_StateO = 0.0;
      ...
      BaseEngineController_LS_112_B.s187_DataTypeConversion = 0;

      /* Logic: '<S188>/Logical Operator' incorporates:
       *  UnitDelay: '<S109>/Unit Delay'
       */
      rtb_RelationalOperator_a5 =
        !BaseEngineController_LS_112_DWork.s109_UnitDelay_DSTATE;
      ...
      /* S-Function Block: <S188>/motohawk_delta_time */
      {
        ...
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_112_DWork.s188_motohawk_delta_time_DWORK1,
           NULL);
        rtb_motohawk_delta_time_on = ((real_T) delta) * 0.000001;
      }

      /* UnitDelay: '<S188>/Unit Delay' */
      rtb_Reset = BaseEngineController_LS_112_DWork.s188_UnitDelay_DSTATE;
       ...
       *  Sum: '<S188>/Sum1'
       */
      if (rtb_RelationalOperator_a5) {
        rtb_alpha_c = BaseEngineController_LS_112_B.s481_RPMInst;
      } else {
         ...
         */
        rtb_alpha_c = rtb_motohawk_delta_time_on /
          (MaxGovRPMCtrlEntryFiltC_DataStore());
        rtb_alpha_c = (1.0 - rtb_alpha_c) * rtb_Reset + rtb_DataTypeConversion_a
          * rtb_alpha_c;
      }
      ...
      BaseEngineController_LS_112_B.s188_DontallowsetpointtoevergoabovetheTargetRPM
        = (rtb_DataTypeConversion_a <= rtb_alpha_c) || rtIsNaN(rtb_alpha_c) ?
        rtb_DataTypeConversion_a : rtb_alpha_c;

      /* DataTypeConversion: '<S187>/Data Type Conversion1' */
      rtb_Reset = fmod((real_T)rtb_Hold, 256.0);
      BaseEngineController_LS_112_B.s187_DataTypeConversion1 = (int8_T)
        (rtb_Reset < 0.0 ? (int8_T)-(int8_T)(uint8_T)-rtb_Reset : (int8_T)
         (uint8_T)rtb_Reset);

      /* Switch: '<S190>/Switch1' */
      if (BaseEngineController_LS_112_B.s187_DataTypeConversion1 >= 1) {
        rtb_alpha_c =
          BaseEngineController_LS_112_B.s188_DontallowsetpointtoevergoabovetheTargetRPM;
      } else {
        rtb_alpha_c = BaseEngineController_LS_112_B.s481_RPMInst;
      ...
      /* Sum: '<S197>/Sum2' */
      BaseEngineController_LS_112_B.s197_Sum2 =
        BaseEngineController_LS_112_B.s188_DontallowsetpointtoevergoabovetheTargetRPM
        - rtb_alpha_c;
       ...
       */
      rtb_alpha_c = BaseEngineController_LS_112_B.s197_Sum2 *
      ...
      /* S-Function Block: <S190>/motohawk_prelookup1 */
      {
        ...
        rtb_motohawk_prelookup1_d = (MaxGovSpeedErrorIdx_DataStore());
      }
      ...
      /* S-Function Block: <S190>/motohawk_interpolation_1d3 */
      {
        ...
        rtb_motohawk_interpolation_1d3_g = TableInterpolation1D_real_T
          (rtb_motohawk_prelookup1_d, (real_T *)
           ((MaxGovPGainErrorMultTbl_DataStore())), 9);
        (MaxGovPGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d3_g;
      }
       ...
       */
      BaseEngineController_LS_112_B.s197_Product2 = (MaxGovPGain_DataStore()) *
        rtb_motohawk_interpolation_1d3_g * rtb_alpha_c;

      /* UnitDelay: '<S198>/Unit Delay' */
      rtb_Reset = BaseEngineController_LS_112_DWork.s198_UnitDelay_DSTATE;
      ...
      /* S-Function Block: <S190>/motohawk_interpolation_1d2 */
      {
        ...
        (MaxGovDGainErrorMult_DataStore()) = rtb_motohawk_interpolation_1d2_d;
      }
      ...
      rtb_DataTypeConversion_a = (MaxGovDGain_DataStore()) *
        rtb_motohawk_interpolation_1d2_d * rtb_alpha_c;
       ...
       *  Sum: '<S198>/Sum2'
       */
      BaseEngineController_LS_112_B.s198_Product = (rtb_DataTypeConversion_a -
        rtb_Reset) / rtb_motohawk_delta_time_n;
      ...
      /* S-Function Block: <S186>/motohawk_interpolation_1d4 */
      {
        ...
        rtb_motohawk_interpolation_1d4_i = TableInterpolation1D_real_T
          (BaseEngineController_LS_112_B.s400_RPMAccel17Idx, (real_T *)
           ((MaxGovPreloadITermTbl_DataStore())), 17);
        (MaxGovPreloadITerm_DataStore()) = rtb_motohawk_interpolation_1d4_i;
      }

      /* Sum: '<S186>/Sum' incorporates:
       *  S-Function (motohawk_sfun_interpolation_1d): '<S186>/motohawk_interpolation_1d4'
       */
      BaseEngineController_LS_112_B.s186_Sum =
        BaseEngineController_LS_112_B.s109_Sum -
        rtb_motohawk_interpolation_1d4_i;
       ...
       */
      if (BaseEngineController_LS_112_B.s187_DataTypeConversion != 0) {
        BaseEngineController_LS_112_B.s199_Switch1 =
          BaseEngineController_LS_112_B.s186_Sum;
      } else {
        BaseEngineController_LS_112_B.s199_Switch1 =
          BaseEngineController_LS_112_DWork.s199_UnitDelay_DSTATE;
      }
       ...
       */
      if (BaseEngineController_LS_112_B.s187_DataTypeConversion >= 1) {
         ...
         *  Sum: '<S197>/Sum1'
         */
        rtb_Reset = (BaseEngineController_LS_112_B.s197_Product2 +
                     BaseEngineController_LS_112_B.s198_Product) +
          BaseEngineController_LS_112_B.s199_Switch1;
         ...
         */
        BaseEngineController_LS_112_B.s190_Switch = (rtb_Reset <=
      ...
      if ((MaxGovDisable_DataStore()) == FALSE) {
        ...
        BaseEngineController_LS_112_B.s187_MultiportSwitch = (((rtb_Reset < 0.0 ?
          (int8_T)-(int8_T)(uint8_T)-rtb_Reset : (int8_T)(uint8_T)rtb_Reset) !=
          0));
      } else {
        BaseEngineController_LS_112_B.s187_MultiportSwitch = FALSE;
      }
       ...
       */
      rtb_alpha_c = rtb_Reset * rtb_motohawk_delta_time_a +
        BaseEngineController_LS_112_B.s199_Switch1;

      /* MinMax: '<S201>/MinMax' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S190>/motohawk_calibration7'
       */
      rtb_Reset = (rtb_alpha_c >= (MaxGovITermLowerLimit_DataStore())) ||
        rtIsNaN((MaxGovITermLowerLimit_DataStore())) ? rtb_alpha_c :
        (MaxGovITermLowerLimit_DataStore());

      /* Update for UnitDelay: '<S109>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s109_UnitDelay_DSTATE =
        BaseEngineController_LS_112_B.s187_MultiportSwitch;

      /* Update for UnitDelay: '<S188>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s188_UnitDelay_DSTATE =
        BaseEngineController_LS_112_B.s188_DontallowsetpointtoevergoabovetheTargetRPM;

      /* Update for UnitDelay: '<S198>/Unit Delay' */
      BaseEngineController_LS_112_DWork.s198_UnitDelay_DSTATE =
        rtb_DataTypeConversion_a;
       ...
       */
      BaseEngineController_LS_112_DWork.s199_UnitDelay_DSTATE = (rtb_Reset <=
    ...
    /* Output and update for function-call system: '<S93>/Spark Manager' */
    {
      ...
      real_T rtb_RichEquivRatioTargetDelta_d;
      real_T rtb_motohawk_interpolation_1d1_n4;
      ...
      real_T rtb_motohawk_interpolation_1d_eq;
      real_T rtb_RichEquivRatioTargetDelta_ak;
      real_T rtb_motohawk_interpolation_1d4_h;
      index_T rtb_motohawk_prelookup_a;
      real_T rtb_Product_i;
      real_T rtb_Product1_hk;
      ...
      /* S-Function Block: <S277>/motohawk_interpolation_1d */
      {
        ...
        (ECT_SpkOfst_DataStore()) = rtb_motohawk_interpolation_1d_e;
      }
      ...
      /* S-Function Block: <S277>/motohawk_interpolation_2d3 */
      {
        extern real_T TableInterpolation2D_real_T(uint16_T row_in, uint16_T
          col_in, real_T *map_data, uint32_T row_sz, uint32_T col_sz);
        rtb_RichEquivRatioTargetDelta_d = TableInterpolation2D_real_T
          (BaseEngineController_LS_112_B.s433_motohawk_prelookup1,
           BaseEngineController_LS_112_B.s435_motohawk_prelookup1, (real_T *)
           ((ECT_SpkOfstMultMap_DataStore())), 9, 9);
        (ECT_SpkOfstMult_DataStore()) = rtb_RichEquivRatioTargetDelta_d;
      }
       ...
       */
      rtb_Product_i = rtb_motohawk_interpolation_1d_e *
        rtb_RichEquivRatioTargetDelta_d;

      /* S-Function Block: <S277>/motohawk_interpolation_1d1 */
      {
        extern real_T TableInterpolation1D_real_T(uint16_T idx, real_T *tbl_data,
          uint32_T sz);
        rtb_motohawk_interpolation_1d1_n4 = TableInterpolation1D_real_T
          (BaseEngineController_LS_112_B.s432_motohawk_prelookup, (real_T *)
           ((IAT_SpkOfstTbl_DataStore())), 5);
        (IAT_SpkOfst_DataStore()) = rtb_motohawk_interpolation_1d1_n4;
      }
      ...
      /* S-Function Block: <S277>/motohawk_interpolation_2d1 */
      {
        ...
        (IAT_SpkOfstMult_DataStore()) = rtb_RichEquivRatioTargetDelta_l;
      }
       ...
       */
      rtb_Product1_hk = rtb_motohawk_interpolation_1d1_n4 *
      ...
      /* S-Function Block: <S277>/motohawk_interpolation_1d2 */
      {
        ...
        (CAT_SpkOfst_DataStore()) = rtb_motohawk_interpolation_1d2_p;
      }
      ...
      /* S-Function Block: <S277>/motohawk_interpolation_2d2 */
      {
        ...
        (CAT_SpkOfstMult_DataStore()) = rtb_RichEquivRatioTargetDelta_a;
      }
       ...
       */
      BaseEngineController_LS_112_B.s277_Add = (rtb_Product_i + rtb_Product1_hk)
        + rtb_motohawk_interpolation_1d2_p * rtb_RichEquivRatioTargetDelta_a;
      ...
      /* S-Function Block: <S274>/motohawk_interpolation_1d */
      {
        ...
        (EthSpkMod_DataStore()) = rtb_motohawk_interpolation_1d_b;
      }
      ...
      /* S-Function Block: <S274>/motohawk_interpolation_2d3 */
      {
        ...
        (Ethanol_SpkOfstMult_DataStore()) = rtb_RichEquivRatioTargetDelta_g;
      }
       ...
       */
      BaseEngineController_LS_112_B.s274_Product =
        rtb_motohawk_interpolation_1d_b * rtb_RichEquivRatioTargetDelta_g;
      ...
      /* S-Function Block: <S273>/motohawk_interpolation_1d */
      {
        extern real_T TableInterpolation1D_real_T(uint16_T idx, real_T *tbl_data,
          uint32_T sz);
        rtb_motohawk_interpolation_1d_eq = TableInterpolation1D_real_T
          (rtb_motohawk_prelookup_a, (real_T *) ((EqRatio_SpkOfstTbl_DataStore())),
           9);
        (EqRatio_SpkOfst_DataStore()) = rtb_motohawk_interpolation_1d_eq;
      }
      ...
      /* S-Function Block: <S273>/motohawk_interpolation_2d3 */
      {
        extern real_T TableInterpolation2D_real_T(uint16_T row_in, uint16_T
          col_in, real_T *map_data, uint32_T row_sz, uint32_T col_sz);
        rtb_RichEquivRatioTargetDelta_ak = TableInterpolation2D_real_T
          (BaseEngineController_LS_112_B.s433_motohawk_prelookup1,
           BaseEngineController_LS_112_B.s435_motohawk_prelookup1, (real_T *)
           ((EqRatio_SpkOfsMultMap_DataStore())), 9, 9);
        (EqRatio_SpkOfsMult_DataStore()) = rtb_RichEquivRatioTargetDelta_ak;
      }
       ...
       */
      BaseEngineController_LS_112_B.s273_Product =
        rtb_motohawk_interpolation_1d_eq * rtb_RichEquivRatioTargetDelta_ak;
       ...
       */
      BaseEngineController_LS_112_B.s112_ApplyOffsetstoBaseSparkAdvance1 =
        ((((rtb_RichEquivRatioTargetDelta +
            BaseEngineController_LS_112_B.s277_Add) +
           BaseEngineController_LS_112_B.s274_Product) +
          BaseEngineController_LS_112_B.s273_Product) +
         BaseEngineController_LS_112_B.s110_IdleSpk) +
        BaseEngineController_LS_112_B.s147_SpkOut;
      ...
      if (BaseEngineController_LS_112_B.s222_RelOp) {
        /* S-Function Block: <S276>/motohawk_interpolation_1d4 */
        {
          ...
          (MaxSparkLimit_DataStore()) = rtb_motohawk_interpolation_1d4_h;
        }

        rtb_Product1_hk = rtb_motohawk_interpolation_1d4_h;
      } else {
        rtb_Product1_hk = (MaxSparkLimitOffIdle_DataStore());
      }
       ...
       *  MinMax: '<S280>/MinMax'
       */
      BaseEngineController_LS_112_B.s280_MinMax1 = (rtb_Product_i <=
        rtb_Product1_hk) || rtIsNaN(rtb_Product1_hk) ? rtb_Product_i :
        rtb_Product1_hk;

      /* UnitDelay: '<S275>/Unit Delay' */
      rtb_Product_i = BaseEngineController_LS_112_DWork.s275_UnitDelay_DSTATE;

      /* Switch: '<S275>/Switch' incorporates:
       *  UnitDelay: '<S278>/Initial Condition is True'
       */
      if (BaseEngineController_LS_112_DWork.s278_InitialConditionisTrue_DSTATE)
      {
        BaseEngineController_LS_112_B.s275_Switch =
          BaseEngineController_LS_112_B.s280_MinMax1;
      } else {
        /* Sum: '<S275>/Sum' incorporates:
         *  S-Function (motohawk_sfun_calibration): '<S275>/motohawk_calibration'
         */
        rtb_Product1_hk = rtb_Product_i + (SparkAdv_DeltaHi_DataStore());

        /* MinMax: '<S279>/MinMax' incorporates:
         *  S-Function (motohawk_sfun_calibration): '<S275>/motohawk_calibration1'
         *  Sum: '<S275>/Sum1'
         */
        rtb_Product_i -= (SparkAdv_DeltaLo_DataStore());

        /* MinMax: '<S279>/MinMax1' incorporates:
         *  MinMax: '<S279>/MinMax'
         */
        rtb_Product_i = (BaseEngineController_LS_112_B.s280_MinMax1 >=
                         rtb_Product_i) || rtIsNaN(rtb_Product_i) ?
          BaseEngineController_LS_112_B.s280_MinMax1 : rtb_Product_i;
        BaseEngineController_LS_112_B.s275_Switch = (rtb_Product_i <=
          rtb_Product1_hk) || rtIsNaN(rtb_Product1_hk) ? rtb_Product_i :
          rtb_Product1_hk;
      }
      ...
      BaseEngineController_LS_112_DWork.s275_UnitDelay_DSTATE =
        BaseEngineController_LS_112_B.s275_Switch;
    }
  }
}
