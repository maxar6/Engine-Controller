...
static void initialize_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c11_st);
static void finalize_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc11_BaseEngineController_LS
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_emlrt_marshallIn(SFc11_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c11_StateO, const char_T *c11_identifier);
static real_T c11_b_emlrt_marshallIn(SFc11_BaseEngineController_LSInstanceStruct
...
static uint8_T c11_d_emlrt_marshallIn
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c11_b_is_active_c11_BaseEngineController_LS, const char_T *c11_identifier);
static uint8_T c11_e_emlrt_marshallIn
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void init_dsm_address_info(SFc11_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_BaseEngineController_LS = 0U;
}
  ...
  (SFc11_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c11_d_hoistedGlobal = chartInstance->c11_is_active_c11_BaseEngineController_LS;
   ...
   *c11_st)
{
  ...
  *c11_StateO = c11_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c11_u, 2)), "StateO");
  chartInstance->c11_is_active_c11_BaseEngineController_LS =
    c11_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 3)),
    "is_active_c11_BaseEngineController_LS");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_BaseEngineController_LS(chartInstance);
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc11_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c11_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
   ...
   *c11_b_is_active_c11_BaseEngineController_LS, const char_T *c11_identifier)
{
  ...
  c11_y = c11_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_BaseEngineController_LS), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_BaseEngineController_LS);
  return c11_y;
}
...
/* SFunction Glue Code */
void sf_c11_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c11_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c11_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"CounterReset\",},{M[1],M[8],T\"ESTEnable\",},{M[1],M[9],T\"StateO\",},{M[8],M[0],T\"is_active_c11_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c11_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c11_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c11_BaseEngineController_LS((SFc11_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c11_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c11_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c11_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c11_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c11_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c11_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c11_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c11_BaseEngineController_LS
      ((SFc11_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc11_BaseEngineController_LS
    ((SFc11_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c11_BaseEngineController_LS
      ((SFc11_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c11_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",11);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",11,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",11,
...
static void mdlRTW_c11_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_BaseEngineController_LS(SimStruct *S)
{
  SFc11_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc11_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc11_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c11_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c11_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c11_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c11_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c11_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c11_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c11_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c11_BaseEngineController_LS;
...
void c11_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_BaseEngineController_LS_method_dispatcher.\n"
