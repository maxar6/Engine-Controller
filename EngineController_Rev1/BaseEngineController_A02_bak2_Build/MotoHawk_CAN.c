  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_1_0_54;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_1_0_54 = 0;
    else
      can_tx_err_CAN_1_0_54 = (uint8_T) GetErrorCode(sErrorResult);
  }
  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_2_0_55;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_2_0_55 = 0;
    else
      can_tx_err_CAN_2_0_55 = (uint8_T) GetErrorCode(sErrorResult);
  }
