...
static void initialize_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void c2_set_sim_state_side_effects_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void finalize_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc2_BaseEngineController_LS
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static int32_T c2_emlrt_marshallIn(SFc2_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_b_emlrt_marshallIn(SFc2_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c2_b_tp_Stall, const char_T *c2_identifier);
static uint8_T c2_c_emlrt_marshallIn(SFc2_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void init_dsm_address_info(SFc2_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_BaseEngineController_LS = 0U;
  chartInstance->c2_is_c2_BaseEngineController_LS = 0U;
  ...
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c2_is_c2_BaseEngineController_LS == c2_IN_Run) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
  }

  if (chartInstance->c2_is_c2_BaseEngineController_LS == c2_IN_Crank) {
  ...
  (SFc2_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_BaseEngineController_LS;
  c2_b_u = c2_b_hoistedGlobal;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_c_hoistedGlobal = chartInstance->c2_is_c2_BaseEngineController_LS;
   ...
   *c2_st)
{
  ...
  *c2_State = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 0)), "State");
  chartInstance->c2_is_active_c2_BaseEngineController_LS = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_BaseEngineController_LS");
  chartInstance->c2_is_c2_BaseEngineController_LS = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_c2_BaseEngineController_LS");
  ...
  c2_update_debugger_state_c2_BaseEngineController_LS(chartInstance);
  ...
  switch (chartInstance->c2_is_c2_BaseEngineController_LS) {
    ...
    if (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4U, 0, *c2_Stall != 0U,
      ...
      *c2_State = 1U;
      ...
      if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0, *c2_Run != 0U,
        ...
        chartInstance->c2_tp_Crank = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_BaseEngineController_LS = c2_IN_Run;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
        chartInstance->c2_tp_Run = 1U;
        *c2_State = 3U;
        _SFD_DATA_RANGE_CHECK((real_T)*c2_State, 3U);
   ...
   case c2_IN_Stall:
    ...
    if (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0, *c2_Crank != 0U,
      ...
      chartInstance->c2_tp_Stall = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c2_sfEvent);
      chartInstance->c2_is_c2_BaseEngineController_LS = c2_IN_Crank;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
      chartInstance->c2_tp_Crank = 1U;
      *c2_State = 2U;
      _SFD_DATA_RANGE_CHECK((real_T)*c2_State, 3U);
...
const mxArray *sf_c2_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc2_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c2_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[12],T\"State\",},{M[8],M[0],T\"is_active_c2_BaseEngineController_LS\",},{M[9],M[0],T\"is_c2_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_BaseEngineController_LS
    ((SFc2_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c2_BaseEngineController_LS
    ((SFc2_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c2_BaseEngineController_LS((SFc2_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c2_BaseEngineController_LS((SFc2_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c2_BaseEngineController_LS((SFc2_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_BaseEngineController_LS
    ((SFc2_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c2_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_BaseEngineController_LS
    ((SFc2_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c2_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c2_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_BaseEngineController_LS
      ((SFc2_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_BaseEngineController_LS
    ((SFc2_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_BaseEngineController_LS
      ((SFc2_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",2,
...
static void mdlRTW_c2_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_BaseEngineController_LS(SimStruct *S)
{
  SFc2_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc2_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc2_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_BaseEngineController_LS;
...
void c2_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_BaseEngineController_LS_method_dispatcher.\n"
