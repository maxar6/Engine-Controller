...
static void initialize_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c19_st);
static void c19_set_sim_state_side_effects_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void finalize_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc19_BaseEngineController_LS
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_emlrt_marshallIn(SFc19_BaseEngineController_LSInstanceStruct *
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_d_emlrt_marshallIn(SFc19_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c19_Timer, const char_T *c19_identifier);
static real_T c19_e_emlrt_marshallIn(SFc19_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_i_emlrt_marshallIn
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_BaseEngineController_LS = 0U;
  chartInstance->c19_is_c19_BaseEngineController_LS = 0U;
  ...
  chartInstance->c19_is_active_c19_BaseEngineController_LS = 1U;
  ...
  chartInstance->c19_is_c19_BaseEngineController_LS = c19_IN_Stall;
  ...
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c19_is_active_c19_BaseEngineController_LS == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 7U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_BaseEngineController_LS == c19_IN_Stall) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_BaseEngineController_LS == c19_IN_CrankRun) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_BaseEngineController_LS == c19_IN_StallDelay) {
  ...
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c19_d_hoistedGlobal = chartInstance->c19_is_active_c19_BaseEngineController_LS;
  c19_d_u = c19_d_hoistedGlobal;
  c19_e_y = NULL;
  sf_mex_assign(&c19_e_y, sf_mex_create("y", &c19_d_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c19_y, 3, c19_e_y);
  c19_e_hoistedGlobal = chartInstance->c19_is_c19_BaseEngineController_LS;
   ...
   *c19_st)
{
  ...
  *c19_Timer = c19_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c19_is_active_c19_BaseEngineController_LS =
    c19_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 3)),
    "is_active_c19_BaseEngineController_LS");
  chartInstance->c19_is_c19_BaseEngineController_LS = c19_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 4)),
     "is_c19_BaseEngineController_LS");
  ...
  c19_update_debugger_state_c19_BaseEngineController_LS(chartInstance);
  ...
  (SFc19_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c19_set_sim_state_side_effects_c19_BaseEngineController_LS(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 7U, chartInstance->c19_sfEvent);
  switch (chartInstance->c19_is_c19_BaseEngineController_LS) {
   case c19_IN_CrankRun:
    ...
    if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0, (int16_T)
      ...
      chartInstance->c19_tp_CrankRun = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
      chartInstance->c19_is_c19_BaseEngineController_LS = c19_IN_StallDelay;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c19_sfEvent);
      chartInstance->c19_tp_StallDelay = 1U;
      *c19_Enable = FALSE;
      _SFD_DATA_RANGE_CHECK((real_T)*c19_Enable, 4U);
   ...
   case c19_IN_Stall:
    ...
    if (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0, (int16_T)
      ...
      chartInstance->c19_tp_Stall = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
      chartInstance->c19_is_c19_BaseEngineController_LS = c19_IN_CrankRun;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
      chartInstance->c19_tp_CrankRun = 1U;
      *c19_Enable = FALSE;
      _SFD_DATA_RANGE_CHECK((real_T)*c19_Enable, 4U);
   ...
   default:
    CV_CHART_EVAL(7, 0, 0);
    chartInstance->c19_is_c19_BaseEngineController_LS = (uint8_T)
...
const mxArray *sf_c19_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc19_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c19_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[13],T\"Enable\",},{M[1],M[12],T\"Timer\",},{M[3],M[14],T\"TOld\",},{M[8],M[0],T\"is_active_c19_BaseEngineController_LS\",},{M[9],M[0],T\"is_c19_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c19_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c19_BaseEngineController_LS((SFc19_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c19_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c19_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c19_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c19_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c19_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c19_BaseEngineController_LS
      ((SFc19_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_BaseEngineController_LS
    ((SFc19_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c19_BaseEngineController_LS
      ((SFc19_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c19_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",19);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",19,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",19,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"BaseEngineController_LS",
        "BaseEngineController_LS",19,3);
      sf_mark_chart_reusable_outputs(S,"BaseEngineController_LS",
        "BaseEngineController_LS",19,2);
    }
...
static void mdlRTW_c19_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_BaseEngineController_LS(SimStruct *S)
{
  SFc19_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc19_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc19_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c19_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c19_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c19_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_BaseEngineController_LS;
...
void c19_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_BaseEngineController_LS_method_dispatcher.\n"
