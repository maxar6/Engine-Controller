...
CANFrame RxSlot_9013p0001_ReceiveFrame;
boolean_T RxSlot_9013p0001_ReceiveFrameValid;
boolean_T RxSlot_9013p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_9013p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_9013p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_9013p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_9013p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_9013p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_9013p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_9013p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_9014p0001_ReceiveFrame;
boolean_T RxSlot_9014p0001_ReceiveFrameValid;
boolean_T RxSlot_9014p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_9014p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_9014p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_9014p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_9014p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_9014p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_9014p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_9014p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_9015p0001_ReceiveFrame;
boolean_T RxSlot_9015p0001_ReceiveFrameValid;
boolean_T RxSlot_9015p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_9015p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_9015p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_9015p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_9015p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_9015p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_9015p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_9015p0001_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_9123p0002_ReceiveFrame;
boolean_T RxSlot_9123p0002_ReceiveFrameValid;
boolean_T RxSlot_9123p0002_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_9123p0002_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_9123p0002_ReceiveFrame.extended;
	if (id) *id = RxSlot_9123p0002_ReceiveFrame.id;
	if (length) *length = RxSlot_9123p0002_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_9123p0002_ReceiveFrame.length; i++) {
			data[i] = RxSlot_9123p0002_ReceiveFrame.data[i];
		}
	}
	RxSlot_9123p0002_ReceiveFrameValid = 0;
...
/* Single CAN receive frame between dispatcher and application */
CANFrame RxSlot_9124p0001_ReceiveFrame;
boolean_T RxSlot_9124p0001_ReceiveFrameValid;
boolean_T RxSlot_9124p0001_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{
	...
	if (!RxSlot_9124p0001_ReceiveFrameValid) {
		Interrupt_Enable();
		return 0;
	}
	if (extended) *extended = RxSlot_9124p0001_ReceiveFrame.extended;
	if (id) *id = RxSlot_9124p0001_ReceiveFrame.id;
	if (length) *length = RxSlot_9124p0001_ReceiveFrame.length;
	if (data) {
		for (i=0; i < RxSlot_9124p0001_ReceiveFrame.length; i++) {
			data[i] = RxSlot_9124p0001_ReceiveFrame.data[i];
		}
	}
	RxSlot_9124p0001_ReceiveFrameValid = 0;
...
CANFrame_Queue CCP1_ReceiveQueue;
CANFrame CCP1_ReceiveQueueFrames[4];

uint32_T CCP1_DynamicID = 0x18EF0231;
uint32_T CCP1_DynamicIDMask = 0x1FFFFFFF;
void CCP1_SetIDFilter(uint32_T id, uint32_T id_mask)
{
	CCP1_DynamicID = id;
	CCP1_DynamicIDMask = id_mask;
}
boolean_T CCP1_Receive(boolean_T *extended, uint32_T *id, uint8_T *length, uint8_T data[])
{

	CANFrame rxFrame;
	int32_T i;
	if (!CANFrame_Queue_Dequeue(&CCP1_ReceiveQueue, &rxFrame)) {
		return 0;
	}
...
void CAN_1_ReceiveDispatch(void)
{
	...
	while (1) {
		...
		if (
			(frame->extended == 1) &&
			((frame->id & 0x1FFFFFFF) == 0xA0002) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_9013p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_9013p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_9014p0001 */
		if (
			(frame->extended == 1) &&
			((frame->id & 0x1FFFFFFF) == 0xA0000) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_9014p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_9014p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_9015p0001 */
		if (
			(frame->extended == 1) &&
			((frame->id & 0x1FFFFFFF) == 0xA0001) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_9015p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_9015p0001_ReceiveFrameValid = 1;
		}
		/* RxSlot_9123p0002 */
		if (
			(frame->extended == 1) &&
			((frame->id & 0x1FFFFFFF) == 0x180) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_9123p0002_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_9123p0002_ReceiveFrameValid = 1;
		}
		/* RxSlot_9124p0001 */
		if (
			(frame->extended == 1) &&
			((frame->id & 0x1FFFFFFF) == 0x181) &&
			(frame->length >= 8)
		)
		{
			memcpy(&RxSlot_9124p0001_ReceiveFrame, frame, sizeof(CANFrame));
			RxSlot_9124p0001_ReceiveFrameValid = 1;
		}
		/* CCP1 */
		if (
			(frame->extended == 1) &&
			((frame->id & 0x1FFFFFFF) == 0x18EF0231) &&
			((frame->id & CCP1_DynamicIDMask) == (CCP1_DynamicID & CCP1_DynamicIDMask))
		)
		{
			CANFrame_Queue_Enqueue(&CCP1_ReceiveQueue, frame);
		}
		/* CAN_1_KeySuite */
		if (
			(frame->extended == 1) &&
...
void CAN_1_Create(void)
{
	...
	CANFrame_Queue_Create(&CCP1_ReceiveQueue, CCP1_ReceiveQueueFrames, sizeof(CCP1_ReceiveQueueFrames)/sizeof(CANFrame));
