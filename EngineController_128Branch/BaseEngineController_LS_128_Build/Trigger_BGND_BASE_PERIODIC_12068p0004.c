/*
 * Trigger_BGND_BASE_PERIODIC_12068p0004.c
 *
...
void Trigger_BGND_BASE_PERIODIC_12068p0004(void)
{
...
#define BaseEngineController_LS_128_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_128_DWork.s5_motohawk_trigger4_DWORK1) {
    BaseEngineController_LS_128_CCPDaqProcessing(4);
  }
}
