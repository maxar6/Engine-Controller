...
#define BaseEngineController_LS_128_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_128_DWork.s72_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S72>/SequencyCutMachine' */
    {
      ...
      /* Inport: '<S82>/CutArray' */
      for (i = 0; i < 8; i++) {
        BaseEngineController_LS_128_B.s82_CutArray[i] =
       ...
       */
      i = (int32_T)((uint32_T)BaseEngineController_LS_128_B.s72_UnitDelay1 + 1U);
      if ((uint32_T)i > 255U) {
        i = 255;
      }

      rtb_Sum1_n = (uint8_T)i;
      ...
      if (5 <= rtb_Sum1_n) {
        ...
        BaseEngineController_LS_128_B.s82_Switch = rtb_Sum1_n;
      }
       ...
       */
      rtb_Sum2 = (real_T)(BaseEngineController_LS_128_B.s82_Switch == 4) +
      ...
      if (5.0 <= rtb_Sum2) {
        ...
        BaseEngineController_LS_128_B.s82_Switch1 = rtb_Sum2;
      }
