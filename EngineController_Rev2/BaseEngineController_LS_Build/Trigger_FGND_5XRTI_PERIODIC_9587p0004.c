/*
 * Trigger_FGND_5XRTI_PERIODIC_9587p0004.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_9587p0004(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s13_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S13>/Coil Control' */
    {
      ...
      /* Logic: '<S823>/Logical Operator3' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S823>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_b = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S823>/motohawk_fault_action'
       *
       * Regarding '<S823>/motohawk_fault_action':
      ...
      /* Logic: '<S823>/Logical Operator4' incorporates:
       *  Constant: '<S827>/Constant'
       *  RelationalOperator: '<S827>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S823>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_p = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S823>/EST Enable TDC Counter' */
      /* UnitDelay: '<S828>/CrankCounter' */
      BaseEngineController_LS_B.s828_CrankCounter =
        BaseEngineController_LS_DWork.s828_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S828>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_9059p0004 */
      if (BaseEngineController_LS_DWork.s828_motohawk_trigger1_DWORK1 == 0) {
       ...
       */
      BaseEngineController_LS_B.s828_RelationalOperator1 =
        ((BaseEngineController_LS_B.s830_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S828>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S828>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S828>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S829>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_LS_B.s828_RelationalOperator1 == TRUE)) {
        /* '<S829>:1:3' */
        /* '<S829>:1:4' */
        rtb_StateO_n = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_LS_B.s828_RelationalOperator1 ==
                            TRUE)) {
        /* '<S829>:1:5' */
        /* '<S829>:1:6' */
        rtb_StateO_n = 2.0;
      ...
      /* End of MATLAB Function Block: '<S828>/EST Enable TDC Counter Stateflow' */

      /* S-Function (motohawk_sfun_data_write): '<S828>/motohawk_data_write' */
      ...
      BaseEngineController_LS_B.s828_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S828>/CrankCounter' */
      BaseEngineController_LS_DWork.s828_CrankCounter_DSTATE = rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S823>/EST Enable TDC Counter' */
       ...
       *  S-Function (motohawk_sfun_calibration): '<S823>/motohawk_calibration5'
       *  S-Function (motohawk_sfun_calibration): '<S823>/motohawk_calibration6'
       *  S-Function (motohawk_sfun_calibration): '<S823>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S823>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S823>/motohawk_calibration9'
       */
      BaseEngineController_LS_B.s798_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
          (SparkEnableCyl1_DataStore()) && rtb_motohawk_data_read2 &&
          rtb_LogicalOperator4_p &&
          (BaseEngineController_LS_B.s828_DataTypeConversion != 0) &&
          BaseEngineController_LS_B.s24_OnlyEnableSparkwhenEnergyisAboveZero &&
          BaseEngineController_LS_B.s22_LogicalOperator2[0]));
      BaseEngineController_LS_B.s798_LogicalOperator1[1] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s798_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s798_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s798_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s798_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s798_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s798_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_LS_DWork.s825_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_B.s825_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S798>/Data Type Conversion' incorporates:
       *  Gain: '<S798>/Gain'
       */
      ...
      /* End of DataTypeConversion: '<S798>/Data Type Conversion' */
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_LS_DWork.s826_UnitDelay_DSTATE;
      ...
      /* Sum: '<S826>/Sum' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S826>/offset'
       */
      BaseEngineController_LS_B.s826_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S798>/Data Type Conversion1' incorporates:
       *  Gain: '<S798>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s826_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* DataTypeConversion: '<S798>/Data Type Conversion2' incorporates:
       *  Gain: '<S798>/Gain2'
      ...
      /* S-Function Block: <S798>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s798_SparkSequence_o3)[i] =
            SparkSeqDiag_23_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s798_SparkSequence_o4)[i] =
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def' */
      ...
      /* RelationalOperator: '<S846>/RelOp' incorporates:
       *  Constant: '<S846>/Constant'
       */
      rtb_RelOp_c = ((rtb_SparkSequence_o1[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def1' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def10' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def11' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def12' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def13' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def14' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def15' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def2' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def3' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def4' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def5' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def6' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def7' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def8' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S824>/motohawk_fault_def9' */
      ...
      BaseEngineController_LS_DWork.s825_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S826>/Unit Delay' */
      BaseEngineController_LS_DWork.s826_UnitDelay_DSTATE = rtb_CounterReset;

      /* S-Function Block: <S798>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_LS_B.s798_LogicalOperator1)[cyl])
