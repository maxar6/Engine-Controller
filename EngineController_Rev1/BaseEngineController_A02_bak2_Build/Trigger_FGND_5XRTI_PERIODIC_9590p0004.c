...
#define BaseEngineController_A02_bak2_IN_PowerUp (2U)
  ...
  if (BaseEngineController_A02_bak2_DWork.s5_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S5>/Coil Control' */
    {
      ...
      /* Logic: '<S718>/Logical Operator3' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S718>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_k = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S718>/motohawk_fault_action'
       *
       * Regarding '<S718>/motohawk_fault_action':
      ...
      /* S-Function (motohawk_sfun_data_read): '<S718>/motohawk_data_read2' */
      rtb_motohawk_data_read2 = ECUP_Enabled_DataStore();

      /* Logic: '<S718>/Logical Operator4' incorporates:
       *  Constant: '<S722>/Constant'
       *  RelationalOperator: '<S722>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S718>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_j = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S718>/EST Enable TDC Counter' */
      /* UnitDelay: '<S723>/CrankCounter' */
      BaseEngineController_A02_bak2_B.s723_CrankCounter =
        BaseEngineController_A02_bak2_DWork.s723_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S723>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_9072p0002 */
      if (BaseEngineController_A02_bak2_DWork.s723_motohawk_trigger1_DWORK1 == 0)
      {
       ...
       */
      BaseEngineController_A02_bak2_B.s723_RelationalOperator1 =
        ((BaseEngineController_A02_bak2_B.s725_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S723>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S723>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S723>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S724>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_A02_bak2_B.s723_RelationalOperator1 == TRUE)) {
        /* '<S724>:1:3' */
        /* '<S724>:1:4' */
        rtb_StateO_m = 1.0;
      ...
      /* End of MATLAB Function Block: '<S723>/EST Enable TDC Counter Stateflow' */

      /* S-Function (motohawk_sfun_data_write): '<S723>/motohawk_data_write' */
      ...
      BaseEngineController_A02_bak2_B.s723_DataTypeConversion = (int8_T)(tmp_0 <
        0.0 ? (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S723>/CrankCounter' */
      BaseEngineController_A02_bak2_DWork.s723_CrankCounter_DSTATE =
        rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S718>/EST Enable TDC Counter' */

      /* Logic: '<S707>/Logical Operator1' incorporates:
       *  Logic: '<S718>/Logical Operator2'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration1'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration3'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration4'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration5'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration6'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S718>/motohawk_calibration9'
       */
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
          (SparkEnableCyl1_DataStore()) && rtb_motohawk_data_read2 &&
          rtb_LogicalOperator4_j &&
          (BaseEngineController_A02_bak2_B.s723_DataTypeConversion != 0) &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[1] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      BaseEngineController_A02_bak2_B.s707_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_k && rtb_LogicalOperator1_k &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable =
          BaseEngineController_A02_bak2_DWork.s720_UnitDelay_DSTATE;
       ...
       *  S-Function (motohawk_sfun_calibration): '<S720>/offset'
       */
      BaseEngineController_A02_bak2_B.s720_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S707>/Data Type Conversion' incorporates:
       *  Gain: '<S707>/Gain'
       */
      tmp_0 = 16.0 * BaseEngineController_A02_bak2_B.s720_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset =
          BaseEngineController_A02_bak2_DWork.s721_UnitDelay_DSTATE;
       ...
       *  S-Function (motohawk_sfun_calibration): '<S721>/offset'
       */
      BaseEngineController_A02_bak2_B.s721_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S707>/Data Type Conversion1' incorporates:
       *  Gain: '<S707>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_A02_bak2_B.s721_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* End of DataTypeConversion: '<S707>/Data Type Conversion1' */
      /* DataTypeConversion: '<S707>/Data Type Conversion2' incorporates:
       *  Gain: '<S707>/Gain2'
      ...
      /* End of DataTypeConversion: '<S707>/Data Type Conversion2' */
      /* S-Function Block: <S707>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_A02_bak2_B.s707_SparkSequence_o3)[i] =
            SparkSeqDiag_24_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_A02_bak2_B.s707_SparkSequence_o4)[i] =
            SparkSeqDiag_24_OnTime[i];
        }
      }

      /* RelationalOperator: '<S740>/RelOp' incorporates:
       *  Constant: '<S740>/Constant'
       */
      rtb_RelOp_o = ((rtb_SparkSequence_o1[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def' */
      ...
      /* RelationalOperator: '<S741>/RelOp' incorporates:
       *  Constant: '<S741>/Constant'
       */
      rtb_RelOp_m = ((rtb_SparkSequence_o1[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def1' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def10' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def11' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def12' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def13' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def14' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def15' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def2' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def3' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def4' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def5' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def6' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def7' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def8' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S719>/motohawk_fault_def9' */
      ...
      /* S-Function (motohawk_sfun_data_write): '<S718>/motohawk_data_write' */
      ...
      BaseEngineController_A02_bak2_DWork.s720_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S721>/Unit Delay' */
      BaseEngineController_A02_bak2_DWork.s721_UnitDelay_DSTATE =
        rtb_CounterReset;

      /* S-Function Block: <S707>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_A02_bak2_B.s707_LogicalOperator1)
