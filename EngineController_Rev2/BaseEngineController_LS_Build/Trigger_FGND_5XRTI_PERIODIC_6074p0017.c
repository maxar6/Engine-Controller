/*
 * Trigger_FGND_5XRTI_PERIODIC_6074p0017.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_6074p0017(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s13_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S13>/Coil Control' */
    {
      ...
      BaseEngineController_LS_B.s854_CrankCounter =
        BaseEngineController_LS_DWork.s854_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S854>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_5546p0017 */
      if (BaseEngineController_LS_DWork.s854_motohawk_trigger1_DWORK1 == 0) {
       ...
       */
      BaseEngineController_LS_B.s854_RelationalOperator1 =
        ((BaseEngineController_LS_B.s856_Switch1 >= ((uint8_T)
      ...
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_LS_B.s854_RelationalOperator1 == TRUE)) {
        /* '<S855>:1:3' */
        /* '<S855>:1:4' */
        rtb_StateO_n = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_LS_B.s854_RelationalOperator1 ==
                            TRUE)) {
        /* '<S855>:1:5' */
        /* '<S855>:1:6' */
        rtb_StateO_n = 2.0;
      ...
      BaseEngineController_LS_B.s854_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S854>/CrankCounter' */
      BaseEngineController_LS_DWork.s854_CrankCounter_DSTATE = rtb_CounterReset;
      ...
      BaseEngineController_LS_B.s792_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s792_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s792_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s792_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s792_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s792_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_LS_DWork.s851_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_B.s851_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S792>/Data Type Conversion' incorporates:
       *  Gain: '<S792>/Gain'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s851_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_LS_DWork.s852_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_B.s852_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S792>/Data Type Conversion1' incorporates:
       *  Gain: '<S792>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s852_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* S-Function Block: <S792>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s792_SparkSequence_o3)[i] =
            SparkSeqDiag_22_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s792_SparkSequence_o4)[i] =
      ...
      BaseEngineController_LS_DWork.s851_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S852>/Unit Delay' */
      BaseEngineController_LS_DWork.s852_UnitDelay_DSTATE = rtb_CounterReset;
      ...
      /* S-Function Block: <S792>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_LS_B.s792_LogicalOperator1)[cyl])
