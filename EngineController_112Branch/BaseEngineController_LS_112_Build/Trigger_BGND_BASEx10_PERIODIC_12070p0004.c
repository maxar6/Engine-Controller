/*
 * Trigger_BGND_BASEx10_PERIODIC_12070p0004.c
 *
...
void Trigger_BGND_BASEx10_PERIODIC_12070p0004(void)
{
...
#define BaseEngineController_LS_112_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_112_DWork.s5_motohawk_trigger6_DWORK1) {
    BaseEngineController_LS_112_CCPDaqProcessing(6);
  }
}
