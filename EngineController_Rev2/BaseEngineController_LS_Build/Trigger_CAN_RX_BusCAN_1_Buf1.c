...
/*---------------------------------------------------------------*/
MHCAN_directslot MHCAN_directslot_RxSlot_8127p0001 = { 0 };

static boolean_T MHCAN_handler_RxSlot_8127p0001(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000181) {
...

    {
      ...
      new_message = !MHCAN_directslot_RxSlot_8127p0001.ready;
      MHCAN_directslot_RxSlot_8127p0001.message = *messageObj;
      MHCAN_directslot_RxSlot_8127p0001.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_8126p0002 = { 0 };

static boolean_T MHCAN_handler_RxSlot_8126p0002(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x000007FF) == 0x00000180) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_8126p0002.ready;
      MHCAN_directslot_RxSlot_8126p0002.message = *messageObj;
      MHCAN_directslot_RxSlot_8126p0002.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x000007FF[] = {
  { 0x00000181, MHCAN_handler_RxSlot_8127p0001 },

  { 0x00000180, MHCAN_handler_RxSlot_8126p0002 },
};
