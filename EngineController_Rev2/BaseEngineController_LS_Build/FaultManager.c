...
void GlobalFaultClear(void)
{
  ...
  FaultMarquees_DataStore_FaultMarquees().current_suspected_vardec = 153;
  FaultMarquees_DataStore_FaultMarquees().current_active_vardec = 153;
  FaultMarquees_DataStore_FaultMarquees().current_occurred_vardec = 153;
  VolFaultManager_DataStore_VolFaultManager().last_suspected_fault = 153;
  VolFaultManager_DataStore_VolFaultManager().last_unsuspected_fault = 153;
  VolFaultManager_DataStore_VolFaultManager().last_active_fault = 153;
  VolFaultManager_DataStore_VolFaultManager().last_inactive_fault = 153;
  VolFaultManager_DataStore_VolFaultManager().last_occurred_fault = 153;
}
...
static void UpdateActionReasonMarquee(uint32_T fault_action_index)
{
  ...
  static fault_action_marquee_state_t fault_action_marquee_state[14] = { { 0 } };
  ...
  (FaultActionReason_DataStore())[fault_action_index] = 153;
}
