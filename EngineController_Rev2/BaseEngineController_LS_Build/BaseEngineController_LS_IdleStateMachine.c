...
{
  BaseEngineController_LS_DWork.s221_is_active_c12_BaseEngineController_LS = 0U;
  BaseEngineController_LS_DWork.s221_is_c12_BaseEngineController_LS = 0U;
  BaseEngineController_LS_B.s221_IdleState = 0U;
}
...
void BaseEngineController_LS_IdleStateMachine(void)
{
  ...
  if (BaseEngineController_LS_DWork.s221_is_active_c12_BaseEngineController_LS ==
      0) {
    /* Entry: Foreground/Control/Controller/Run/MinGovernor/Idle State Determination/IdleStateMachine */
    BaseEngineController_LS_DWork.s221_is_active_c12_BaseEngineController_LS =
      1U;

    /* Transition: '<S221>:4' */
    BaseEngineController_LS_DWork.s221_is_c12_BaseEngineController_LS =
      BaseEngineController_LS_IN_Flaring;

    /* Entry 'Flaring': '<S221>:2' */
    BaseEngineController_LS_B.s221_IdleState = 1U;
  } else {
    switch (BaseEngineController_LS_DWork.s221_is_c12_BaseEngineController_LS) {
     case BaseEngineController_LS_IN_Flaring:
      /* During 'Flaring': '<S221>:2' */
      if (BaseEngineController_LS_B.s206_LogicalOperator ||
        ...
        BaseEngineController_LS_B.s221_IdleState = 3U;
      } else {
        if (BaseEngineController_LS_B.s220_RelationalOperator &&
            BaseEngineController_LS_B.s206_RelationalOperator1) {
          /* Transition: '<S221>:7' */
          BaseEngineController_LS_DWork.s221_is_c12_BaseEngineController_LS =
            BaseEngineController_LS_IN_OnIdle;

          /* Entry 'OnIdle': '<S221>:3' */
          BaseEngineController_LS_B.s221_IdleState = 2U;
        }
      }
      break;
      ...
      if (((EnableRPMFalling_DataStore()) &&
           (BaseEngineController_LS_B.s206_RelationalOperator3 ||
            (BaseEngineController_LS_B.s206_RelationalOperator &&
             BaseEngineController_LS_B.s206_RelationalOperator1))) ||
          BaseEngineController_LS_B.s206_RelationalOperator5) {
        /* Transition: '<S221>:6' */
        BaseEngineController_LS_DWork.s221_is_c12_BaseEngineController_LS =
          BaseEngineController_LS_IN_OnIdle;
     ...
     case BaseEngineController_LS_IN_OnIdle:
      ...
      if ((!BaseEngineController_LS_B.s206_RelationalOperator3) &&
          (BaseEngineController_LS_B.s206_LogicalOperator ||
           (!(EnableRPMFalling_DataStore())))) {
        /* Transition: '<S221>:8' */
        BaseEngineController_LS_DWork.s221_is_c12_BaseEngineController_LS =
          BaseEngineController_LS_IN_OffIdle;
