/*
 * Trigger_STARTUP_EVENT_4486p0011.c
 *
...
void Trigger_STARTUP_EVENT_4486p0011(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  {
    /* Output and update for function-call system: '<S563>/Once at Startup' */
    {
      ...
      /* DataTypeConversion: '<S613>/Data Type Conversion' incorporates:
       *  S-Function (motohawk_sfun_ain): '<S613>/motohawk_ain'
       */
      BaseEngineController_LS_B.s563_Merge = (real_T)rtb_motohawk_ain;
    }
  }
}
