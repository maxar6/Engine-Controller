/*
 * Trigger_FGND_5XRTI_PERIODIC_4910p0004.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_4910p0004(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s136_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S136>/MinGovernor' */
    {
       ...
       */
      rtb_Sum2_g = BaseEngineController_LS_B.s453_RPMInst -
      ...
      if (AirControlSource_DataStore() == FALSE) {
        rtb_Switch_e = BaseEngineController_LS_B.s415_Switch1;
      } else {
        rtb_Switch_e = BaseEngineController_LS_B.s422_Switch2;
      }
       ...
       */
      if (AirControlSource_DataStore() == FALSE) {
        rtb_RelOp_j = (BaseEngineController_LS_B.s430_Sum2 >
      ...
      if (rtb_LogicalOperator_i) {
        rtb_Product5 = BaseEngineController_LS_B.s453_RPMInst;
      } else {
       ...
       */
      if (!rtb_LogicalOperator_i) {
        rtb_Sum2_g = BaseEngineController_LS_B.s422_Switch2;
      } else {
    ...
    /* Output and update for function-call system: '<S136>/MaxGovernor' */
    {
       ...
       */
      if (BaseEngineController_LS_B.s581_Merge) {
       ...
       *  Sum: '<S233>/Sum1'
       */
      rtb_RelationalOperator_j = (BaseEngineController_LS_B.s453_RPMInst >
        rtb_Merge_a - rtb_Merge1);

      /* RelationalOperator: '<S231>/Relational Operator2' */
      rtb_RelationalOperator2_n = (BaseEngineController_LS_B.s453_RPMInst >
        rtb_Merge_a);
      ...
      rtb_RelationalOperator_c = (BaseEngineController_LS_B.s152_Sum <=
        BaseEngineController_LS_B.s422_Switch2 - (MaxGovTPSHyst_DataStore()));
      ...
      if (rtb_RelationalOperator_j) {
        rtb_alpha_o = BaseEngineController_LS_B.s453_RPMInst;
      } else {
      ...
      /* S-Function Block: <S230>/motohawk_interpolation_1d4 */
      {
        ...
        rtb_motohawk_interpolation_1d4_k = TableInterpolation1D_real_T
          (BaseEngineController_LS_B.s373_RPMAccel17Idx, (real_T *)
      ...
      if (BaseEngineController_LS_B.s266_RelOp) {
        /* S-Function Block: <S304>/motohawk_interpolation_1d4 */
        {
          ...
          rtb_motohawk_interpolation_1d4_p = TableInterpolation1D_real_T
            (BaseEngineController_LS_B.s405_motohawk_prelookup1, (real_T *)
