function msg = CANRx_AEM_DASH_DBW()
...
%%
  ...
  msg.name                    = 'AEM Infinity Dash';
  msg.description             = 'Message DBW';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A00D');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{6}.name          = 'DBW_Error_APP1_Range';
  msg.fields{6}.units         = 'On/Off';
  msg.fields{6}.start_bit     = 17;
  ...
  msg.fields{7}.name          = 'DBW_Error_APP2_Range';
  msg.fields{7}.units         = 'On/Off';
  msg.fields{7}.start_bit     = 18;
  ...
  msg.fields{8}.name          = 'DBW_Error_BTO';
  msg.fields{8}.units         = 'On/Off';
  ...
  msg.fields{9}.name          = 'DBW1_Error_Fatal';
  msg.fields{9}.units         = 'On/Off';
  msg.fields{9}.start_bit     = 8;
  ...
  msg.fields{10}.name          = 'DBW1_Error_TPSA_Range';
  msg.fields{10}.units         = 'On/Off';
  msg.fields{10}.start_bit     = 9;
  ...
  msg.fields{11}.name          = 'DBW1_Error_TPSB_Range';
  msg.fields{11}.units         = 'On/Off';
  msg.fields{11}.start_bit     = 10;
  ...
  msg.fields{12}.name          = 'DBW1_Error_Tracking';
  msg.fields{12}.units         = 'On/Off';
  msg.fields{12}.start_bit     = 11;
  ...
  msg.fields{13}.name          = 'DBW1_Error_Current';
  msg.fields{13}.units         = 'On/Off';
  msg.fields{13}.start_bit     = 12;
  ...
  msg.fields{14}.name          = 'DBW1_Error_TPS_Corr';
  msg.fields{14}.units         = 'On/Off';
  msg.fields{14}.start_bit     = 13;
  ...
  msg.fields{15}.name          = 'DBW2_Error_Fatal';
  msg.fields{15}.units         = 'On/Off';
  msg.fields{15}.start_bit     = 0;
  ...
  msg.fields{16}.name          = 'DBW2_Error_TPSA_Range';
  msg.fields{16}.units         = 'On/Off';
  msg.fields{16}.start_bit     = 1;
  ...
  msg.fields{17}.name          = 'DBW2_Error_TPSB_Range';
  msg.fields{17}.units         = 'On/Off';
  msg.fields{17}.start_bit     = 2;
  ...
  msg.fields{18}.name          = 'DBW2_Error_Tracking';
  msg.fields{18}.units         = 'On/Off';
  msg.fields{18}.start_bit     = 3;
  ...
  msg.fields{19}.name          = 'DBW2_Error_Current';
  msg.fields{19}.units         = 'On/Off';
  msg.fields{19}.start_bit     = 4;
  ...
  msg.fields{20}.name          = 'DBW2_Error_TPS_Corr';
  msg.fields{20}.units         = 'On/Off';
  msg.fields{20}.start_bit     = 5;
