function msg = CANRx_AEM_GPS_DATE_TIME()
...
%%
  ...
  msg.name                    = 'AEM GPS';
  msg.description             = 'GPS Date Time';
  msg.protocol                = '';
  msg.module                  = 'GPS';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('A0002');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'GPS_YearUTC';
  msg.fields{2}.units         = 'year';
  ...
  msg.fields{2}.offset        = 2000;
  
  msg.fields{3}.name          = 'GPS_MonthUTC';
  msg.fields{3}.units         = 'month';
  ...
  msg.fields{4}.name          = 'GPS_DayUTC';
  msg.fields{4}.units         = 'day';
  ...
  msg.fields{5}.name          = 'GPS_HoursUTC';
  msg.fields{5}.units         = 'hour';
  ...
  msg.fields{6}.name          = 'GPS_MinutesUTC';
  msg.fields{6}.units         = 'minute';
  ...
  msg.fields{7}.name          = 'GPS_SecondsUTC';
  msg.fields{7}.units         = 'seconds';
