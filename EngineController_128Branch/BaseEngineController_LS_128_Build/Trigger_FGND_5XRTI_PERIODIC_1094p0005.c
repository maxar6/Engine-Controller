...
#define BaseEngineController_LS_128_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_128_DWork.s14_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S14>/Spark Coil Characterization' */
    {
      ...
      if ((SparkDwell_ovr_DataStore())) {
         ...
         */
        rtb_Merge_c = BaseEngineController_LS_128_DWork.s87_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_128_B.s87_Sum = rtb_Merge_c +
      ...
      BaseEngineController_LS_128_DWork.s87_UnitDelay_DSTATE = rtb_Merge_c;
    }
  }
}
