   ...
   case FGND_TDC_EVENT:
    {
      if (FGND_TDC_EVENT_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_TDC_EVENT_9072p0002(void);
          Trigger_FGND_TDC_EVENT_9072p0002();
        }

        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_TDC_EVENT_7146p0001(void);
          Trigger_FGND_TDC_EVENT_7146p0001();
        }
   ...
   case STARTUP_EVENT:
    {
      if (STARTUP_EVENT_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_INIT) {
          extern void Trigger_STARTUP_EVENT_8345p0002(void);
          Trigger_STARTUP_EVENT_8345p0002();
        }
   ...
   case FGND_MID_TDC_EVENT:
    {
      if (FGND_MID_TDC_EVENT_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_MID_TDC_EVENT_8346p0002(void);
          Trigger_FGND_MID_TDC_EVENT_8346p0002();
        }
   ...
   case FGND_TDC1_EVENT:
    {
      if (FGND_TDC1_EVENT_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_TDC1_EVENT_984p0004(void);
          Trigger_FGND_TDC1_EVENT_984p0004();
        }
   ...
   case FGND_RTI_PERIODIC:
    {
      if (FGND_RTI_PERIODIC_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_RTI_PERIODIC_9872p0001(void);
          Trigger_FGND_RTI_PERIODIC_9872p0001();
        }
   ...
   case FGND_5XRTI_PERIODIC:
    {
      if (FGND_5XRTI_PERIODIC_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_5XRTI_PERIODIC_8535p0002(void);
          Trigger_FGND_5XRTI_PERIODIC_8535p0002();
        }

        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_5XRTI_PERIODIC_4926p0004(void);
          Trigger_FGND_5XRTI_PERIODIC_4926p0004();
        }

        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_5XRTI_PERIODIC_1237p0004(void);
          Trigger_FGND_5XRTI_PERIODIC_1237p0004();
        }

        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_5XRTI_PERIODIC_1236p0004(void);
          Trigger_FGND_5XRTI_PERIODIC_1236p0004();
        }

        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_5XRTI_PERIODIC_9590p0004(void);
          Trigger_FGND_5XRTI_PERIODIC_9590p0004();
        }
   ...
   case BGND_BASE_PERIODIC:
    {
      if (BGND_BASE_PERIODIC_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_BGND_BASE_PERIODIC_9866p0001(void);
          Trigger_BGND_BASE_PERIODIC_9866p0001();
        }
...
void OpenApplication(E_OpenEventType open_type)
{
...

  {
    ...
    DOut9834p0001_DiscreteOutput_Create();
    ...
    DOut8998p0002_DiscreteOutput_Create();
    ...
    PreO2Pin_AnalogInput_Create();
    MAF_Pin_FrequencyInput_Create();
    BrakePin_AnalogInput_Create();
    CruiseControl_AnalogInput_Create();
    CruiseControl_2_AnalogInput_Create();
    CruiseControl_3_AnalogInput_Create();
    ESTOPPin_DigitalInput_Create();
    GearStatePin_DigitalInput_Create();
    ScramblePin_AnalogInput_Create();
    TwoStepPin_DigitalInput_Create();
    SysVoltage_AnalogInput_Create();
    DOut9272p0004_DiscreteOutput_Create();
    DOut9273p0004_DiscreteOutput_Create();
    DOut9285p0004_DiscreteOutput_Create();
