...
%%
  ...
  msg.description             = 'Message 3';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A004');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'MAP';
  msg.fields{1}.units         = 'kPa';
  ...
  msg.fields{7}.name          = 'FAN1';
  msg.fields{7}.units         = 'On/Off';
  msg.fields{7}.start_bit     = 9;
  ...
  msg.fields{8}.name          = 'FAN2';
  msg.fields{8}.units         = 'On/Off';
  msg.fields{8}.start_bit     = 10;
  ...
  msg.fields{9}.name          = 'N20';
  msg.fields{9}.units         = 'On/Off';
  msg.fields{9}.start_bit     = 11;
  ...
  msg.fields{10}.name          = 'O2FB';
  msg.fields{10}.units         = 'On/Off';
  msg.fields{10}.start_bit     = 12;
  ...
  msg.fields{11}.name          = 'EngineProtect';
  msg.fields{11}.units         = 'On/Off';
  msg.fields{11}.start_bit     = 13;
  ...
  msg.fields{12}.name          = 'MILState';
  msg.fields{12}.units         = 'On/Off';
  msg.fields{12}.start_bit     = 14;
  ...
  msg.fields{13}.name          = 'LeanProtect';
  msg.fields{13}.units         = 'On/Off';
  msg.fields{13}.start_bit     = 15;
  ...
  msg.fields{14}.name          = 'OilPresProtect';
  msg.fields{14}.units         = 'On/Off';
  msg.fields{14}.start_bit     = 0;
  ...
  msg.fields{15}.name          = '2StepFuel';
  msg.fields{15}.units         = 'On/Off';
  msg.fields{15}.start_bit     = 1;
  ...
  msg.fields{16}.name          = '2StepSpark';
  msg.fields{16}.units         = 'On/Off';
  msg.fields{16}.start_bit     = 2;
  ...
  msg.fields{17}.name          = 'SyncState';
  msg.fields{17}.units         = 'On/Off';
  msg.fields{17}.start_bit     = 3;
  ...
  msg.fields{18}.name          = 'AC On';
  msg.fields{18}.units         = 'On/Off';
  msg.fields{18}.start_bit     = 4;
  ...
  msg.fields{19}.name          = 'BoostCut';
  msg.fields{19}.units         = 'On/Off';
  msg.fields{19}.start_bit     = 5;
  ...
  msg.fields{20}.name          = 'CoolantProtect';
  msg.fields{20}.units         = 'On/Off';
  msg.fields{20}.start_bit     = 6;
  ...
  msg.fields{21}.name          = 'DBZ Error';
  msg.fields{21}.units         = 'On/Off';
  msg.fields{21}.start_bit     = 7;
