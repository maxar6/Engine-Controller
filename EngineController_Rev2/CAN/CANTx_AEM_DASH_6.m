...
%%
  ...
  msg.description             = 'Message 6';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A007');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{9}.name          = 'ECU_Logging_Active';
  msg.fields{9}.units         = 'On/Off';
  msg.fields{9}.start_bit     = 1;
  ...
  msg.fields{10}.name          = 'ModeSelect_Ign';
  msg.fields{10}.units         = 'enum';
  msg.fields{10}.start_bit     = 2;
  msg.fields{10}.bit_length    = 2;
  msg.fields{10}.byte_order    = 'BIG_ENDIAN';
  msg.fields{10}.data_type     = 'UNSIGNED';
  msg.fields{10}.scale         = 1;
  msg.fields{10}.offset        = 0;
  
  msg.fields{11}.name          = 'ModeSelect_Lambda';
  msg.fields{11}.units         = 'enum';
  msg.fields{11}.start_bit     = 4;
  msg.fields{11}.bit_length    = 2;
  msg.fields{11}.byte_order    = 'BIG_ENDIAN';
  msg.fields{11}.data_type     = 'UNSIGNED';
  msg.fields{11}.scale         = 1;
  msg.fields{11}.offset        = 0;
  
  msg.fields{12}.name          = 'ModeSelect_DBW';
  msg.fields{12}.units         = 'enum';
  msg.fields{12}.start_bit     = 6;
  ...
  msg.fields{13}.name          = 'VTEC';
  msg.fields{13}.units         = 'On/Off';
  msg.fields{13}.start_bit     = 7;
