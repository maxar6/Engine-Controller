...
#define SRZ_NAME                       "BaseEngineController_LS_128_034"
#define MODEL_NAME                     "BaseEngineController_LS_128"
#define MODEL_GUID                     "a749ec14-8a37-4ecf-bb-ef-07-f5-29-2a-95"
#define BUILD_GUID                     "70e4bce9-a719-451e-bc-76-a9-56-b2-7d-46"
...
uint1 __SECTION_BSS_DECRAM__ FgndTimeStack[4096];
   ...
   case FGND_HIRES:
    {
      if (FGND_HIRES_RunCnt != 0) {
        if (ApplicationStatus == APPLICATION_RUN) {
          extern void Trigger_FGND_HIRES_12345p0009(void);
          Trigger_FGND_HIRES_12345p0009();
        }
