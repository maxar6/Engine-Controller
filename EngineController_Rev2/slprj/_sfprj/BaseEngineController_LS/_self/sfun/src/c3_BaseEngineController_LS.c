...
static void initialize_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void c3_set_sim_state_side_effects_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void finalize_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc3_BaseEngineController_LS
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static int32_T c3_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_b_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c3_b_tp_Init, const char_T *c3_identifier);
static uint8_T c3_c_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_d_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c3_etc, const char_T *c3_identifier);
static real_T c3_e_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint32_T c3_f_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c3_b_temporalCounter_i1, const char_T
  *c3_identifier);
static uint32_T c3_g_emlrt_marshallIn(SFc3_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void init_dsm_address_info(SFc3_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_BaseEngineController_LS = 0U;
  chartInstance->c3_is_c3_BaseEngineController_LS = 0U;
  ...
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c3_is_active_c3_BaseEngineController_LS == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_BaseEngineController_LS == c3_IN_Init) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_BaseEngineController_LS == c3_IN_Open) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_BaseEngineController_LS == c3_IN_Wait) {
  ...
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_BaseEngineController_LS;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = chartInstance->c3_is_c3_BaseEngineController_LS;
   ...
   *c3_st)
{
  ...
  *c3_etc = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "etc");
  chartInstance->c3_is_active_c3_BaseEngineController_LS = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_BaseEngineController_LS");
  chartInstance->c3_is_c3_BaseEngineController_LS = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_c3_BaseEngineController_LS");
  ...
  c3_update_debugger_state_c3_BaseEngineController_LS(chartInstance);
  ...
  (SFc3_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c3_etc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_set_sim_state_side_effects_c3_BaseEngineController_LS(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if ((int16_T)chartInstance->c3_is_active_c3_BaseEngineController_LS == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_BaseEngineController_LS = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_BaseEngineController_LS = c3_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_Init = 1U;
  } else {
    switch (chartInstance->c3_is_c3_BaseEngineController_LS) {
     case c3_IN_Init:
      CV_CHART_EVAL(2, 0, 1);
            ...
            *c3_timeSinceKeyOn < *c3_enblTime != 0U, chartInstance->c3_sfEvent)))
      {
        ...
        chartInstance->c3_tp_Init = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_BaseEngineController_LS = c3_IN_Open;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_temporalCounter_i1 = 0U;
        chartInstance->c3_tp_Open = 1U;
      } else {
     ...
     case c3_IN_Open:
      ...
      if (CV_TRANSITION_EVAL(2U, (int32_T)c3_temp)) {
        ...
        chartInstance->c3_tp_Open = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_BaseEngineController_LS = c3_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_Wait = 1U;
      } else {
        *c3_etc = *c3_icePos;
     ...
     default:
      CV_CHART_EVAL(2, 0, 0);
      chartInstance->c3_is_c3_BaseEngineController_LS = (uint8_T)
...
const mxArray *sf_c3_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc3_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c3_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"etc\",},{M[8],M[0],T\"is_active_c3_BaseEngineController_LS\",},{M[9],M[0],T\"is_c3_BaseEngineController_LS\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[4],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_BaseEngineController_LS
    ((SFc3_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c3_BaseEngineController_LS
    ((SFc3_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c3_BaseEngineController_LS((SFc3_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c3_BaseEngineController_LS((SFc3_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c3_BaseEngineController_LS((SFc3_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_BaseEngineController_LS
    ((SFc3_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c3_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_BaseEngineController_LS
    ((SFc3_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c3_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c3_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_BaseEngineController_LS
      ((SFc3_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_BaseEngineController_LS
    ((SFc3_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_BaseEngineController_LS
      ((SFc3_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_BaseEngineController_LS(SimStruct *S)
{
  ssSetNeedAbsoluteTime(S,1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",3,"RTWCG"));
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",3,
...
static void mdlRTW_c3_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_BaseEngineController_LS(SimStruct *S)
{
  SFc3_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc3_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc3_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_BaseEngineController_LS;
...
void c3_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_BaseEngineController_LS_method_dispatcher.\n"
