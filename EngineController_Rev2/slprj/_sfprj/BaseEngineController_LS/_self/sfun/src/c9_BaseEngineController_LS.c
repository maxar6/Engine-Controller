...
static void initialize_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c9_st);
static void c9_set_sim_state_side_effects_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void finalize_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void c9_chartstep_c9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc9_BaseEngineController_LS
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance);
static void c9_LowAdapt(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static int32_T c9_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static uint8_T c9_b_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c9_b_tp_PassThrough, const char_T *c9_identifier);
static uint8_T c9_c_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static real_T c9_d_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c9_TestTime, const char_T *c9_identifier);
static real_T c9_e_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static const mxArray *c9_e_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int8_T c9_f_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c9_DC_Override, const char_T *c9_identifier);
static int8_T c9_g_emlrt_marshallIn(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static const mxArray *c9_k_emlrt_marshallIn
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_BaseEngineController_LS = 0U;
  chartInstance->c9_is_c9_BaseEngineController_LS = 0U;
  ...
  chartInstance->c9_is_active_c9_BaseEngineController_LS = 1U;
  ...
  chartInstance->c9_is_c9_BaseEngineController_LS = c9_IN_PassThrough;
  ...
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c9_is_active_c9_BaseEngineController_LS == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 4U, chartInstance->c9_sfEvent);
  }

  if (chartInstance->c9_is_c9_BaseEngineController_LS == c9_IN_PassThrough) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c9_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c9_sfEvent);
  }

  if (chartInstance->c9_is_c9_BaseEngineController_LS == c9_IN_LowAdapt) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c9_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c9_sfEvent);
  }

  if (chartInstance->c9_is_c9_BaseEngineController_LS ==
  ...
  if (chartInstance->c9_is_c9_BaseEngineController_LS == c9_IN_SpringTest) {
  ...
  if (chartInstance->c9_is_c9_BaseEngineController_LS == c9_IN_ForcedShutdown) {
  ...
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c9_f_hoistedGlobal = chartInstance->c9_is_active_c9_BaseEngineController_LS;
  c9_f_u = c9_f_hoistedGlobal;
  c9_g_y = NULL;
  sf_mex_assign(&c9_g_y, sf_mex_create("y", &c9_f_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c9_y, 5, c9_g_y);
  c9_g_hoistedGlobal = chartInstance->c9_is_c9_BaseEngineController_LS;
   ...
   *c9_st)
{
  ...
  *c9_TestTime = c9_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c9_is_active_c9_BaseEngineController_LS = c9_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 5)),
     "is_active_c9_BaseEngineController_LS");
  chartInstance->c9_is_c9_BaseEngineController_LS = c9_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 6)),
     "is_c9_BaseEngineController_LS");
  ...
  c9_update_debugger_state_c9_BaseEngineController_LS(chartInstance);
  ...
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c9_TestTime = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c9_set_sim_state_side_effects_c9_BaseEngineController_LS(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c9_SetpointMode, 9U);
  chartInstance->c9_sfEvent = CALL_EVENT;
  c9_chartstep_c9_BaseEngineController_LS(chartInstance);
  ...
  (SFc9_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c9_TestTime = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c9_sfEvent);
  switch (chartInstance->c9_is_c9_BaseEngineController_LS) {
   case c9_IN_ForcedShutdown:
    ...
    if (CV_TRANSITION_EVAL(12U, !(_SFD_CCP_CALL(12U, 0, *c9_ECUP_Off != 0U,
      ...
      chartInstance->c9_tp_ForcedShutdown = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c9_sfEvent);
      chartInstance->c9_is_c9_BaseEngineController_LS = c9_IN_SpringTestComplete;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c9_sfEvent);
      chartInstance->c9_tp_SpringTestComplete = 1U;
      *c9_DC_Override = 1;
      _SFD_DATA_RANGE_CHECK((real_T)*c9_DC_Override, 2U);
   ...
   case c9_IN_PassThrough:
    ...
    if (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0, *c9_ECUP_Off != 0U,
      ...
      chartInstance->c9_tp_PassThrough = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c9_sfEvent);
      chartInstance->c9_is_c9_BaseEngineController_LS = c9_IN_LowAdapt;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c9_sfEvent);
      chartInstance->c9_tp_LowAdapt = 1U;
      *c9_DC_Override = 0;
      _SFD_DATA_RANGE_CHECK((real_T)*c9_DC_Override, 2U);
   ...
   case c9_IN_SpringTest:
    ...
    if (CV_TRANSITION_EVAL(9U, (int32_T)_SFD_CCP_CALL(9U, 0, *c9_Timer > 5.0 !=
      ...
      chartInstance->c9_tp_SpringTest = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c9_sfEvent);
      chartInstance->c9_is_c9_BaseEngineController_LS = c9_IN_ForcedShutdown;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c9_sfEvent);
      chartInstance->c9_tp_ForcedShutdown = 1U;
      *c9_DC_Override = 1;
      _SFD_DATA_RANGE_CHECK((real_T)*c9_DC_Override, 2U);
      ...
      *c9_TestTime = 0.0;
      ...
      if (CV_TRANSITION_EVAL(4U, (int32_T)c9_temp)) {
        ...
        chartInstance->c9_tp_SpringTest = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c9_sfEvent);
        chartInstance->c9_is_c9_BaseEngineController_LS =
          c9_IN_SpringTestComplete;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c9_sfEvent);
        chartInstance->c9_tp_SpringTestComplete = 1U;
        *c9_DC_Override = 1;
    ...
    if (CV_TRANSITION_EVAL(6U, !(_SFD_CCP_CALL(6U, 0, *c9_ECUP_Off != 0U,
      ...
      *c9_TestTime = 0.0;
      ...
      if (CV_TRANSITION_EVAL(3U, (int32_T)c9_b_temp)) {
        ...
        chartInstance->c9_tp_SpringTestSetpoint = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, chartInstance->c9_sfEvent);
        chartInstance->c9_is_c9_BaseEngineController_LS = c9_IN_SpringTest;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c9_sfEvent);
        chartInstance->c9_tp_SpringTest = 1U;
        *c9_DC_Override = 1;
        _SFD_DATA_RANGE_CHECK((real_T)*c9_DC_Override, 2U);
   ...
   default:
    CV_CHART_EVAL(4, 0, 0);
    chartInstance->c9_is_c9_BaseEngineController_LS = (uint8_T)
  ...
  if (CV_TRANSITION_EVAL(10U, (int32_T)_SFD_CCP_CALL(10U, 0, *c9_Timer > 5.0 !=
    ...
    *c9_TestTime = 0.0;
    ...
    if (CV_TRANSITION_EVAL(2U, (int32_T)c9_temp)) {
      ...
      chartInstance->c9_tp_LowAdapt = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c9_sfEvent);
      chartInstance->c9_is_c9_BaseEngineController_LS = c9_IN_SpringTestSetpoint;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c9_sfEvent);
      chartInstance->c9_tp_SpringTestSetpoint = 1U;
      *c9_DC_Override = 0;
      _SFD_DATA_RANGE_CHECK((real_T)*c9_DC_Override, 2U);
...
const mxArray *sf_c9_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc9_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c9_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[22],T\"DC_Override\",},{M[1],M[29],T\"SetpointMode\",},{M[1],M[28],T\"TestComplete\",},{M[1],M[20],T\"TestTime\",},{M[3],M[27],T\"TimerOld\",},{M[8],M[0],T\"is_active_c9_BaseEngineController_LS\",},{M[9],M[0],T\"is_c9_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c9_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_BaseEngineController_LS
    ((SFc9_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c9_BaseEngineController_LS
    ((SFc9_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c9_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c9_BaseEngineController_LS((SFc9_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c9_BaseEngineController_LS((SFc9_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c9_BaseEngineController_LS((SFc9_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_BaseEngineController_LS
    ((SFc9_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c9_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_BaseEngineController_LS
    ((SFc9_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c9_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c9_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c9_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c9_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_BaseEngineController_LS
      ((SFc9_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc9_BaseEngineController_LS
    ((SFc9_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_BaseEngineController_LS
      ((SFc9_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c9_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",9);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",9,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",9,
...
static void mdlRTW_c9_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_BaseEngineController_LS(SimStruct *S)
{
  SFc9_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc9_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc9_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c9_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_BaseEngineController_LS;
...
void c9_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_BaseEngineController_LS_method_dispatcher.\n"
