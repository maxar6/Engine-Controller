function msg = CANRx_AEM_GPS_SPEED_DIRECTION()
...
%%
  ...
  msg.name                    = 'AEM GPS';
  msg.description             = 'GPS Speed Direction';
  msg.protocol                = '';
  msg.module                  = 'GPS';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('A0001');
