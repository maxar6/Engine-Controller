/*
 * Trigger_FGND_5XRTI_PERIODIC_12064p0004.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_12064p0004(void)
{
...
#define BaseEngineController_LS_128_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_128_DWork.s5_motohawk_trigger_DWORK1) {
    BaseEngineController_LS_128_CCPDaqProcessing(1);
  }
}
