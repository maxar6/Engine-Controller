/*
 * Trigger_FGND_5XRTI_PERIODIC_30560p0005.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_30560p0005(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s93_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S93>/DFCO' */
    {
       ...
       */
      rtb_RelationalOperator_a = (BaseEngineController_LS_B.s557_Sum1 >=
       ...
       */
      rtb_RelationalOperator1_l = (BaseEngineController_LS_B.s445_Switch1 <=
       ...
       */
      rtb_LogicalOperator2_l = (BaseEngineController_LS_B.s608_Merge <= (real_T)
       ...
       *  Sum: '<S147>/Sum1'
       */
      BaseEngineController_LS_B.s147_LogicalOperator =
        ((rtb_RelationalOperator_a && rtb_RelationalOperator1_l &&
          rtb_LogicalOperator2_l && rtb_LogicalOperator1_d &&
          (DFCOEnable_DataStore()) && (BaseEngineController_LS_B.s557_Sum1 >=
      ...
      /* S-Function Block: <S150>/motohawk_delta_time */
      {
        ...
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s150_motohawk_delta_time_DWORK1, NULL);
       ...
       *  Sum: '<S150>/Sum'
       */
      if (BaseEngineController_LS_B.s147_LogicalOperator) {
       ...
       */
      rtb_LogicalOperator2_l = (BaseEngineController_LS_B.s147_LogicalOperator &&
       ...
       */
      rtb_RelationalOperator1_l = (BaseEngineController_LS_B.s557_Sum1 <=
       ...
       */
      rtb_LogicalOperator1_d = (BaseEngineController_LS_B.s445_Switch1 >=
      ...
      rtb_LogicalOperator4 = ((rtb_RelationalOperator_a &&
        ...
        (BaseEngineController_LS_B.s608_Merge >= (real_T)((uint8_T)
      ...
      if (rtb_CombinatorialLogic[1]) {
        BaseEngineController_LS_B.s149_Switch1 = rtb_CombinatorialLogic[0];
      } else {
        BaseEngineController_LS_B.s149_Switch1 =
          BaseEngineController_LS_DWork.s149_UnitDelay_DSTATE;
      }
      ...
      /* S-Function Block: <S148>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s148_motohawk_delta_time_DWORK1, NULL);
       ...
       */
      if (BaseEngineController_LS_B.s149_Switch1 == FALSE) {
       ...
       */
      rtb_Switch1_p += BaseEngineController_LS_DWork.s148_state_DSTATE;
      ...
      BaseEngineController_LS_B.s105_EquivRatioInfo[0] =
        BaseEngineController_LS_B.s103_DesEquivRatio;
      BaseEngineController_LS_B.s105_EquivRatioInfo[1] =
        BaseEngineController_LS_B.s103_WarmUpRatio;
      BaseEngineController_LS_B.s105_EquivRatioInfo[2] =
        BaseEngineController_LS_B.s127_Switch;
      BaseEngineController_LS_B.s105_EquivRatioInfo[3] =
        BaseEngineController_LS_B.s103_IATEnrichment;
      BaseEngineController_LS_B.s105_EquivRatioInfo[4] =
       ...
       *  Sum: '<S147>/Sum2'
       */
      BaseEngineController_LS_B.s147_Product1 = (1.0 - rtb_Switch1_p) *
        BaseEngineController_LS_B.s105_EquivRatioInfo[0];
       ...
       */
      BaseEngineController_LS_B.s147_SpkOut = rtb_Switch1_p * (real_T)((int16_T)
       ...
       *  MinMax: '<S151>/MinMax1'
       */
      BaseEngineController_LS_DWork.s148_state_DSTATE = rtb_Switch1_p;
    }
    ...
    /* Output and update for function-call system: '<S93>/MinGovernor' */
    {
       ...
       */
      rtb_Sum2_g = BaseEngineController_LS_B.s483_RPMInst -
      ...
      rtb_Sum1_f = (1.0 - rtb_Switch_e0) *
        BaseEngineController_LS_DWork.s226_UnitDelay_DSTATE + rtb_Sum2_g *
        rtb_Switch_e0;
       ...
       */
      BaseEngineController_LS_B.s220_RelationalOperator = ((rtb_Sum1_f <
      ...
      if (rtIsNaN(BaseEngineController_LS_B.s483_RPMInst) || rtIsInf
        ...
        rtb_Sum2_g = fmod(floor(BaseEngineController_LS_B.s483_RPMInst), 65536.0);
      }
      ...
      /* S-Function Block: <S204>/motohawk_interpolation_1d2 */
      {
        ...
        rtb_motohawk_interpolation_1d2_i = TableInterpolation1D_int16_T
          (BaseEngineController_LS_B.s433_motohawk_prelookup, (int16_T *)
       ...
       *  Sum: '<S206>/Sum'
       */
      BaseEngineController_LS_B.s206_RelationalOperator =
       ...
       *  Sum: '<S206>/Sum2'
       */
      BaseEngineController_LS_B.s206_RelationalOperator3 =
        ((rtb_DataTypeConversion_f < tmp));
      ...
      if (AirControlSource_DataStore() == FALSE) {
        rtb_Switch_e0 = BaseEngineController_LS_B.s445_Switch1;
      } else {
        rtb_Switch_e0 = BaseEngineController_LS_B.s452_Switch2;
      }
       ...
       */
      BaseEngineController_LS_B.s206_RelationalOperator1 = ((rtb_Switch_e0 <
       ...
       */
      if (AirControlSource_DataStore() == FALSE) {
        rtb_RelationalOperator2_e = (BaseEngineController_LS_B.s460_Sum2 >
          BaseEngineController_LS_DWork.s110_UnitDelay3_DSTATE);
      } else {
       ...
       *  Sum: '<S206>/Sum1'
       */
      BaseEngineController_LS_B.s206_LogicalOperator = (((rtb_Switch_e0 >=
       ...
       *  Sum: '<S223>/Sum'
       */
      if (BaseEngineController_LS_B.s206_RelationalOperator1) {
       ...
       */
      BaseEngineController_LS_B.s206_RelationalOperator5 = ((rtb_Switch_e0 >
       ...
       */
      BaseEngineController_LS_B.s222_RelOp =
        ((BaseEngineController_LS_B.s221_IdleState == 2));

      /* UnitDelay: '<S110>/Unit Delay1' */
      rtb_UnitDelay1_j = BaseEngineController_LS_DWork.s110_UnitDelay1_DSTATE;
      ...
      if (BaseEngineController_LS_B.s222_RelOp) {
         ...
         */
        BaseEngineController_LS_B.s203_LogicalOperator1 =
         ...
         */
        if (BaseEngineController_LS_B.s203_LogicalOperator1) {
      ...
      /* S-Function Block: <S205>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s205_motohawk_delta_time_DWORK1, NULL);
       ...
       */
      if (BaseEngineController_LS_B.s222_RelOp == FALSE) {
       ...
       */
      rtb_Product5 += BaseEngineController_LS_DWork.s205_state_DSTATE;
      ...
      BaseEngineController_LS_B.s219_MinMax1 = rtb_Sum2_g <= 1.0 ? rtb_Sum2_g :
        1.0;

      /* RelationalOperator: '<S208>/RelOp' incorporates:
       *  Constant: '<S208>/Constant'
       */
      rtb_RelationalOperator2_e = (BaseEngineController_LS_B.s219_MinMax1 == 0.0);

      /* UnitDelay: '<S110>/Unit Delay2' */
      rtb_Sum2_g = BaseEngineController_LS_DWork.s110_UnitDelay2_DSTATE;
      ...
      zcEvent = rt_ZCFcn(FALLING_ZERO_CROSSING,
                         ...
                         (BaseEngineController_LS_DWork.s110_UnitDelay2_DSTATE -
                          0.5));
      if (BaseEngineController_LS_DWork.s110_HitCrossing1_MODE == 0) {
        if (zcEvent != NO_ZCEVENT) {
          BaseEngineController_LS_B.s110_HitCrossing1 =
            !BaseEngineController_LS_B.s110_HitCrossing1;
          BaseEngineController_LS_DWork.s110_HitCrossing1_MODE = 1;
        } else {
          if (BaseEngineController_LS_B.s110_HitCrossing1 && (rtb_Sum2_g != 0.5))
          {
            BaseEngineController_LS_B.s110_HitCrossing1 = FALSE;
          }
        }
      } else {
        if (rtb_Sum2_g != 0.5) {
        ...
        BaseEngineController_LS_DWork.s110_HitCrossing1_MODE = 0;
      }

      /* End of HitCross: '<S110>/Hit  Crossing1' */

      /* Logic: '<S110>/Logical Operator' */
      BaseEngineController_LS_B.s110_LogicalOperator =
        ((rtb_RelationalOperator2_e ||
          BaseEngineController_LS_B.s110_HitCrossing1));
      ...
      rtb_LogicalOperator_i = !BaseEngineController_LS_B.s222_RelOp;
      ...
      rtb_Sum2_g = BaseEngineController_LS_DWork.s209_UnitDelay_DSTATE;
      ...
      if (rtb_LogicalOperator_i) {
        rtb_Product5 = BaseEngineController_LS_B.s483_RPMInst;
      } else {
      ...
      /* Sum: '<S235>/Sum2' */
      BaseEngineController_LS_B.s235_Sum2 =
        BaseEngineController_LS_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM
       ...
       */
      rtb_Product5 = BaseEngineController_LS_B.s235_Sum2 *
       ...
       */
      BaseEngineController_LS_B.s235_Product2 = (AirMinGovPGain_DataStore()) *
        rtb_motohawk_interpolation_1d2 * rtb_Product5;

      /* UnitDelay: '<S236>/Unit Delay' */
      rtb_Sum2_g = BaseEngineController_LS_DWork.s236_UnitDelay_DSTATE;
       ...
       *  Sum: '<S236>/Sum2'
       */
      BaseEngineController_LS_B.s236_Product = (rtb_Product4 - rtb_Sum2_g) /
       ...
       */
      if (BaseEngineController_LS_B.s110_LogicalOperator) {
        BaseEngineController_LS_B.s237_Switch1 = 0.0;
      } else {
        BaseEngineController_LS_B.s237_Switch1 =
          BaseEngineController_LS_DWork.s237_UnitDelay_DSTATE;
      }
      ...
      if (BaseEngineController_LS_B.s110_LogicalOperator) {
         ...
         *  Sum: '<S235>/Sum1'
         */
        rtb_Sum2_g = (BaseEngineController_LS_B.s235_Product2 +
                      BaseEngineController_LS_B.s236_Product) +
          BaseEngineController_LS_B.s237_Switch1;
      ...
      BaseEngineController_LS_B.s110_MinGovAirPID =
        BaseEngineController_LS_B.s219_MinMax1 * rtb_UnitDelay1_j;

      /* Sum: '<S230>/Sum1' */
      BaseEngineController_LS_B.s230_Sum1 =
        BaseEngineController_LS_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM
        - BaseEngineController_LS_B.s557_Sum1;
       ...
       */
      rtb_UnitDelay1_j = BaseEngineController_LS_B.s230_Sum1 *
       ...
       */
      BaseEngineController_LS_B.s230_Product = (SpkMinGovPGain_DataStore()) *
        rtb_motohawk_interpolation_1d2_f * rtb_UnitDelay1_j;

      /* UnitDelay: '<S231>/Unit Delay' */
      rtb_Sum2_g = BaseEngineController_LS_DWork.s231_UnitDelay_DSTATE;
       ...
       *  Sum: '<S231>/Sum2'
       */
      BaseEngineController_LS_B.s231_Product = (rtb_Product2_j - rtb_Sum2_g) /
      ...
      if (rtb_RelationalOperator2_e) {
         ...
         *  Sum: '<S230>/Sum'
         */
        rtb_Sum2_g = BaseEngineController_LS_B.s230_Product +
          BaseEngineController_LS_B.s231_Product;
      ...
      BaseEngineController_LS_B.s110_IdleSpk =
        BaseEngineController_LS_B.s219_MinMax1 * rtb_UnitDelay1_j;
      ...
      rtb_Sum2_g = ((ACAirFlowOfst_Enab_DataStore()) ? (real_T)
                    BaseEngineController_LS_B.s101_LogicalOperator : 0.0) *
      ...
      rtb_RelationalOperator2_e = ((rtb_RelOp <
        BaseEngineController_LS_DWork.s202_UnitDelay_DSTATE) || (rtb_RelOp ==
      ...
      /* S-Function Block: <S212>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s212_motohawk_delta_time_DWORK1, NULL);
        rtb_motohawk_delta_time_bc = ((real_T) delta) * 0.000001;
      }

      /* UnitDelay: '<S212>/Unit Delay' */
      rtb_Sum2_g = BaseEngineController_LS_DWork.s212_UnitDelay_DSTATE;
       ...
       */
      if (!rtb_RelationalOperator2_e) {
        rtb_Sum2_g = BaseEngineController_LS_B.s452_Switch2;
      } else {
      ...
      /* Sum: '<S207>/Sum' */
      rtb_UnitDelay1_j = BaseEngineController_LS_B.s557_Sum1 -
        BaseEngineController_LS_B.s209_DontallowsetpointtoeverdropbelowtheTargetRPM;
      ...
      {
        BaseEngineController_LS_B.s227_Switch = rtb_motohawk_delta_time_n2 +
       ...
       */
      BaseEngineController_LS_B.s207_RelationalOperator1 =
        ((BaseEngineController_LS_B.s227_Switch >
      ...
      rtb_Saturation_k = BaseEngineController_LS_B.s227_Switch >= 16000.0 ?
        16000.0 : BaseEngineController_LS_B.s227_Switch <= 0.0 ? 0.0 :
        BaseEngineController_LS_B.s227_Switch;
      ...
      /* S-Function Block: <S237>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s237_motohawk_delta_time_DWORK1, NULL);
      ...
      BaseEngineController_LS_DWork.s226_UnitDelay_DSTATE = rtb_Sum1_f;
      ...
      BaseEngineController_LS_DWork.s110_UnitDelay1_DSTATE =
        BaseEngineController_LS_B.s237_Switch1;

      /* Update for UnitDelay: '<S205>/state' */
      BaseEngineController_LS_DWork.s205_state_DSTATE =
        BaseEngineController_LS_B.s219_MinMax1;
      ...
      BaseEngineController_LS_DWork.s236_UnitDelay_DSTATE = rtb_Product4;
       ...
       */
      BaseEngineController_LS_DWork.s237_UnitDelay_DSTATE = (rtb_Sum2_g <=
      ...
      BaseEngineController_LS_DWork.s231_UnitDelay_DSTATE = rtb_Product2_j;
      ...
      BaseEngineController_LS_DWork.s212_UnitDelay_DSTATE =
        BaseEngineController_LS_B.s212_DontallowsetpointtoeverdropbelowtheTargetRPM;
    ...
    /* Output and update for function-call system: '<S93>/AC Control' */
    {
       ...
       */
      rtb_BelowLoTarget = (BaseEngineController_LS_B.s676_Merge >=
                           (ACTempOn_DataStore()));

      /* RelationalOperator: '<S118>/LT1' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S101>/motohawk_calibration8'
       */
      rtb_AboveHiTarget = (BaseEngineController_LS_B.s676_Merge <=
                           (ACTempOff_DataStore()));
      ...
      if (rtIsNaN(BaseEngineController_LS_B.s557_Sum1) || rtIsInf
          (BaseEngineController_LS_B.s557_Sum1)) {
        tmp = 0.0;
      } else {
        tmp = fmod(floor(BaseEngineController_LS_B.s557_Sum1), 65536.0);
      }
       ...
       */
      if (rtb_CombinatorialLogic_m[1]) {
        BaseEngineController_LS_B.s123_Switch1 = rtb_CombinatorialLogic_m[0];
      } else {
        BaseEngineController_LS_B.s123_Switch1 =
          BaseEngineController_LS_DWork.s123_UnitDelay_DSTATE;
      }
      ...
      if (rtb_CombinatorialLogic_m[1]) {
        ...
        rtb_Switch1_n = BaseEngineController_LS_DWork.s121_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S121>/Switch1' */

      /* Logic: '<S101>/Logical Operator2' */
      BaseEngineController_LS_B.s101_LogicalOperator2 = !rtb_Switch1_n;

      /* DataTypeConversion: '<S101>/Data Type Conversion2' */
      if (rtIsNaN(BaseEngineController_LS_B.s452_Switch2) || rtIsInf
          (BaseEngineController_LS_B.s452_Switch2)) {
        tmp = 0.0;
      } else {
        tmp = fmod(floor(BaseEngineController_LS_B.s452_Switch2), 65536.0);
      }
      ...
      if (rtb_CombinatorialLogic_m[1]) {
        ...
        rtb_Switch1_k = BaseEngineController_LS_DWork.s122_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S122>/Switch1' */

      /* Logic: '<S101>/Logical Operator4' */
      BaseEngineController_LS_B.s101_LogicalOperator4 = !rtb_Switch1_k;

      /* Logic: '<S101>/Logical Operator3' */
      rtb_LogicalOperator3_o = (BaseEngineController_LS_B.s123_Switch1 &&
        BaseEngineController_LS_B.s101_LogicalOperator2);

      /* DataTypeConversion: '<S101>/Data Type Conversion1' */
      if (rtIsNaN(BaseEngineController_LS_B.s571_Merge) || rtIsInf
          (BaseEngineController_LS_B.s571_Merge)) {
        tmp = 0.0;
      } else {
        tmp = fmod(floor(BaseEngineController_LS_B.s571_Merge), 65536.0);
      }
       ...
       */
      if (rtb_CombinatorialLogic_m[1]) {
        BaseEngineController_LS_B.s120_Switch1 = rtb_CombinatorialLogic_m[0];
      } else {
        BaseEngineController_LS_B.s120_Switch1 =
          BaseEngineController_LS_DWork.s120_UnitDelay_DSTATE;
      }
      ...
      if (rtb_CombinatorialLogic_m[1]) {
        ...
        rtb_Switch1_e = BaseEngineController_LS_DWork.s119_UnitDelay_DSTATE;
      }

      /* End of Switch: '<S119>/Switch1' */

      /* Logic: '<S101>/Logical Operator1' */
      BaseEngineController_LS_B.s101_LogicalOperator1 = !rtb_Switch1_e;

      /* RelationalOperator: '<S101>/Relational Operator' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S101>/motohawk_calibration7'
       */
      rtb_RelationalOperator_j = (BaseEngineController_LS_B.s473_Switch >=
      ...
      BaseEngineController_LS_B.s101_LogicalOperator =
        ((BaseEngineController_LS_B.s514_Merge &&
          BaseEngineController_LS_B.s124_Switch1 && rtb_LogicalOperator3_o &&
          BaseEngineController_LS_B.s101_LogicalOperator4 &&
          BaseEngineController_LS_B.s120_Switch1 &&
          BaseEngineController_LS_B.s101_LogicalOperator1 &&
      ...
      BaseEngineController_LS_DWork.s121_UnitDelay_DSTATE = rtb_Switch1_n;

      /* Update for UnitDelay: '<S122>/Unit Delay' */
      BaseEngineController_LS_DWork.s122_UnitDelay_DSTATE = rtb_Switch1_k;
      ...
      BaseEngineController_LS_DWork.s119_UnitDelay_DSTATE = rtb_Switch1_e;
    }
    ...
    /* Output and update for function-call system: '<S93>/Boost Control' */
    {
       ...
       *  Sum: '<S104>/Sum1'
       */
      rtb_kPatoPSI = (BaseEngineController_LS_B.s608_Merge -
                      BaseEngineController_LS_B.s407_Sum) * 0.145038;
      ...
      rtb_UnitDelay_hb = BaseEngineController_LS_DWork.s104_UnitDelay_DSTATE;
      ...
      if (!rtb_RelationalOperator_n) {
         ...
         */
        BaseEngineController_LS_B.s131_LogicalOperator1 =
         ...
         */
        if (BaseEngineController_LS_B.s131_LogicalOperator1) {
      ...
      if (rtb_RelationalOperator_n) {
        ...
        BaseEngineController_LS_B.s143_Switch1 =
          BaseEngineController_LS_DWork.s143_UnitDelay_DSTATE;
      }
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_2d2 */
      {
        ...
        rtb_motohawk_interpolation_2d2 = TableInterpolation2D_int8_T
          (BaseEngineController_LS_B.s440_motohawk_prelookup,
           BaseEngineController_LS_B.s437_motohawk_prelookup1, (int8_T *)
       ...
       */
      rtb_UnitDelay_hb = (real_T)BaseEngineController_LS_B.s533_Merge *
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_1d */
      {
        ...
        rtb_MinMax_g = TableInterpolation1D_int8_T
          (BaseEngineController_LS_B.s433_motohawk_prelookup, (int8_T *)
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_1d3 */
      {
        ...
        rtb_motohawk_interpolation_1d3_d = TableInterpolation1D_int8_T
          (BaseEngineController_LS_B.s434_motohawk_prelookup, (int8_T *)
      ...
      BaseEngineController_LS_B.s104_MinMax2 = rtb_UnitDelay_hb <= rtb_Abs_e ?
        rtb_UnitDelay_hb : rtb_Abs_e;

      /* UnitDelay: '<S133>/Unit Delay' */
      rtb_Abs_e = BaseEngineController_LS_DWork.s133_UnitDelay_DSTATE;
      ...
      rtb_UnitDelay_hb = 1.0 / rtb_motohawk_delta_time_i *
        (BaseEngineController_LS_B.s104_MinMax2 -
         BaseEngineController_LS_DWork.s133_UnitDelay_DSTATE);
      ...
      /* Sum: '<S141>/Sum2' */
      BaseEngineController_LS_B.s141_Sum2 = rtb_Sum2_o - rtb_kPatoPSI;

      /* Product: '<S141>/Product5' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S132>/motohawk_calibration5'
       */
      rtb_UnitDelay_hb = BaseEngineController_LS_B.s141_Sum2 *
      ...
      /* S-Function Block: <S132>/motohawk_prelookup1 */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (BoostCtlSpeedErrorIn_DataStore()) = BaseEngineController_LS_B.s141_Sum2;
        (BoostCtlSpeedErrorIdx_DataStore()) = TablePrelookup_real_T
          (BaseEngineController_LS_B.s141_Sum2,
       ...
       */
      BaseEngineController_LS_B.s141_Product2 = (BoostCtlPGain_DataStore()) *
        rtb_motohawk_interpolation_1d2_l * rtb_UnitDelay_hb;

      /* UnitDelay: '<S142>/Unit Delay' */
      rtb_Abs_e = BaseEngineController_LS_DWork.s142_UnitDelay_DSTATE;
       ...
       *  Sum: '<S142>/Sum2'
       */
      BaseEngineController_LS_B.s142_Product = (rtb_kPatoPSI - rtb_Abs_e) /
      ...
      if (rtb_RelationalOperator_n) {
         ...
         *  Sum: '<S141>/Sum1'
         */
        rtb_Abs_e = (BaseEngineController_LS_B.s141_Product2 +
                     BaseEngineController_LS_B.s142_Product) +
          BaseEngineController_LS_B.s143_Switch1;
         ...
         */
        BaseEngineController_LS_B.s132_Switch = (rtb_Abs_e <=
      ...
      /* S-Function Block: <S104>/motohawk_prelookup */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (BoostTargetIn_DataStore()) = BaseEngineController_LS_B.s104_MinMax2;
        (BoostTargetIdx_DataStore()) = TablePrelookup_real_T
          (BaseEngineController_LS_B.s104_MinMax2, (BoostTargetIdxArr_DataStore()),
      ...
      /* S-Function Block: <S104>/motohawk_interpolation_2d */
      {
        ...
        BaseEngineController_LS_B.s104_motohawk_interpolation_2d =
          TableInterpolation2D_uint8_T(rtb_motohawk_prelookup,
          BaseEngineController_LS_B.s437_motohawk_prelookup1, (uint8_T *)
      ...
      rtb_Abs_e = (rtb_motohawk_interpolation_2d1_d + (real_T)
                   BaseEngineController_LS_B.s104_motohawk_interpolation_2d) +
        BaseEngineController_LS_B.s132_Switch;
       ...
       */
      BaseEngineController_LS_B.s104_Sum3 = rtb_Abs_e +
      ...
      if (rtb_RelationalOperator_n) {
        ...
        BaseEngineController_LS_B.s104_Switch =
          BaseEngineController_LS_B.s104_Sum3;
      }
      ...
      /* S-Function Block: <S143>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s143_motohawk_delta_time_DWORK1, NULL);
      ...
      BaseEngineController_LS_DWork.s104_UnitDelay_DSTATE =
        BaseEngineController_LS_B.s143_Switch1;
       ...
       */
      BaseEngineController_LS_DWork.s143_UnitDelay_DSTATE = (maxV <=
      ...
      BaseEngineController_LS_DWork.s133_UnitDelay_DSTATE = rtb_Sum2_o;

      /* Update for UnitDelay: '<S142>/Unit Delay' */
      BaseEngineController_LS_DWork.s142_UnitDelay_DSTATE = rtb_kPatoPSI;
    }
    ...
    /* Output and update for function-call system: '<S93>/FAN Control' */
    {
       ...
       */
      rtb_BelowLoTarget_b = (BaseEngineController_LS_B.s667_Merge >=
        ECTFanOn_DataStore());

      /* RelationalOperator: '<S152>/LT1' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S106>/motohawk_data_read1'
       */
      rtb_AboveHiTarget_a = (BaseEngineController_LS_B.s667_Merge <=
        ECTFanOff_DataStore());
      ...
      if (rtb_CombinatorialLogic_c[1]) {
        ...
        rtb_Switch1_em = BaseEngineController_LS_DWork.s155_UnitDelay_DSTATE;
      }
      ...
      if (FAN_Mode_DataStore()) {
        ...
        /* S-Function Block: <S106>/motohawk_interpolation_2d */
        {
          ...
          rtb_motohawk_interpolation_2d = TableInterpolation2D_real_T
            (BaseEngineController_LS_B.s433_motohawk_prelookup2,
             BaseEngineController_LS_B.s440_motohawk_prelookup2, (real_T *)
       ...
       */
      rtb_AboveHiTarget_a = (BaseEngineController_LS_B.s685_Merge >=
        IATFanOn_DataStore());

      /* RelationalOperator: '<S153>/LT1' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S106>/motohawk_data_read3'
       */
      rtb_BelowLoTarget_b = (BaseEngineController_LS_B.s685_Merge <=
        IATFanOff_DataStore());
      ...
      if (rtb_CombinatorialLogic_c[1]) {
        ...
        rtb_Switch1_l = BaseEngineController_LS_DWork.s156_UnitDelay_DSTATE;
      }
      ...
      if (FAN_Mode_DataStore()) {
        ...
        /* S-Function Block: <S106>/motohawk_interpolation_2d1 */
        {
          ...
          rtb_motohawk_interpolation_2d1_i = TableInterpolation2D_real_T
            (BaseEngineController_LS_B.s434_motohawk_prelookup1,
             BaseEngineController_LS_B.s440_motohawk_prelookup2, (real_T *)
      ...
      if (rtb_CombinatorialLogic_c[1]) {
        ...
        rtb_Switch1_m = BaseEngineController_LS_DWork.s157_UnitDelay_DSTATE;
      }
      ...
      if (FAN_Mode_DataStore()) {
        ...
        /* S-Function Block: <S106>/motohawk_interpolation_2d2 */
        {
          ...
          rtb_motohawk_interpolation_2d2_n = TableInterpolation2D_real_T
            (BaseEngineController_LS_B.s431_motohawk_prelookup1,
             BaseEngineController_LS_B.s440_motohawk_prelookup2, (real_T *)
      ...
      rtb_DataTypeConversion_cu = (real_T)BaseEngineController_LS_B.s514_Merge;
      ...
      if (rtb_motohawk_fault_action_l) {
        ...
        u = (u >= rtb_Product2_jc) || rtIsNaN(rtb_Product2_jc) ? u :
          rtb_Product2_jc;
        BaseEngineController_LS_B.s106_Switch4 = u >= rtb_Product3_m ? u :
          rtb_Product3_m;
      }
      ...
      if (rtb_motohawk_fault_action_l) {
        ...
        u = (u >= rtb_Product3_m) || rtIsNaN(rtb_Product3_m) ? u :
          rtb_Product3_m;
        BaseEngineController_LS_B.s106_Switch5 = u >= rtb_Product2_jc ? u :
          rtb_Product2_jc;
      }
      ...
      BaseEngineController_LS_DWork.s155_UnitDelay_DSTATE = rtb_Switch1_em;

      /* Update for UnitDelay: '<S156>/Unit Delay' */
      BaseEngineController_LS_DWork.s156_UnitDelay_DSTATE = rtb_Switch1_l;

      /* Update for UnitDelay: '<S157>/Unit Delay' */
      BaseEngineController_LS_DWork.s157_UnitDelay_DSTATE = rtb_Switch1_m;
    }
    ...
    /* Output and update for function-call system: '<S93>/MaxGovernor' */
    {
      ...
      /* Sum: '<S109>/Sum' */
      BaseEngineController_LS_B.s109_Sum =
        BaseEngineController_LS_B.s212_DontallowsetpointtoeverdropbelowtheTargetRPM
       ...
       *  Sum: '<S189>/Sum1'
       */
      rtb_RelationalOperator_j1 = (BaseEngineController_LS_B.s483_RPMInst >
      ...
      rtb_RelationalOperator2_n = (BaseEngineController_LS_B.s483_RPMInst >
       ...
       *  Sum: '<S187>/Sum'
       */
      rtb_RelationalOperator_c = (BaseEngineController_LS_B.s109_Sum <=
        BaseEngineController_LS_B.s452_Switch2 - (MaxGovTPSHyst_DataStore()));
      ...
      rtb_LogicalOperator1_l = (rtb_RelationalOperator_j1 &&
        (BaseEngineController_LS_B.s109_Sum > (MaxGovTPSHyst_DataStore()) +
         BaseEngineController_LS_B.s452_Switch2));
      ...
      BaseEngineController_LS_B.s187_DataTypeConversion = 0;

      /* Logic: '<S188>/Logical Operator' incorporates:
       *  UnitDelay: '<S109>/Unit Delay'
       */
      rtb_RelationalOperator_j1 =
        !BaseEngineController_LS_DWork.s109_UnitDelay_DSTATE;
      ...
      /* S-Function Block: <S188>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s188_motohawk_delta_time_DWORK1, NULL);
        rtb_motohawk_delta_time_d4 = ((real_T) delta) * 0.000001;
      }

      /* UnitDelay: '<S188>/Unit Delay' */
      rtb_Reset = BaseEngineController_LS_DWork.s188_UnitDelay_DSTATE;
      ...
      if (rtb_RelationalOperator_j1) {
        rtb_alpha_o = BaseEngineController_LS_B.s483_RPMInst;
      } else {
      ...
      BaseEngineController_LS_B.s187_DataTypeConversion1 = (int8_T)(rtb_Reset <
        0.0 ? (int8_T)-(int8_T)(uint8_T)-rtb_Reset : (int8_T)(uint8_T)rtb_Reset);

      /* Switch: '<S190>/Switch1' */
      if (BaseEngineController_LS_B.s187_DataTypeConversion1 >= 1) {
        rtb_alpha_o =
          BaseEngineController_LS_B.s188_DontallowsetpointtoevergoabovetheTargetRPM;
      } else {
        rtb_alpha_o = BaseEngineController_LS_B.s483_RPMInst;
      ...
      /* Sum: '<S197>/Sum2' */
      BaseEngineController_LS_B.s197_Sum2 =
        BaseEngineController_LS_B.s188_DontallowsetpointtoevergoabovetheTargetRPM
        - rtb_alpha_o;
       ...
       */
      rtb_alpha_o = BaseEngineController_LS_B.s197_Sum2 *
      ...
      /* S-Function Block: <S190>/motohawk_prelookup1 */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (MaxGovSpeedErrorIn_DataStore()) = BaseEngineController_LS_B.s197_Sum2;
       ...
       */
      BaseEngineController_LS_B.s197_Product2 = (MaxGovPGain_DataStore()) *
        rtb_motohawk_interpolation_1d3_m * rtb_alpha_o;

      /* UnitDelay: '<S198>/Unit Delay' */
      rtb_Reset = BaseEngineController_LS_DWork.s198_UnitDelay_DSTATE;
       ...
       *  Sum: '<S198>/Sum2'
       */
      BaseEngineController_LS_B.s198_Product = (rtb_DataTypeConversion_m -
      ...
      /* S-Function Block: <S186>/motohawk_interpolation_1d4 */
      {
        ...
        rtb_motohawk_interpolation_1d4_k = TableInterpolation1D_real_T
          (BaseEngineController_LS_B.s402_RPMAccel17Idx, (real_T *)
       ...
       */
      BaseEngineController_LS_B.s186_Sum = BaseEngineController_LS_B.s109_Sum -
       ...
       */
      if (BaseEngineController_LS_B.s187_DataTypeConversion != 0) {
        BaseEngineController_LS_B.s199_Switch1 =
          BaseEngineController_LS_B.s186_Sum;
      } else {
        BaseEngineController_LS_B.s199_Switch1 =
          BaseEngineController_LS_DWork.s199_UnitDelay_DSTATE;
      }
       ...
       */
      if (BaseEngineController_LS_B.s187_DataTypeConversion >= 1) {
         ...
         *  Sum: '<S197>/Sum1'
         */
        rtb_Reset = (BaseEngineController_LS_B.s197_Product2 +
                     BaseEngineController_LS_B.s198_Product) +
          BaseEngineController_LS_B.s199_Switch1;
         ...
         */
        BaseEngineController_LS_B.s190_Switch = (rtb_Reset <=
      ...
      if ((MaxGovDisable_DataStore()) == FALSE) {
        ...
        BaseEngineController_LS_B.s187_MultiportSwitch = (((rtb_Reset < 0.0 ?
          (int8_T)-(int8_T)(uint8_T)-rtb_Reset : (int8_T)(uint8_T)rtb_Reset) !=
          0));
      } else {
        BaseEngineController_LS_B.s187_MultiportSwitch = FALSE;
      }
      ...
      /* S-Function Block: <S199>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_DWork.s199_motohawk_delta_time_DWORK1, NULL);
      ...
      BaseEngineController_LS_DWork.s109_UnitDelay_DSTATE =
        BaseEngineController_LS_B.s187_MultiportSwitch;

      /* Update for UnitDelay: '<S188>/Unit Delay' */
      BaseEngineController_LS_DWork.s188_UnitDelay_DSTATE =
        BaseEngineController_LS_B.s188_DontallowsetpointtoevergoabovetheTargetRPM;

      /* Update for UnitDelay: '<S198>/Unit Delay' */
      BaseEngineController_LS_DWork.s198_UnitDelay_DSTATE =
        rtb_DataTypeConversion_m;
       ...
       */
      BaseEngineController_LS_DWork.s199_UnitDelay_DSTATE = (rtb_Reset <=
    ...
    /* Output and update for function-call system: '<S93>/Spark Manager' */
    {
       ...
       */
      BaseEngineController_LS_B.s277_Add = (rtb_Product_h + rtb_Product1_fs) +
       ...
       */
      BaseEngineController_LS_B.s274_Product = rtb_motohawk_interpolation_1d_k *
      ...
      /* S-Function Block: <S273>/motohawk_prelookup */
      {
        extern uint16_T TablePrelookup_real_T(real_T in, const volatile real_T
          ordarr[], uint32_T sz, uint16_T prev);
        (DesEqRatio09In_DataStore()) = BaseEngineController_LS_B.s147_Product1;
        (DesEqRatio09Idx_DataStore()) = TablePrelookup_real_T
          (BaseEngineController_LS_B.s147_Product1,
       ...
       */
      BaseEngineController_LS_B.s273_Product = rtb_motohawk_interpolation_1d_h *
       ...
       */
      BaseEngineController_LS_B.s112_ApplyOffsetstoBaseSparkAdvance1 =
        ((((rtb_RichEquivRatioTargetDelta + BaseEngineController_LS_B.s277_Add)
           + BaseEngineController_LS_B.s274_Product) +
          BaseEngineController_LS_B.s273_Product) +
         BaseEngineController_LS_B.s110_IdleSpk) +
        BaseEngineController_LS_B.s147_SpkOut;
       ...
       *  MinMax: '<S280>/MinMax'
       */
      BaseEngineController_LS_B.s280_MinMax1 = (rtb_Product_h <= rtb_Product1_fs)
        || rtIsNaN(rtb_Product1_fs) ? rtb_Product_h : rtb_Product1_fs;

      /* UnitDelay: '<S275>/Unit Delay' */
      rtb_Product_h = BaseEngineController_LS_DWork.s275_UnitDelay_DSTATE;

      /* Switch: '<S275>/Switch' incorporates:
       *  UnitDelay: '<S278>/Initial Condition is True'
       */
      if (BaseEngineController_LS_DWork.s278_InitialConditionisTrue_DSTATE) {
        BaseEngineController_LS_B.s275_Switch =
          BaseEngineController_LS_B.s280_MinMax1;
      } else {
         ...
         *  MinMax: '<S279>/MinMax'
         */
        rtb_Product_h = (BaseEngineController_LS_B.s280_MinMax1 >= rtb_Product_h)
          || rtIsNaN(rtb_Product_h) ? BaseEngineController_LS_B.s280_MinMax1 :
          rtb_Product_h;
        BaseEngineController_LS_B.s275_Switch = (rtb_Product_h <=
       ...
       */
      BaseEngineController_LS_DWork.s278_InitialConditionisTrue_DSTATE = FALSE;
