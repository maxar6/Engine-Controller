/*
 * Trigger_FGND_HIRES_17967p0001.c
 *
...
void Trigger_FGND_HIRES_17967p0001(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  {
    /* Output and update for function-call system: '<S333>/Tooth Time' */

    /* S-Function Block: <S334>/motohawk_abs_time */
    {
      ...
      Timer_FreeRunningCounter_GetTime
        (&BaseEngineController_LS_B.s334_motohawk_abs_time, NULL);
    }
  }
}
