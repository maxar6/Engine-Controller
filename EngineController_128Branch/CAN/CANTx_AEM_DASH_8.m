...
%%
  ...
  msg.description             = 'Message 8';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A009');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.offset        = -3276.8;
  
  msg.fields{3}.name          = 'LaunchBootTarget';
  msg.fields{3}.units         = 'kPa';
