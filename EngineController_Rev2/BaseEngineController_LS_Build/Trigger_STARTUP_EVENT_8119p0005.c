/*
 * Trigger_STARTUP_EVENT_8119p0005.c
 *
...
void Trigger_STARTUP_EVENT_8119p0005(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  {
    /* Output and update for function-call system: '<S633>/Once at Startup' */
    {
       ...
       *  S-Function (motohawk_sfun_ain): '<S683>/motohawk_ain'
       */
      BaseEngineController_LS_B.s633_Merge = (real_T)rtb_motohawk_ain;
    }
  }
}
