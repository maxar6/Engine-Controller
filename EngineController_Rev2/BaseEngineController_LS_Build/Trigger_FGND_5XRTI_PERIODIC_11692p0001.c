/*
 * Trigger_FGND_5XRTI_PERIODIC_11692p0001.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_11692p0001(void)
{
  ...
  if (BaseEngineController_LS_DWork.s14_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S14>/Spark Coil Characterization' */
    {
      ...
      /* S-Function Block: <S24>/motohawk_prelookup */
      {
        ...
        (SpkEnergy09In_DataStore()) = BaseEngineController_LS_B.s92_SparkEnergy;
      ...
      /* S-Function Block: <S24>/motohawk_interpolation_2d1 */
      {
        ...
        rtb_motohawk_interpolation_2d1 = TableInterpolation2D_real_T
          (rtb_SpkEnergy09Idx, BaseEngineController_LS_B.s423_motohawk_prelookup,
      ...
      if ((SparkDwell_ovr_DataStore())) {
         ...
         */
        rtb_Merge_d = BaseEngineController_LS_DWork.s87_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_B.s87_Sum = rtb_Merge_d +
      ...
      BaseEngineController_LS_DWork.s87_UnitDelay_DSTATE = rtb_Merge_d;
    }
  }
}
