function msg = CANRx_AEM_GPS_LAT_LONG()
...
%%
  ...
  msg.name                    = 'AEM GPS';
  msg.description             = 'GPS Latitude Longitude';
  msg.protocol                = '';
  msg.module                  = 'GPS';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('A0000');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'GSP_Latitude';
  msg.fields{1}.units         = 'deg';
  ...
  msg.fields{2}.name          = 'GPS_Longitude';
