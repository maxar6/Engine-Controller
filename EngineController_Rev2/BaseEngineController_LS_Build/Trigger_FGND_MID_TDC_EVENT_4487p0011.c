/*
 * Trigger_FGND_MID_TDC_EVENT_4487p0011.c
 *
...
void Trigger_FGND_MID_TDC_EVENT_4487p0011(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s563_motohawk_trigger5_DWORK1) {
    /* Output and update for function-call system: '<S563>/MID_TDC' */
    {
       ...
       */
      BaseEngineController_LS_B.s563_Merge = (real_T)rtb_motohawk_ain_read;
    }
  }
}
