...
static void initialize_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc7_BaseEngineController_LS
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c7_StateO, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_BaseEngineController_LSInstanceStruct
...
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_c_emlrt_marshallIn(SFc7_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_d_emlrt_marshallIn(SFc7_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c7_b_is_active_c7_BaseEngineController_LS, const
  char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn(SFc7_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_BaseEngineController_LS = 0U;
}
  ...
  (SFc7_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c7_e_hoistedGlobal = chartInstance->c7_is_active_c7_BaseEngineController_LS;
   ...
   *c7_st)
{
  ...
  *c7_StateO = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u,
    3)), "StateO");
  chartInstance->c7_is_active_c7_BaseEngineController_LS = c7_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 4)),
     "is_active_c7_BaseEngineController_LS");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_BaseEngineController_LS(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc7_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c7_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_BaseEngineController_LS), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_BaseEngineController_LS);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"ETCMode\",},{M[1],M[10],T\"Hold\",},{M[1],M[9],T\"Reset\",},{M[1],M[11],T\"StateO\",},{M[8],M[0],T\"is_active_c7_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_BaseEngineController_LS
    ((SFc7_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c7_BaseEngineController_LS
    ((SFc7_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c7_BaseEngineController_LS((SFc7_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c7_BaseEngineController_LS((SFc7_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c7_BaseEngineController_LS((SFc7_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_BaseEngineController_LS
    ((SFc7_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c7_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_BaseEngineController_LS
    ((SFc7_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c7_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c7_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_BaseEngineController_LS
      ((SFc7_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_BaseEngineController_LS
    ((SFc7_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_BaseEngineController_LS
      ((SFc7_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",7,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",7,
...
static void mdlRTW_c7_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_BaseEngineController_LS(SimStruct *S)
{
  SFc7_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc7_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc7_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_BaseEngineController_LS;
...
void c7_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_BaseEngineController_LS_method_dispatcher.\n"
