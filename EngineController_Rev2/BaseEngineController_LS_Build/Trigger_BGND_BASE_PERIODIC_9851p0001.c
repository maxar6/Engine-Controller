/*
 * Trigger_BGND_BASE_PERIODIC_9851p0001.c
 *
...
void Trigger_BGND_BASE_PERIODIC_9851p0001(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
...

  {
    /* Output and update for function-call system: '<S3>/Main Power Relay' */
    {
      ...
      /* S-Function Block: DOut9819p0001 */
      {
        DOut9819p0001_DiscreteOutput_Set(rtb_Merge);
      }
