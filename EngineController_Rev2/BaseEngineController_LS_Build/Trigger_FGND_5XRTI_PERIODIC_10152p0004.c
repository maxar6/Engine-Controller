/*
 * Trigger_FGND_5XRTI_PERIODIC_10152p0004.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_10152p0004(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s13_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S13>/Coil Control' */
    {
      ...
      /* Logic: '<S919>/Logical Operator3' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S919>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_b = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S919>/motohawk_fault_action'
       *
       * Regarding '<S919>/motohawk_fault_action':
      ...
      /* S-Function (motohawk_sfun_data_read): '<S919>/motohawk_data_read2' */
      rtb_motohawk_data_read2 = ECUP_Enabled_DataStore();

      /* Logic: '<S919>/Logical Operator4' incorporates:
       *  Constant: '<S923>/Constant'
       *  RelationalOperator: '<S923>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S919>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_p = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S919>/EST Enable TDC Counter' */
      /* UnitDelay: '<S924>/CrankCounter' */
      BaseEngineController_LS_B.s924_CrankCounter =
        BaseEngineController_LS_DWork.s924_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S924>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_9624p0004 */
      if (BaseEngineController_LS_DWork.s924_motohawk_trigger1_DWORK1 == 0) {
        BaseEngineController_LS_DWork.s924_motohawk_trigger1_DWORK1 = 1;
      }

      /* RelationalOperator: '<S924>/Relational Operator1' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S924>/motohawk_calibration1'
       */
      BaseEngineController_LS_B.s924_RelationalOperator1 =
        ((BaseEngineController_LS_B.s926_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S924>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S924>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S924>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S925>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_LS_B.s924_RelationalOperator1 == TRUE)) {
        /* '<S925>:1:3' */
        /* '<S925>:1:4' */
        rtb_StateO_n = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_LS_B.s924_RelationalOperator1 ==
                            TRUE)) {
        /* '<S925>:1:5' */
        /* '<S925>:1:6' */
        rtb_StateO_n = 2.0;
      ...
      /* End of MATLAB Function Block: '<S924>/EST Enable TDC Counter Stateflow' */
      ...
      /* DataTypeConversion: '<S924>/Data Type Conversion' */
      tmp = (int32_T)rtb_ESTEnable;
      tmp_0 = fmod((real_T)tmp, 256.0);
      BaseEngineController_LS_B.s924_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S924>/CrankCounter' */
      BaseEngineController_LS_DWork.s924_CrankCounter_DSTATE = rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S919>/EST Enable TDC Counter' */
       ...
       *  S-Function (motohawk_sfun_calibration): '<S919>/motohawk_calibration5'
       *  S-Function (motohawk_sfun_calibration): '<S919>/motohawk_calibration6'
       *  S-Function (motohawk_sfun_calibration): '<S919>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S919>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S919>/motohawk_calibration9'
       */
      BaseEngineController_LS_B.s862_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
          ...
          (BaseEngineController_LS_B.s924_DataTypeConversion != 0) &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_LS_DWork.s921_UnitDelay_DSTATE;
      ...
      /* Sum: '<S921>/Sum' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S921>/offset'
       */
      BaseEngineController_LS_B.s921_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S862>/Data Type Conversion' incorporates:
       *  Gain: '<S862>/Gain'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s921_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_LS_DWork.s922_UnitDelay_DSTATE;

        /* End of Outputs for SubSystem: '<S922>/NewValue' */
      } else {
        /* Outputs for IfAction SubSystem: '<S922>/OldValue' incorporates:
         *  ActionPort: '<S946>/Action Port'
         */
        rtb_CounterReset = BaseEngineController_LS_B.s135_SparkAdv;

        /* End of Outputs for SubSystem: '<S922>/OldValue' */
      }

      /* End of If: '<S922>/If' */

      /* Sum: '<S922>/Sum' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S922>/offset'
       */
      BaseEngineController_LS_B.s922_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S862>/Data Type Conversion1' incorporates:
       *  Gain: '<S862>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s922_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* RelationalOperator: '<S941>/RelOp' incorporates:
       *  Constant: '<S941>/Constant'
       */
      rtb_RelOp_jk = ((rtb_SparkSequence_o1[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def' */
      ...
      /* RelationalOperator: '<S942>/RelOp' incorporates:
       *  Constant: '<S942>/Constant'
       */
      rtb_RelOp_c = ((rtb_SparkSequence_o1[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def1' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def10' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def11' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def12' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def13' */
      ...
      /* RelationalOperator: '<S933>/RelOp' incorporates:
       *  Constant: '<S933>/Constant'
       */
      rtb_RelOp_b = ((rtb_SparkSequence_o1[6] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def14' */
      ...
      /* RelationalOperator: '<S934>/RelOp' incorporates:
       *  Constant: '<S934>/Constant'
       */
      rtb_RelOp_jc = ((rtb_SparkSequence_o1[7] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def15' */
      ...
      /* RelationalOperator: '<S935>/RelOp' incorporates:
       *  Constant: '<S935>/Constant'
       */
      rtb_RelOp_n = ((rtb_SparkSequence_o2[2] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def2' */
      ...
      /* RelationalOperator: '<S936>/RelOp' incorporates:
       *  Constant: '<S936>/Constant'
       */
      rtb_RelOp_ot = ((rtb_SparkSequence_o2[3] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def3' */
      ...
      /* RelationalOperator: '<S937>/RelOp' incorporates:
       *  Constant: '<S937>/Constant'
       */
      rtb_RelOp_mz = ((rtb_SparkSequence_o2[4] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def4' */
      ...
      /* RelationalOperator: '<S938>/RelOp' incorporates:
       *  Constant: '<S938>/Constant'
       */
      rtb_RelOp_ps = ((rtb_SparkSequence_o2[5] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def5' */
      ...
      /* RelationalOperator: '<S939>/RelOp' incorporates:
       *  Constant: '<S939>/Constant'
       */
      rtb_RelOp_hp = ((rtb_SparkSequence_o2[6] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def6' */
      ...
      /* RelationalOperator: '<S940>/RelOp' incorporates:
       *  Constant: '<S940>/Constant'
       */
      rtb_RelOp_ol = ((rtb_SparkSequence_o2[7] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def7' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def8' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S920>/motohawk_fault_def9' */
      ...
      /* S-Function (motohawk_sfun_data_write): '<S919>/motohawk_data_write' */
      ...
      BaseEngineController_LS_DWork.s921_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S922>/Unit Delay' */
      BaseEngineController_LS_DWork.s922_UnitDelay_DSTATE = rtb_CounterReset;
