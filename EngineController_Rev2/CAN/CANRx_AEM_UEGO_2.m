...
%%
  ...
  msg.name                    = 'AEM X-Series UEGO';
  msg.description             = 'UEGO Num2';
  msg.protocol                = '';
  msg.module                  = 'UEGO';
  msg.channel                 = 1;
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{4}.name          = 'HeaterVolts';
  msg.fields{4}.units         = 'V';
  ...
  msg.fields{6}.name          = 'UsingFreeAreCalState';
  ...
  msg.fields{7}.name          = 'DataValidState';
  msg.fields{7}.units         = 'On/Off';
  msg.fields{7}.start_bit     = 15;
