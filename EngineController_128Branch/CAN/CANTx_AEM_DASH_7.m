...
%%
  ...
  msg.description             = 'Message 7';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A008');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{1}.name          = 'TransTemp';
  msg.fields{1}.units         = 'degC';
  ...
  msg.fields{5}.scale         = 100;
  msg.fields{5}.offset        = 0;
  
  msg.fields{6}.name          = 'ErrorThrottle';
  msg.fields{6}.units         = 'On/Off';
  msg.fields{6}.start_bit     = 0;
  ...
  msg.fields{7}.name          = 'ErrorCoolantTemp';
  msg.fields{7}.units         = 'On/Off';
  msg.fields{7}.start_bit     = 1;
  ...
  msg.fields{8}.name          = 'ErrorFuelPressure';
  msg.fields{8}.units         = 'On/Off';
  msg.fields{8}.start_bit     = 2;
  ...
  msg.fields{9}.name          = 'ErrorOilPressure';
  msg.fields{9}.units         = 'On/Off';
  msg.fields{9}.start_bit     = 3;
  ...
  msg.fields{10}.name          = 'ErrorEBP';
  msg.fields{10}.units         = 'On/Off';
  msg.fields{10}.start_bit     = 4;
  ...
  msg.fields{12}.name          = 'ErrorAirTemp';
