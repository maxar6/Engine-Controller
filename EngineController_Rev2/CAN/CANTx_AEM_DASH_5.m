...
%%
  ...
  msg.description             = 'Message 5';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A006');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{4}.name          = 'ModeSw';
  msg.fields{4}.units         = 'enum';
  ...
  msg.fields{7}.name          = 'EstTorque';
  msg.fields{7}.units         = 'Nm';
  msg.fields{7}.start_bit     = 0;
  msg.fields{7}.bit_length    = 16;
  msg.fields{7}.byte_order    = 'BIG_ENDIAN';
  msg.fields{7}.data_type     = 'UNSIGNED';
  msg.fields{7}.scale         = 0.1;
  msg.fields{7}.offset        = -3276.8;
