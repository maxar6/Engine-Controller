...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s623_motohawk_trigger5_DWORK1) {
    /* Output and update for function-call system: '<S623>/MID_TDC' */
    {
      /* local block i/o variables */
      uint16_T rtb_motohawk_ain_read;

      /* S-Function Block: <S672>/motohawk_ain_read Resource: MAPSensorPin */
      {
       ...
       *  S-Function (motohawk_sfun_ain_read): '<S672>/motohawk_ain_read'
       */
      BaseEngineController_LS_B.s623_Merge = (real_T)rtb_motohawk_ain_read;
    }
  }
}
