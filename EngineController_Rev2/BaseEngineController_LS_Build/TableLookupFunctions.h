...
extern uint8_T TableInterpolation1D_uint8_T(uint16_T idx, uint8_T *tbl_data,
  uint32_T sz);
extern uint16_T TableInterpolation1D_uint16_T(uint16_T idx, uint16_T *tbl_data,
  uint32_T sz);
extern uint16_T TablePrelookup_uint8_T(uint8_T in, const volatile uint8_T
  ordarr[], uint32_T sz, uint16_T prev);
