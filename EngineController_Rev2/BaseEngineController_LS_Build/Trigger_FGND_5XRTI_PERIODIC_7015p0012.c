...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s13_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S13>/Coil Control' */
    {
      ...
      /* Logic: '<S908>/Logical Operator3' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S908>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_b = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S908>/motohawk_fault_action'
       *
       * Regarding '<S908>/motohawk_fault_action':
      ...
      /* S-Function (motohawk_sfun_data_read): '<S908>/motohawk_data_read2' */
      rtb_motohawk_data_read2 = ECUP_Enabled_DataStore();

      /* Logic: '<S908>/Logical Operator4' incorporates:
       *  Constant: '<S912>/Constant'
       *  RelationalOperator: '<S912>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S908>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_p = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S908>/EST Enable TDC Counter' */
      /* UnitDelay: '<S913>/CrankCounter' */
      BaseEngineController_LS_B.s913_CrankCounter =
        BaseEngineController_LS_DWork.s913_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S913>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_6487p001 */
      if (BaseEngineController_LS_DWork.s913_motohawk_trigger1_DWORK1 == 0) {
        BaseEngineController_LS_DWork.s913_motohawk_trigger1_DWORK1 = 1;
      }

      /* RelationalOperator: '<S913>/Relational Operator1' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S913>/motohawk_calibration1'
       */
      BaseEngineController_LS_B.s913_RelationalOperator1 =
        ((BaseEngineController_LS_B.s915_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S913>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S913>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S913>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S914>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_LS_B.s913_RelationalOperator1 == TRUE)) {
        /* '<S914>:1:3' */
        /* '<S914>:1:4' */
        rtb_StateO_n = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_LS_B.s913_RelationalOperator1 ==
                            TRUE)) {
        /* '<S914>:1:5' */
        /* '<S914>:1:6' */
        rtb_StateO_n = 2.0;
      ...
      /* End of MATLAB Function Block: '<S913>/EST Enable TDC Counter Stateflow' */
      ...
      /* DataTypeConversion: '<S913>/Data Type Conversion' */
      tmp = (int32_T)rtb_ESTEnable;
      tmp_0 = fmod((real_T)tmp, 256.0);
      BaseEngineController_LS_B.s913_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S913>/CrankCounter' */
      BaseEngineController_LS_DWork.s913_CrankCounter_DSTATE = rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S908>/EST Enable TDC Counter' */

      /* Logic: '<S851>/Logical Operator1' incorporates:
       *  Logic: '<S908>/Logical Operator2'
       ...
       *  S-Function (motohawk_sfun_calibration): '<S908>/motohawk_calibration5'
       *  S-Function (motohawk_sfun_calibration): '<S908>/motohawk_calibration6'
       *  S-Function (motohawk_sfun_calibration): '<S908>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S908>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S908>/motohawk_calibration9'
       */
      BaseEngineController_LS_B.s851_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
          (SparkEnableCyl1_DataStore()) && rtb_motohawk_data_read2 &&
          rtb_LogicalOperator4_p &&
          (BaseEngineController_LS_B.s913_DataTypeConversion != 0) &&
          BaseEngineController_LS_B.s24_OnlyEnableSparkwhenEnergyisAboveZero &&
          BaseEngineController_LS_B.s22_LogicalOperator2[0]));
      BaseEngineController_LS_B.s851_LogicalOperator1[1] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s851_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s851_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s851_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s851_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s851_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s851_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_LS_DWork.s910_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_B.s910_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S851>/Data Type Conversion' incorporates:
       *  Gain: '<S851>/Gain'
       */
      ...
      /* End of DataTypeConversion: '<S851>/Data Type Conversion' */
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_LS_DWork.s911_UnitDelay_DSTATE;
       ...
       */
      BaseEngineController_LS_B.s911_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S851>/Data Type Conversion1' incorporates:
       *  Gain: '<S851>/Gain1'
       */
      ...
      /* End of DataTypeConversion: '<S851>/Data Type Conversion1' */
      /* DataTypeConversion: '<S851>/Data Type Conversion2' incorporates:
       *  Gain: '<S851>/Gain2'
       *  S-Function (motohawk_sfun_calibration): '<S851>/motohawk_calibration2'
       */
      ...
      /* S-Function Block: <S851>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s851_SparkSequence_o3)[i] =
            SparkSeqDiag_22_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s851_SparkSequence_o4)[i] =
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def1' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def10' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def11' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def12' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def13' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def14' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def15' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def2' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def3' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def4' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def5' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def6' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def7' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def8' */
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S909>/motohawk_fault_def9' */
      ...
      /* S-Function (motohawk_sfun_data_write): '<S908>/motohawk_data_write' */
      ...
      BaseEngineController_LS_DWork.s910_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S911>/Unit Delay' */
      BaseEngineController_LS_DWork.s911_UnitDelay_DSTATE = rtb_CounterReset;

      /* S-Function Block: <S851>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_LS_B.s851_LogicalOperator1)[cyl])
