/*
 * Trigger_FGND_5XRTI_PERIODIC_4582p0011.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_4582p0011(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s485_motohawk_trigger1_DWORK1) {
    /* Output and update for function-call system: '<S485>/Fuel Level' */
    {
      ...
      /* S-Function Block: <S638>/motohawk_ain Resource: FuelLvlSensorPin */
      {
        ...
        FuelLvlSensorPin_AnalogInput_Get
          (&BaseEngineController_LS_B.s638_motohawk_ain, NULL);
      }

      /* DataTypeConversion: '<S640>/Data Type Conversion' */
      rtb_DataTypeConversion_b = (real_T)
        BaseEngineController_LS_B.s638_motohawk_ain;
      ...
      rtb_UnitDelay_f = BaseEngineController_LS_DWork.s640_UnitDelay_DSTATE;
      ...
      if ((!rtb_LogicalOperator4_i) && rtb_LogicalOperator1_a) {
        ...
        BaseEngineController_LS_IfActionSubsystem(rtb_UnitDelay_f,
          &BaseEngineController_LS_B.s640_Merge);
      ...
      rtb_Sum1_e = (1.0 - rtb_Product_lb) *
        BaseEngineController_LS_DWork.s647_UnitDelay_DSTATE +
        BaseEngineController_LS_B.s640_Merge * rtb_Product_lb;
      ...
      if ((Fuel_Lvl_ovr_DataStore())) {
         ...
         */
        BaseEngineController_LS_B.s645_Merge = (Fuel_Lvl_new_DataStore());
         ...
         */
        BaseEngineController_LS_B.s645_Merge = rtb_Sum1_e;
      ...
      BaseEngineController_LS_DWork.s640_UnitDelay_DSTATE =
        BaseEngineController_LS_B.s640_Merge;

      /* Update for UnitDelay: '<S647>/Unit Delay' */
      BaseEngineController_LS_DWork.s647_UnitDelay_DSTATE = rtb_Sum1_e;
    }
  }
}
