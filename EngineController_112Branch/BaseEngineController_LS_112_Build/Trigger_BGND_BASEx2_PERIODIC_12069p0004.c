/*
 * Trigger_BGND_BASEx2_PERIODIC_12069p0004.c
 *
...
void Trigger_BGND_BASEx2_PERIODIC_12069p0004(void)
{
...
#define BaseEngineController_LS_112_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_112_DWork.s5_motohawk_trigger5_DWORK1) {
    BaseEngineController_LS_112_CCPDaqProcessing(5);
  }
}
