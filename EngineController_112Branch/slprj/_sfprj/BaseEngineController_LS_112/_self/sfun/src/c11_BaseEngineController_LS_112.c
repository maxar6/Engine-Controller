...
#include "c11_BaseEngineController_LS_112.h"
...
static void initialize_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void initialize_params_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void enable_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void disable_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void set_sim_state_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance, const mxArray
   *c11_st);
static void finalize_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void sf_c11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
static void initSimStructsc11_BaseEngineController_LS_112
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance);
...
static real_T c11_emlrt_marshallIn
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance, const mxArray
   *c11_StateO, const char_T *c11_identifier);
...
static uint8_T c11_d_emlrt_marshallIn
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance, const mxArray
   *c11_b_is_active_c11_BaseEngineController_LS_112, const char_T
   *c11_identifier);
  ...
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_BaseEngineController_LS_112 = 0U;
}
  ...
  (SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance)
{
  ...
  c11_d_hoistedGlobal =
    chartInstance->c11_is_active_c11_BaseEngineController_LS_112;
   ...
   *c11_st)
{
  ...
  *c11_StateO = c11_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c11_is_active_c11_BaseEngineController_LS_112 =
    ...
    "is_active_c11_BaseEngineController_LS_112");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_BaseEngineController_LS_112(chartInstance);
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance;
  chartInstance = (SFc11_BaseEngineController_LS_112InstanceStruct *)
    chartInstanceVoid;
   ...
   *c11_identifier)
{
  ...
  c11_y = c11_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_BaseEngineController_LS_112), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_BaseEngineController_LS_112);
  return c11_y;
}
...
/* SFunction Glue Code */
void sf_c11_BaseEngineController_LS_112_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c11_BaseEngineController_LS_112_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c11_BaseEngineController_LS_112(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"CounterReset\",},{M[1],M[8],T\"ESTEnable\",},{M[1],M[9],T\"StateO\",},{M[8],M[0],T\"is_active_c11_BaseEngineController_LS_112\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_BaseEngineController_LS_112_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c11_BaseEngineController_LS_112(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_BaseEngineController_LS_112InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
  initialize_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c11_BaseEngineController_LS_112(void
  *chartInstanceVar)
{
  enable_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_BaseEngineController_LS_112(void
  *chartInstanceVar)
{
  disable_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_BaseEngineController_LS_112(void
  *chartInstanceVar)
{
  sf_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c11_BaseEngineController_LS_112
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_BaseEngineController_LS_112();/* state var info */
...
extern void sf_internal_set_sim_state_c11_BaseEngineController_LS_112(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c11_BaseEngineController_LS_112
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c11_BaseEngineController_LS_112(S);
}

static void sf_opaque_set_sim_state_c11_BaseEngineController_LS_112(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c11_BaseEngineController_LS_112(S, st);
}

static void sf_opaque_terminate_c11_BaseEngineController_LS_112(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_BaseEngineController_LS_112InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c11_BaseEngineController_LS_112
      ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc11_BaseEngineController_LS_112
    ((SFc11_BaseEngineController_LS_112InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_BaseEngineController_LS_112(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c11_BaseEngineController_LS_112
      ((SFc11_BaseEngineController_LS_112InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c11_BaseEngineController_LS_112(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS_112",
      "BaseEngineController_LS_112",11);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS_112",
                "BaseEngineController_LS_112",11,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS_112","BaseEngineController_LS_112",11,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"BaseEngineController_LS_112",
        "BaseEngineController_LS_112",11,3);
...
static void mdlRTW_c11_BaseEngineController_LS_112(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_BaseEngineController_LS_112(SimStruct *S)
{
  SFc11_BaseEngineController_LS_112InstanceStruct *chartInstance;
  chartInstance = (SFc11_BaseEngineController_LS_112InstanceStruct *)malloc
    (sizeof(SFc11_BaseEngineController_LS_112InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_BaseEngineController_LS_112;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c11_BaseEngineController_LS_112;
...
void c11_BaseEngineController_LS_112_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_BaseEngineController_LS_112(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_BaseEngineController_LS_112(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_BaseEngineController_LS_112(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_BaseEngineController_LS_112_method_dispatcher.\n"
