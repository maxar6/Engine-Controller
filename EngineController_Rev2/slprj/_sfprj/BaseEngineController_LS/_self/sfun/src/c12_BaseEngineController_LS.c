...
static void initialize_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c12_st);
static void c12_set_sim_state_side_effects_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void finalize_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc12_BaseEngineController_LS
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_emlrt_marshallIn(SFc12_BaseEngineController_LSInstanceStruct *
...
static const mxArray *c12_e_emlrt_marshallIn
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_BaseEngineController_LS = 0U;
  chartInstance->c12_is_c12_BaseEngineController_LS = 0U;
  ...
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c12_b_hoistedGlobal = chartInstance->c12_is_active_c12_BaseEngineController_LS;
  c12_b_u = c12_b_hoistedGlobal;
  c12_c_y = NULL;
  sf_mex_assign(&c12_c_y, sf_mex_create("y", &c12_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c12_y, 1, c12_c_y);
  c12_c_hoistedGlobal = chartInstance->c12_is_c12_BaseEngineController_LS;
   ...
   *c12_st)
{
  ...
  *c12_IdleState = c12_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c12_is_active_c12_BaseEngineController_LS =
    c12_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
    "is_active_c12_BaseEngineController_LS");
  chartInstance->c12_is_c12_BaseEngineController_LS = c12_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 2)),
     "is_c12_BaseEngineController_LS");
  ...
  c12_update_debugger_state_c12_BaseEngineController_LS(chartInstance);
  ...
  (SFc12_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c12_set_sim_state_side_effects_c12_BaseEngineController_LS(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if ((int16_T)chartInstance->c12_is_active_c12_BaseEngineController_LS == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 6U, chartInstance->c12_sfEvent);
    chartInstance->c12_is_active_c12_BaseEngineController_LS = 1U;
    ...
    chartInstance->c12_is_c12_BaseEngineController_LS = c12_IN_Flaring;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c12_sfEvent);
    chartInstance->c12_tp_Flaring = 1U;
    *c12_IdleState = 1U;
    _SFD_DATA_RANGE_CHECK((real_T)*c12_IdleState, 6U);
  } else {
    switch (chartInstance->c12_is_c12_BaseEngineController_LS) {
     case c12_IN_Flaring:
      CV_CHART_EVAL(6, 0, 1);
      ...
      if (CV_TRANSITION_EVAL(1U, (int32_T)c12_temp)) {
        ...
        chartInstance->c12_tp_Flaring = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c12_sfEvent);
        chartInstance->c12_is_c12_BaseEngineController_LS = c12_IN_OffIdle;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c12_sfEvent);
        chartInstance->c12_tp_OffIdle = 1U;
        *c12_IdleState = 3U;
        _SFD_DATA_RANGE_CHECK((real_T)*c12_IdleState, 6U);
        ...
        if (CV_TRANSITION_EVAL(3U, (int32_T)c12_b_temp)) {
          ...
          chartInstance->c12_tp_Flaring = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c12_sfEvent);
          chartInstance->c12_is_c12_BaseEngineController_LS = c12_IN_OnIdle;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c12_sfEvent);
          chartInstance->c12_tp_OnIdle = 1U;
          *c12_IdleState = 2U;
          _SFD_DATA_RANGE_CHECK((real_T)*c12_IdleState, 6U);
     ...
     default:
      CV_CHART_EVAL(6, 0, 0);
      chartInstance->c12_is_c12_BaseEngineController_LS = (uint8_T)
...
const mxArray *sf_c12_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc12_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c12_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[15],T\"IdleState\",},{M[8],M[0],T\"is_active_c12_BaseEngineController_LS\",},{M[9],M[0],T\"is_c12_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c12_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c12_BaseEngineController_LS((SFc12_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c12_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c12_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c12_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c12_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c12_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c12_BaseEngineController_LS
      ((SFc12_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_BaseEngineController_LS
    ((SFc12_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_BaseEngineController_LS(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_BaseEngineController_LS
      ((SFc12_BaseEngineController_LSInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS",
      "BaseEngineController_LS",12);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS",
                "BaseEngineController_LS",12,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS","BaseEngineController_LS",12,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"BaseEngineController_LS",
        "BaseEngineController_LS",12,7);
      sf_mark_chart_reusable_outputs(S,"BaseEngineController_LS",
        "BaseEngineController_LS",12,1);
    }
...
static void mdlRTW_c12_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_BaseEngineController_LS(SimStruct *S)
{
  SFc12_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc12_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc12_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_BaseEngineController_LS;
...
void c12_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_BaseEngineController_LS_method_dispatcher.\n"
