...
%%
  ...
  msg.description             = 'Message 4';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A005');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{4}.scale         = 0.344738;
  msg.fields{4}.offset        = 0;
  
  msg.fields{5}.name          = 'BrakeSw';
  ...
  msg.fields{6}.name          = 'ClutchSw';
  msg.fields{6}.units         = 'On/Off';
  msg.fields{6}.start_bit     = 1;
  ...
  msg.fields{7}.name          = 'ShiftSw';
  msg.fields{7}.units         = 'On/Off';
  msg.fields{7}.start_bit     = 2;
  ...
  msg.fields{8}.name          = 'StagedSw';
  msg.fields{8}.units         = 'On/Off';
  msg.fields{8}.start_bit     = 3;
