/*
 * Trigger_ONE_SECOND_EVENT_12071p0004.c
 *
...
void Trigger_ONE_SECOND_EVENT_12071p0004(void)
{
...
#define BaseEngineController_LS_128_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_128_DWork.s5_motohawk_trigger7_DWORK1) {
    BaseEngineController_LS_128_CCPDaqProcessing(7);
  }
}
