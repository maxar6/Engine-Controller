  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_1_0_51;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_1_0_51 = 0;
    else
      can_tx_err_CAN_1_0_51 = (uint8_T) GetErrorCode(sErrorResult);
  }
  ...
  uint8_T data[])
{
  ...
  {
    extern uint8_T can_tx_err_CAN_2_0_52;
    if (SUCCESS(sErrorResult))
      can_tx_err_CAN_2_0_52 = 0;
    else
      can_tx_err_CAN_2_0_52 = (uint8_T) GetErrorCode(sErrorResult);
  }
