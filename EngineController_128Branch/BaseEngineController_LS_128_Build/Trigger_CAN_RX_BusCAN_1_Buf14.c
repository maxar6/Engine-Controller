...
MHCAN_directslot MHCAN_directslot_RxSlot_9123p0002 = { 0 };

static boolean_T MHCAN_handler_RxSlot_9123p0002(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x00000180) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_9123p0002.ready;
      MHCAN_directslot_RxSlot_9123p0002.message = *messageObj;
      MHCAN_directslot_RxSlot_9123p0002.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_9124p0001 = { 0 };

static boolean_T MHCAN_handler_RxSlot_9124p0001(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x00000181) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_9124p0001.ready;
      MHCAN_directslot_RxSlot_9124p0001.message = *messageObj;
      MHCAN_directslot_RxSlot_9124p0001.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_9015p0001 = { 0 };

static boolean_T MHCAN_handler_RxSlot_9015p0001(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x000A0001) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_9015p0001.ready;
      MHCAN_directslot_RxSlot_9015p0001.message = *messageObj;
      MHCAN_directslot_RxSlot_9015p0001.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_9013p0001 = { 0 };

static boolean_T MHCAN_handler_RxSlot_9013p0001(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x000A0002) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_9013p0001.ready;
      MHCAN_directslot_RxSlot_9013p0001.message = *messageObj;
      MHCAN_directslot_RxSlot_9013p0001.ready = 1;
    }
...
MHCAN_directslot MHCAN_directslot_RxSlot_9014p0001 = { 0 };

static boolean_T MHCAN_handler_RxSlot_9014p0001(S_CANMessage *messageObj)
{
  if ((messageObj->u4MessageID & 0x1FFFFFFF) == 0x000A0000) {
    ...
    {
      boolean_T new_message;
      new_message = !MHCAN_directslot_RxSlot_9014p0001.ready;
      MHCAN_directslot_RxSlot_9014p0001.message = *messageObj;
      MHCAN_directslot_RxSlot_9014p0001.ready = 1;
    }
...
static const MHCAN_id_dispatcher_T MHCAN_consumers_0x1FFFFFFF[] = {
  ...
  { 0x00000180, MHCAN_handler_RxSlot_9123p0002 },

  { 0x00000181, MHCAN_handler_RxSlot_9124p0001 },

  { 0x000a0001, MHCAN_handler_RxSlot_9015p0001 },

  { 0x000a0002, MHCAN_handler_RxSlot_9013p0001 },

  { 0x000a0000, MHCAN_handler_RxSlot_9014p0001 },
};
