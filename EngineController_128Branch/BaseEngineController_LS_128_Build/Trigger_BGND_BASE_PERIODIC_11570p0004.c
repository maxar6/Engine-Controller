    ...
    /* Output and update for function-call system: '<S3>/Main Power Relay' */
    {
      ...
      /* S-Function Block: <S949>/motohawk_delta_time */
      {
        ...
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_128_DWork.s949_motohawk_delta_time_DWORK1,
           NULL);
       ...
       */
      BaseEngineController_LS_128_B.s932_RelationalOperator =
       ...
       *  Sum: '<S949>/Sum'
       */
      if (!BaseEngineController_LS_128_B.s932_RelationalOperator) {
        BaseEngineController_LS_128_B.s949_Switch = rtb_motohawk_delta_time +
       ...
       */
      rtb_LogicalOperator5 = !(BaseEngineController_LS_128_B.s949_Switch >=
      ...
      rtb_UnitDelay8 = BaseEngineController_LS_128_DWork.s937_UnitDelay8_DSTATE;

      /* Outputs for Triggered SubSystem: '<S937>/Processor Reboot' incorporates:
       *  TriggerPort: '<S946>/Trigger'
       */
      if ((!BaseEngineController_LS_128_DWork.s937_UnitDelay8_DSTATE) &&
      ...
      rtb_UnitDelay6 = BaseEngineController_LS_128_DWork.s937_UnitDelay6_DSTATE;

      /* Outputs for Triggered SubSystem: '<S937>/Save NV Vars one tick before MPRD off' incorporates:
       *  TriggerPort: '<S947>/Trigger'
       */
      if ((!BaseEngineController_LS_128_DWork.s937_UnitDelay6_DSTATE) &&
      ...
      rtb_UnitDelay7 = BaseEngineController_LS_128_DWork.s937_UnitDelay7_DSTATE;

      /* Outputs for Triggered SubSystem: '<S937>/Shutdown power on ECU565//563' incorporates:
       *  TriggerPort: '<S948>/Trigger'
       */
      if ((!BaseEngineController_LS_128_DWork.s937_UnitDelay7_DSTATE) &&
      ...
      rtb_Saturation = BaseEngineController_LS_128_B.s949_Switch >= 16000.0 ?
        16000.0 : BaseEngineController_LS_128_B.s949_Switch <= 0.0 ? 0.0 :
        BaseEngineController_LS_128_B.s949_Switch;
      ...
      rtb_LogicalOperator = ((!(ProcessorReboot_DataStore())) &&
        BaseEngineController_LS_128_DWork.s933_UnitDelay_DSTATE);
      ...
      /* S-Function Block: <S940>/motohawk_delta_time */
      {
        ...
        extern uint32_T Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (uint32_T * pReference_lower32Bits, uint32_T *pReference_upper32Bits);
        delta = Timer_FreeRunningCounter_GetDeltaUpdateReference_us
          (&BaseEngineController_LS_128_DWork.s940_motohawk_delta_time_DWORK1,
           NULL);
      ...
      if (rtb_LogicalOperator2_n) {
        rtb_Switch_n = rtb_motohawk_delta_time_f + TimeSinceShutdown_DataStore();
      } else {
        rtb_Switch_n = 0.0;
      }
       ...
       */
      rtb_UnitDelay8 = (rtb_Switch_n >= (Shutdown_Delay_DataStore()));

      /* Logic: '<S932>/Logical Operator2' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S932>/motohawk_data_read'
       */
      BaseEngineController_LS_128_B.s932_LogicalOperator2 = ((rtb_UnitDelay8 &&
        rtb_LogicalOperator2_n && ShutDownTasksComplete_DataStore()));
      ...
      {
       case BaseEngineController_LS_128_IN_PowerDown:
        /* During 'PowerDown': '<S936>:1' */
        if (BaseEngineController_LS_128_B.s932_RelationalOperator) {
          /* Transition: '<S936>:5' */
          BaseEngineController_LS_128_DWork.s936_is_c8_BaseEngineController_LS_128
            = BaseEngineController_LS_128_IN_PowerUp;

          /* Entry 'PowerUp': '<S936>:2' */
          BaseEngineController_LS_128_B.s936_MPRDState = TRUE;
        }
        break;

       case BaseEngineController_LS_128_IN_PowerUp:
        /* During 'PowerUp': '<S936>:2' */
        if ((!BaseEngineController_LS_128_B.s932_RelationalOperator) &&
            BaseEngineController_LS_128_B.s932_LogicalOperator2) {
          /* Transition: '<S936>:4' */
          BaseEngineController_LS_128_DWork.s936_is_c8_BaseEngineController_LS_128
       ...
       */
      if (BaseEngineController_LS_128_B.s936_MPRDState) {
        rtb_Switch = (real_T)BaseEngineController_LS_128_B.s936_MPRDState +
          BaseEngineController_LS_128_DWork.s938_UnitDelay_DSTATE;
      } else {
        rtb_Switch = 0.0;
      }
       ...
       */
      rtb_LogicalOperator2_n = (BaseEngineController_LS_128_B.s936_MPRDState &&
                                (rtb_Switch >= 2.0));

      /* Logic: '<S938>/Logical Operator' */
      rtb_UnitDelay8 = !BaseEngineController_LS_128_B.s936_MPRDState;
      ...
      if (rtb_UnitDelay8) {
        rtb_Switch1 = 1.0 +
          BaseEngineController_LS_128_DWork.s938_UnitDelay1_DSTATE;
      } else {
        rtb_Switch1 = 0.0;
      }
      ...
      /* Memory: '<S953>/Memory' */
      rtb_Memory = BaseEngineController_LS_128_DWork.s953_Memory_PreviousInput;
      ...
      /* CombinatorialLogic: '<S953>/Logic' */
      {
        ...
        rtb_Logic[0] = BaseEngineController_LS_128_ConstP.pooled889[rowidx];
        rtb_Logic[1] = BaseEngineController_LS_128_ConstP.pooled889[rowidx + 8];
      }

      /* Logic: '<S932>/Logical Operator' incorporates:
       *  Logic: '<S932>/Logical Operator1'
       */
      rtb_LogicalOperator_d = ((!rtb_LogicalOperator) && rtb_Logic[0]);

      /* UnitDelay: '<S939>/Unit Delay2' */
      rtb_UnitDelay8 = BaseEngineController_LS_128_DWork.s939_UnitDelay2_DSTATE;

      /* Logic: '<S939>/Logical Operator2' incorporates:
       *  UnitDelay: '<S939>/Unit Delay2'
       */
      rtb_LogicalOperator2 = (rtb_LogicalOperator_d ||
        BaseEngineController_LS_128_DWork.s939_UnitDelay2_DSTATE);
      ...
      BaseEngineController_LS_128_PrevZCSigState.PostShutdowntwoticksbeforeMPRDoff_Trig_ZCE
        = (uint8_T)(rtb_LogicalOperator_d ? (int32_T)POS_ZCSIG : (int32_T)
                    ZERO_ZCSIG);
      ...
      if (BaseEngineController_LS_128_DWork.s932_UnitDelay5_DSTATE) {
        /* Outputs for Enabled and Triggered SubSystem: '<S939>/Processor Reboot' incorporates:
         *  EnablePort: '<S955>/Enable'
         *  TriggerPort: '<S955>/Trigger'
         */
      ...
      rtb_UnitDelay8 = BaseEngineController_LS_128_DWork.s939_UnitDelay_DSTATE;

      /* Outputs for Triggered SubSystem: '<S939>/Save NV Vars one tick before MPRD off' incorporates:
       *  TriggerPort: '<S956>/Trigger'
       */
      if ((!BaseEngineController_LS_128_DWork.s939_UnitDelay_DSTATE) &&
      ...
      rtb_LogicalOperator2 =
        BaseEngineController_LS_128_DWork.s939_UnitDelay1_DSTATE;

      /* Outputs for Triggered SubSystem: '<S939>/Shutdown power on ECU565//563' incorporates:
       *  TriggerPort: '<S957>/Trigger'
       */
      if ((!BaseEngineController_LS_128_DWork.s939_UnitDelay1_DSTATE) &&
      ...
      rtb_Saturation_p = rtb_Switch_n >= 16000.0 ? 16000.0 : rtb_Switch_n <= 0.0
        ? 0.0 : rtb_Switch_n;

      /* S-Function (motohawk_sfun_data_write): '<S940>/motohawk_data_write' */
      /* Write to Data Storage as scalar: TimeSinceShutdown */
      {
        TimeSinceShutdown_DataStore() = rtb_Saturation_p;
      }

      /* UnitDelay: '<S932>/Unit Delay3' */
      rtb_UnitDelay3 = BaseEngineController_LS_128_DWork.s932_UnitDelay3_DSTATE;

      /* UnitDelay: '<S932>/Unit Delay4' */
      rtb_UnitDelay4 = BaseEngineController_LS_128_DWork.s932_UnitDelay4_DSTATE;
      ...
      if ((!(RestoreNVFactoryDefaults_DataStore())) &&
          (BaseEngineController_LS_128_PrevZCSigState.Clear_Trig_ZCE_o !=
           ZERO_ZCSIG)) {
      ...
      BaseEngineController_LS_128_PrevZCSigState.Clear_Trig_ZCE_o = (uint8_T)
      ...
      if ((!(StoreNV_DataStore())) &&
          (BaseEngineController_LS_128_PrevZCSigState.Clear_Trig_ZCE !=
           ZERO_ZCSIG)) {
      ...
      BaseEngineController_LS_128_PrevZCSigState.Clear_Trig_ZCE = (uint8_T)
      ...
      BaseEngineController_LS_128_DWork.s937_UnitDelay8_DSTATE = rtb_UnitDelay7;

      /* Update for UnitDelay: '<S937>/Unit Delay6' */
      BaseEngineController_LS_128_DWork.s937_UnitDelay6_DSTATE =
        rtb_LogicalOperator5;

      /* Update for UnitDelay: '<S937>/Unit Delay7' */
      BaseEngineController_LS_128_DWork.s937_UnitDelay7_DSTATE = rtb_UnitDelay6;
      ...
      BaseEngineController_LS_128_DWork.s938_UnitDelay_DSTATE = rtb_Switch;

      /* Update for UnitDelay: '<S938>/Unit Delay1' */
      BaseEngineController_LS_128_DWork.s938_UnitDelay1_DSTATE = rtb_Switch1;

      /* Update for Memory: '<S953>/Memory' */
      BaseEngineController_LS_128_DWork.s953_Memory_PreviousInput = rtb_Logic[0];
      ...
      BaseEngineController_LS_128_DWork.s932_UnitDelay5_DSTATE = rtb_UnitDelay4;

      /* Update for UnitDelay: '<S939>/Unit Delay' */
      BaseEngineController_LS_128_DWork.s939_UnitDelay_DSTATE =
        rtb_LogicalOperator_d;

      /* Update for UnitDelay: '<S939>/Unit Delay1' */
      BaseEngineController_LS_128_DWork.s939_UnitDelay1_DSTATE = rtb_UnitDelay8;

      /* Update for UnitDelay: '<S932>/Unit Delay3' */
      BaseEngineController_LS_128_DWork.s932_UnitDelay3_DSTATE =
        rtb_LogicalOperator;

      /* Update for UnitDelay: '<S932>/Unit Delay4' */
      BaseEngineController_LS_128_DWork.s932_UnitDelay4_DSTATE = rtb_UnitDelay3;
    }
  }
}
