function msg = CANRx_AEM_DASH_Boost()
...
%%
  ...
  msg.description             = 'Message Boost';
  msg.protocol                = '';
  msg.module                  = 'DASH';
  msg.channel                 = 1;

  msg.idext                   = 'EXTENDED';
  msg.id                      = hex2dec('1F0A00B');
...
%   msg.idcontent{1}.bit_length = 4;
  ...
  msg.fields{2}.name          = 'ChargeOutPress';
  msg.fields{2}.units         = 'kPa';
  ...
  msg.fields{3}.name          = 'BoostControl';
  msg.fields{3}.units         = '%';
  ...
  msg.fields{5}.name          = 'ChargeOutTemp';
  msg.fields{5}.units         = 'degC';
