...
static void initialize_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void initialize_params_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void enable_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void disable_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void set_sim_state_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance, const mxArray *
   c8_st);
static void c8_set_sim_state_side_effects_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void finalize_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void sf_c8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
static void initSimStructsc8_BaseEngineController_LS_128
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance);
...
static const mxArray *c8_g_emlrt_marshallIn
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance, const mxArray *
   c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_BaseEngineController_LS_128InstanceStruct
  *chartInstance);
  ...
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_BaseEngineController_LS_128 = 0U;
  chartInstance->c8_is_c8_BaseEngineController_LS_128 = 0U;
  if (!(cdrGetOutputPortReusable(chartInstance->S, 1) != 0)) {
    *c8_MPRDState = FALSE;
  }

  _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  chartInstance->c8_is_active_c8_BaseEngineController_LS_128 = 1U;
  ...
  chartInstance->c8_is_c8_BaseEngineController_LS_128 = c8_IN_PowerDown;
  ...
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c8_is_active_c8_BaseEngineController_LS_128 == 1)
  {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 3U, chartInstance->c8_sfEvent);
  }

  if (chartInstance->c8_is_c8_BaseEngineController_LS_128 == c8_IN_PowerDown) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
  }

  if (chartInstance->c8_is_c8_BaseEngineController_LS_128 == c8_IN_PowerUp) {
  ...
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal =
    chartInstance->c8_is_active_c8_BaseEngineController_LS_128;
  c8_b_u = c8_b_hoistedGlobal;
  c8_c_y = NULL;
  sf_mex_assign(&c8_c_y, sf_mex_create("y", &c8_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c8_y, 1, c8_c_y);
  c8_c_hoistedGlobal = chartInstance->c8_is_c8_BaseEngineController_LS_128;
   ...
   c8_st)
{
  ...
  *c8_MPRDState = c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c8_is_active_c8_BaseEngineController_LS_128 =
    ...
    "is_active_c8_BaseEngineController_LS_128");
  chartInstance->c8_is_c8_BaseEngineController_LS_128 = c8_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
     "is_c8_BaseEngineController_LS_128");
  ...
  c8_update_debugger_state_c8_BaseEngineController_LS_128(chartInstance);
  ...
  (SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance)
{
  ...
  c8_set_sim_state_side_effects_c8_BaseEngineController_LS_128(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  switch (chartInstance->c8_is_c8_BaseEngineController_LS_128) {
   case c8_IN_PowerDown:
    ...
    if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0, *c8_ECUP != 0U,
      ...
      chartInstance->c8_tp_PowerDown = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
      chartInstance->c8_is_c8_BaseEngineController_LS_128 = c8_IN_PowerUp;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_PowerUp = 1U;
      *c8_MPRDState = TRUE;
      _SFD_DATA_RANGE_CHECK((real_T)*c8_MPRDState, 2U);
   ...
   default:
    CV_CHART_EVAL(3, 0, 0);
    chartInstance->c8_is_c8_BaseEngineController_LS_128 = (uint8_T)
...
const mxArray *sf_c8_BaseEngineController_LS_128_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance;
  chartInstance = (SFc8_BaseEngineController_LS_128InstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c8_BaseEngineController_LS_128_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_BaseEngineController_LS_128_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_BaseEngineController_LS_128(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"MPRDState\",},{M[8],M[0],T\"is_active_c8_BaseEngineController_LS_128\",},{M[9],M[0],T\"is_c8_BaseEngineController_LS_128\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_BaseEngineController_LS_128_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_BaseEngineController_LS_128InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
  initialize_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  enable_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  disable_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  sf_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_BaseEngineController_LS_128
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_BaseEngineController_LS_128();/* state var info */
...
extern void sf_internal_set_sim_state_c8_BaseEngineController_LS_128(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_BaseEngineController_LS_128
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_BaseEngineController_LS_128(S);
}

static void sf_opaque_set_sim_state_c8_BaseEngineController_LS_128(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_BaseEngineController_LS_128(S, st);
}

static void sf_opaque_terminate_c8_BaseEngineController_LS_128(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_BaseEngineController_LS_128InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_BaseEngineController_LS_128
      ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_BaseEngineController_LS_128
    ((SFc8_BaseEngineController_LS_128InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_BaseEngineController_LS_128(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_BaseEngineController_LS_128
      ((SFc8_BaseEngineController_LS_128InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_BaseEngineController_LS_128(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"BaseEngineController_LS_128",
      "BaseEngineController_LS_128",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"BaseEngineController_LS_128",
                "BaseEngineController_LS_128",8,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "BaseEngineController_LS_128","BaseEngineController_LS_128",8,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"BaseEngineController_LS_128",
        "BaseEngineController_LS_128",8,2);
      sf_mark_chart_reusable_outputs(S,"BaseEngineController_LS_128",
        "BaseEngineController_LS_128",8,1);
    }
...
static void mdlRTW_c8_BaseEngineController_LS_128(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_BaseEngineController_LS_128(SimStruct *S)
{
  SFc8_BaseEngineController_LS_128InstanceStruct *chartInstance;
  chartInstance = (SFc8_BaseEngineController_LS_128InstanceStruct *)malloc
    (sizeof(SFc8_BaseEngineController_LS_128InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_BaseEngineController_LS_128InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_BaseEngineController_LS_128;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_BaseEngineController_LS_128;
...
void c8_BaseEngineController_LS_128_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_BaseEngineController_LS_128(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_BaseEngineController_LS_128(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_BaseEngineController_LS_128(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_BaseEngineController_LS_128_method_dispatcher.\n"
