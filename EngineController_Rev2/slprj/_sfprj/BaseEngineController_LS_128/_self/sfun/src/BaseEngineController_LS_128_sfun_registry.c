...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_BaseEngineController_LS_128_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_BaseEngineController_LS_128_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_BaseEngineController_LS_128_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "BaseEngineController_LS_128") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_BaseEngineController_LS_128_autoinheritance_info(nlhs,plhs,2,
      newRhs);
  }
...
{
  extern unsigned int
    sf_BaseEngineController_LS_128_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "BaseEngineController_LS_128") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_BaseEngineController_LS_128_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_BaseEngineController_LS_128_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"BaseEngineController_LS_128")) {
    return(sf_BaseEngineController_LS_128_method_dispatcher(simstructPtr,
...
extern void BaseEngineController_LS_128_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    BaseEngineController_LS_128_terminator();
    sf_debug_terminate();
  }
...
extern void BaseEngineController_LS_128_initializer(void);
extern void BaseEngineController_LS_128_register_exported_symbols(SimStruct* S);
extern void BaseEngineController_LS_128_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  BaseEngineController_LS_128_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      BaseEngineController_LS_128_debug_initialize();
    }

    BaseEngineController_LS_128_initializer();
  }
