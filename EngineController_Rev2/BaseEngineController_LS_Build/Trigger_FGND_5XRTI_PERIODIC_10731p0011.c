/*
 * Trigger_FGND_5XRTI_PERIODIC_10731p0011.c
 *
...
void Trigger_FGND_5XRTI_PERIODIC_10731p0011(void)
{
...
#define BaseEngineController_LS_IN_PowerUp (2U)
  ...
  if (BaseEngineController_LS_DWork.s13_motohawk_trigger_DWORK1) {
    /* Output and update for function-call system: '<S13>/Coil Control' */
    {
      ...
      /* Logic: '<S794>/Logical Operator3' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S794>/motohawk_data_read1'
       */
      rtb_LogicalOperator3_b = !DelayedEngineShutdownAction_DataStore();

      /* S-Function (motohawk_sfun_fault_action): '<S794>/motohawk_fault_action'
       *
       * Regarding '<S794>/motohawk_fault_action':
         Get Fault Action Status: EngineShutdown
       */
      {
        extern boolean_T GetFaultActionStatus(uint32_T action);
        rtb_motohawk_fault_action_b = GetFaultActionStatus(9);
      }

      /* Logic: '<S794>/Logical Operator1' */
      rtb_LogicalOperator1_lu = !rtb_motohawk_fault_action_b;

      /* S-Function (motohawk_sfun_data_read): '<S794>/motohawk_data_read2' */
      rtb_motohawk_data_read2_f = ECUP_Enabled_DataStore();

      /* Logic: '<S794>/Logical Operator4' incorporates:
       *  Constant: '<S798>/Constant'
       *  RelationalOperator: '<S798>/RelOp'
       *  S-Function (motohawk_sfun_data_read): '<S794>/motohawk_data_read3'
       */
      rtb_LogicalOperator4_p = !(((uint8_T)EngineState_DataStore()) == 1);

      /* Outputs for Atomic SubSystem: '<S794>/EST Enable TDC Counter' */
      /* UnitDelay: '<S799>/CrankCounter' */
      BaseEngineController_LS_B.s799_CrankCounter =
        BaseEngineController_LS_DWork.s799_CrankCounter_DSTATE;

      /* S-Function (motohawk_sfun_trigger): '<S799>/motohawk_trigger1' */
      /* Enable for Trigger_FGND_TDC_EVENT_10217p0009 */
      if (BaseEngineController_LS_DWork.s799_motohawk_trigger1_DWORK1 == 0) {
       ...
       */
      BaseEngineController_LS_B.s799_RelationalOperator1 =
        ((BaseEngineController_LS_B.s801_Switch1 >= ((uint8_T)
           (SparkEnableTDCCounts_DataStore()))));

      /* MATLAB Function Block: '<S799>/EST Enable TDC Counter Stateflow' incorporates:
       *  S-Function (motohawk_sfun_data_read): '<S799>/motohawk_data_read'
       *  S-Function (motohawk_sfun_data_read): '<S799>/motohawk_data_read3'
       */

      /* MATLAB Function 'Foreground/Outputs/Coil Control/Coil Enable Manager/EST Enable TDC Counter/EST Enable TDC Counter Stateflow': '<S800>:1' */
      if ((TDC_DataStore() == 0.0) &&
          (BaseEngineController_LS_B.s799_RelationalOperator1 == TRUE)) {
        /* '<S800>:1:3' */
        /* '<S800>:1:4' */
        rtb_StateO_n = 1.0;
      } else if ((TDC_DataStore() == 1.0) && (((uint8_T)EngineState_DataStore())
                  == 2) && (BaseEngineController_LS_B.s799_RelationalOperator1 ==
                            TRUE)) {
        /* '<S800>:1:5' */
        /* '<S800>:1:6' */
        rtb_StateO_n = 2.0;
      ...
      /* End of MATLAB Function Block: '<S799>/EST Enable TDC Counter Stateflow' */

      /* S-Function (motohawk_sfun_data_write): '<S799>/motohawk_data_write' */
      ...
      BaseEngineController_LS_B.s799_DataTypeConversion = (int8_T)(tmp_0 < 0.0 ?
        (int8_T)-(int8_T)(uint8_T)-tmp_0 : (int8_T)(uint8_T)tmp_0);

      /* Update for UnitDelay: '<S799>/CrankCounter' */
      BaseEngineController_LS_DWork.s799_CrankCounter_DSTATE = rtb_CounterReset;

      /* End of Outputs for SubSystem: '<S794>/EST Enable TDC Counter' */

      /* Logic: '<S739>/Logical Operator1' incorporates:
       *  Logic: '<S794>/Logical Operator2'
       ...
       *  S-Function (motohawk_sfun_calibration): '<S794>/motohawk_calibration7'
       *  S-Function (motohawk_sfun_calibration): '<S794>/motohawk_calibration8'
       *  S-Function (motohawk_sfun_calibration): '<S794>/motohawk_calibration9'
       */
      BaseEngineController_LS_B.s739_LogicalOperator1[0] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
          (SparkEnableCyl1_DataStore()) && rtb_motohawk_data_read2_f &&
          rtb_LogicalOperator4_p &&
          (BaseEngineController_LS_B.s799_DataTypeConversion != 0) &&
          BaseEngineController_LS_B.s24_OnlyEnableSparkwhenEnergyisAboveZero &&
          BaseEngineController_LS_B.s22_LogicalOperator2[0]));
      BaseEngineController_LS_B.s739_LogicalOperator1[1] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s739_LogicalOperator1[2] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s739_LogicalOperator1[3] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s739_LogicalOperator1[4] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s739_LogicalOperator1[5] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s739_LogicalOperator1[6] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      BaseEngineController_LS_B.s739_LogicalOperator1[7] =
        ((rtb_LogicalOperator3_b && rtb_LogicalOperator1_lu &&
      ...
      if ((SparkStartAngle_ovr_DataStore())) {
         ...
         */
        rtb_ESTEnable = BaseEngineController_LS_DWork.s796_UnitDelay_DSTATE;
       ...
       *  S-Function (motohawk_sfun_calibration): '<S796>/offset'
       */
      BaseEngineController_LS_B.s796_Sum = rtb_ESTEnable +
        (SparkStartAngle_offset_DataStore());

      /* DataTypeConversion: '<S739>/Data Type Conversion' incorporates:
       *  Gain: '<S739>/Gain'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s796_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* End of DataTypeConversion: '<S739>/Data Type Conversion' */
      ...
      if ((SparkStopAngle_ovr_DataStore())) {
         ...
         */
        rtb_CounterReset = BaseEngineController_LS_DWork.s797_UnitDelay_DSTATE;
      ...
      /* Sum: '<S797>/Sum' incorporates:
       *  S-Function (motohawk_sfun_calibration): '<S797>/offset'
       */
      BaseEngineController_LS_B.s797_Sum = rtb_CounterReset +
        (SparkStopAngle_offset_DataStore());

      /* DataTypeConversion: '<S739>/Data Type Conversion1' incorporates:
       *  Gain: '<S739>/Gain1'
       */
      tmp_0 = 16.0 * BaseEngineController_LS_B.s797_Sum;
      if (tmp_0 < 32768.0) {
        if (tmp_0 >= -32768.0) {
      ...
      /* End of DataTypeConversion: '<S739>/Data Type Conversion1' */
      /* DataTypeConversion: '<S739>/Data Type Conversion2' incorporates:
       *  Gain: '<S739>/Gain2'
      ...
      /* End of DataTypeConversion: '<S739>/Data Type Conversion2' */
      /* S-Function Block: <S739>/Spark Sequence Output Spark Sequence Diagnostics */
      {
        ...
        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s739_SparkSequence_o3)[i] =
            SparkSeqDiag_22_OpenADC[i];
        }

        for (i=0; i < (EncoderNumCylinders_DataStore()); i++) {
          (BaseEngineController_LS_B.s739_SparkSequence_o4)[i] =
            SparkSeqDiag_22_OnTime[i];
        }
      }

      /* RelationalOperator: '<S816>/RelOp' incorporates:
      ...
      /* Set Fault Suspected Status: EST1_Short */
      {
        ...
        SetFaultSuspected(41, rtb_RelOp_j);
        UpdateFault(41);
      }

      /* RelationalOperator: '<S817>/RelOp' incorporates:
      ...
      /* Set Fault Suspected Status: EST2_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(43, rtb_RelOp_c);
        UpdateFault(43);
      }

      /* RelationalOperator: '<S804>/RelOp' incorporates:
       *  Constant: '<S804>/Constant'
       */
      rtb_RelOp_p = ((rtb_SparkSequence_o1[2] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def10' */

      /* Set Fault Suspected Status: EST3_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(45, rtb_RelOp_p);
        UpdateFault(45);
      }
      ...
      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def11' */

      /* Set Fault Suspected Status: EST4_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(47, rtb_RelOp_h);
        UpdateFault(47);
      }

      /* RelationalOperator: '<S806>/RelOp' incorporates:
       *  Constant: '<S806>/Constant'
       */
      rtb_RelOp_m = ((rtb_SparkSequence_o1[4] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def12' */

      /* Set Fault Suspected Status: EST5_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(49, rtb_RelOp_m);
        UpdateFault(49);
      }

      /* RelationalOperator: '<S807>/RelOp' incorporates:
       *  Constant: '<S807>/Constant'
       */
      rtb_RelOp_ch = ((rtb_SparkSequence_o1[5] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def13' */

      /* Set Fault Suspected Status: EST6_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(51, rtb_RelOp_ch);
        UpdateFault(51);
      }

      /* RelationalOperator: '<S808>/RelOp' incorporates:
       *  Constant: '<S808>/Constant'
       */
      rtb_RelOp_b = ((rtb_SparkSequence_o1[6] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def14' */

      /* Set Fault Suspected Status: EST7_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(53, rtb_RelOp_b);
        UpdateFault(53);
      }

      /* RelationalOperator: '<S809>/RelOp' incorporates:
       *  Constant: '<S809>/Constant'
       */
      rtb_RelOp_jc = ((rtb_SparkSequence_o1[7] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def15' */

      /* Set Fault Suspected Status: EST8_Short */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(55, rtb_RelOp_jc);
        UpdateFault(55);
      }

      /* RelationalOperator: '<S810>/RelOp' incorporates:
       *  Constant: '<S810>/Constant'
       */
      rtb_RelOp_n = ((rtb_SparkSequence_o2[2] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def2' */

      /* Set Fault Suspected Status: EST3_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(44, rtb_RelOp_n);
        UpdateFault(44);
      }

      /* RelationalOperator: '<S811>/RelOp' incorporates:
       *  Constant: '<S811>/Constant'
       */
      rtb_RelOp_ot = ((rtb_SparkSequence_o2[3] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def3' */

      /* Set Fault Suspected Status: EST4_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(46, rtb_RelOp_ot);
        UpdateFault(46);
      }

      /* RelationalOperator: '<S812>/RelOp' incorporates:
       *  Constant: '<S812>/Constant'
       */
      rtb_RelOp_mz = ((rtb_SparkSequence_o2[4] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def4' */

      /* Set Fault Suspected Status: EST5_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(48, rtb_RelOp_mz);
        UpdateFault(48);
      }

      /* RelationalOperator: '<S813>/RelOp' incorporates:
       *  Constant: '<S813>/Constant'
       */
      rtb_RelOp_ps = ((rtb_SparkSequence_o2[5] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def5' */

      /* Set Fault Suspected Status: EST6_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(50, rtb_RelOp_ps);
        UpdateFault(50);
      }

      /* RelationalOperator: '<S814>/RelOp' incorporates:
       *  Constant: '<S814>/Constant'
       */
      rtb_RelOp_hp = ((rtb_SparkSequence_o2[6] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def6' */

      /* Set Fault Suspected Status: EST7_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(52, rtb_RelOp_hp);
        UpdateFault(52);
      }

      /* RelationalOperator: '<S815>/RelOp' incorporates:
       *  Constant: '<S815>/Constant'
       */
      rtb_RelOp_ol = ((rtb_SparkSequence_o2[7] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def7' */

      /* Set Fault Suspected Status: EST8_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(54, rtb_RelOp_ol);
        UpdateFault(54);
      }

      /* RelationalOperator: '<S802>/RelOp' incorporates:
       *  Constant: '<S802>/Constant'
       */
      rtb_RelOp_pr = ((rtb_SparkSequence_o2[0] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def8' */

      /* Set Fault Suspected Status: EST1_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(40, rtb_RelOp_pr);
        UpdateFault(40);
      }

      /* RelationalOperator: '<S803>/RelOp' incorporates:
       *  Constant: '<S803>/Constant'
       */
      rtb_RelOp_l = ((rtb_SparkSequence_o2[1] == 1));

      /* S-Function (motohawk_sfun_fault_def): '<S795>/motohawk_fault_def9' */

      /* Set Fault Suspected Status: EST2_Open */
      {
        extern void SetFaultSuspected(uint32_T fault, boolean_T val);
        extern void UpdateFault(uint32_T fault);
        SetFaultSuspected(42, rtb_RelOp_l);
        UpdateFault(42);
      }
      ...
      BaseEngineController_LS_DWork.s796_UnitDelay_DSTATE = rtb_ESTEnable;

      /* Update for UnitDelay: '<S797>/Unit Delay' */
      BaseEngineController_LS_DWork.s797_UnitDelay_DSTATE = rtb_CounterReset;

      /* S-Function Block: <S739>/Spark Sequence Update Spark Sequence */
      {
        ...
        for (count=0; count < (EncoderNumCylinders_DataStore()); count++) {
          ...
          if (condition != SEQ_DISABLED) {
            condition = ((BaseEngineController_LS_B.s739_LogicalOperator1)[cyl])
