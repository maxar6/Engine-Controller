...
static void initialize_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void initialize_params_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void enable_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void disable_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void set_sim_state_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void c8_set_sim_state_side_effects_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void finalize_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void sf_c8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void initSimStructsc8_BaseEngineController_LS
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static int32_T c8_emlrt_marshallIn(SFc8_BaseEngineController_LSInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_b_emlrt_marshallIn(SFc8_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c8_b_tp_PowerDown, const char_T *c8_identifier);
static uint8_T c8_c_emlrt_marshallIn(SFc8_BaseEngineController_LSInstanceStruct *
  chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_g_emlrt_marshallIn
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance, const mxArray
   *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_BaseEngineController_LSInstanceStruct
  *chartInstance);
  ...
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_BaseEngineController_LS = 0U;
  chartInstance->c8_is_c8_BaseEngineController_LS = 0U;
  if (!(cdrGetOutputPortReusable(chartInstance->S, 1) != 0)) {
    *c8_MPRDState = FALSE;
  }

  _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  chartInstance->c8_is_active_c8_BaseEngineController_LS = 1U;
  ...
  chartInstance->c8_is_c8_BaseEngineController_LS = c8_IN_PowerDown;
  ...
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c8_is_active_c8_BaseEngineController_LS == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 3U, chartInstance->c8_sfEvent);
  }

  if (chartInstance->c8_is_c8_BaseEngineController_LS == c8_IN_PowerDown) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
  }

  if (chartInstance->c8_is_c8_BaseEngineController_LS == c8_IN_PowerUp) {
  ...
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal = chartInstance->c8_is_active_c8_BaseEngineController_LS;
  c8_b_u = c8_b_hoistedGlobal;
  c8_c_y = NULL;
  sf_mex_assign(&c8_c_y, sf_mex_create("y", &c8_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c8_y, 1, c8_c_y);
  c8_c_hoistedGlobal = chartInstance->c8_is_c8_BaseEngineController_LS;
   ...
   *c8_st)
{
  ...
  *c8_MPRDState = c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c8_u, 0)), "MPRDState");
  chartInstance->c8_is_active_c8_BaseEngineController_LS = c8_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
     "is_active_c8_BaseEngineController_LS");
  chartInstance->c8_is_c8_BaseEngineController_LS = c8_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
     "is_c8_BaseEngineController_LS");
  ...
  c8_update_debugger_state_c8_BaseEngineController_LS(chartInstance);
  ...
  (SFc8_BaseEngineController_LSInstanceStruct *chartInstance)
{
  ...
  c8_set_sim_state_side_effects_c8_BaseEngineController_LS(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c8_sfEvent);
  switch (chartInstance->c8_is_c8_BaseEngineController_LS) {
   case c8_IN_PowerDown:
    ...
    if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0, *c8_ECUP != 0U,
      ...
      chartInstance->c8_tp_PowerDown = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
      chartInstance->c8_is_c8_BaseEngineController_LS = c8_IN_PowerUp;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_PowerUp = 1U;
      *c8_MPRDState = TRUE;
      _SFD_DATA_RANGE_CHECK((real_T)*c8_MPRDState, 2U);
   ...
   default:
    CV_CHART_EVAL(3, 0, 0);
    chartInstance->c8_is_c8_BaseEngineController_LS = (uint8_T)
...
const mxArray *sf_c8_BaseEngineController_LS_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc8_BaseEngineController_LSInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c8_BaseEngineController_LS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_BaseEngineController_LS_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_BaseEngineController_LS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"MPRDState\",},{M[8],M[0],T\"is_active_c8_BaseEngineController_LS\",},{M[9],M[0],T\"is_c8_BaseEngineController_LS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_BaseEngineController_LS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_BaseEngineController_LS(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_BaseEngineController_LS
    ((SFc8_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
  initialize_c8_BaseEngineController_LS
    ((SFc8_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_BaseEngineController_LS(void *chartInstanceVar)
{
  enable_c8_BaseEngineController_LS((SFc8_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_BaseEngineController_LS(void *chartInstanceVar)
{
  disable_c8_BaseEngineController_LS((SFc8_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_BaseEngineController_LS(void *chartInstanceVar)
{
  sf_c8_BaseEngineController_LS((SFc8_BaseEngineController_LSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_BaseEngineController_LS
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_BaseEngineController_LS
    ((SFc8_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_BaseEngineController_LS();/* state var info */
...
extern void sf_internal_set_sim_state_c8_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_BaseEngineController_LS
    ((SFc8_BaseEngineController_LSInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_BaseEngineController_LS
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_BaseEngineController_LS(S);
}

static void sf_opaque_set_sim_state_c8_BaseEngineController_LS(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_BaseEngineController_LS(S, st);
}

static void sf_opaque_terminate_c8_BaseEngineController_LS(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_BaseEngineController_LSInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_BaseEngineController_LS
      ((SFc8_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_BaseEngineController_LS
    ((SFc8_BaseEngineController_LSInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_BaseEngineController_LS(SimStruct *S)
{
  int i;
...
static void mdlRTW_c8_BaseEngineController_LS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_BaseEngineController_LS(SimStruct *S)
{
  SFc8_BaseEngineController_LSInstanceStruct *chartInstance;
  chartInstance = (SFc8_BaseEngineController_LSInstanceStruct *)malloc(sizeof
    (SFc8_BaseEngineController_LSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_BaseEngineController_LSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_BaseEngineController_LS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_BaseEngineController_LS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_BaseEngineController_LS;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_BaseEngineController_LS;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_BaseEngineController_LS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_BaseEngineController_LS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_BaseEngineController_LS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_BaseEngineController_LS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_BaseEngineController_LS;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_BaseEngineController_LS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_BaseEngineController_LS;
...
void c8_BaseEngineController_LS_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_BaseEngineController_LS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_BaseEngineController_LS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_BaseEngineController_LS_method_dispatcher.\n"
